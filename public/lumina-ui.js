(function(g,h){typeof exports=="object"&&typeof module<"u"?h(exports):typeof define=="function"&&define.amd?define(["exports"],h):(g=typeof globalThis<"u"?globalThis:g||self,h(g.LuminaUI={}))})(this,function(g){"use strict";var ta=Object.defineProperty;var ea=(g,h,z)=>h in g?ta(g,h,{enumerable:!0,configurable:!0,writable:!0,value:z}):g[h]=z;var a=(g,h,z)=>ea(g,typeof h!="symbol"?h+"":h,z);const h={radiusSm:"8px",radiusMd:"14px",radiusLg:"22px",radiusXl:"34px",radiusPill:"999px",easeSpring:"cubic-bezier(0.34, 1.56, 0.64, 1)",easeOut:"cubic-bezier(0.22, 1, 0.36, 1)",easeInOut:"cubic-bezier(0.65, 0, 0.35, 1)",fontSans:"'Inter', 'SF Pro Display', -apple-system, BlinkMacSystemFont, 'Segoe UI', system-ui, sans-serif",fontMono:"'JetBrains Mono', 'SF Mono', 'Fira Code', ui-monospace, monospace",lightBg:"#f3f4fb",lightSurface:"255 255 255",lightSurfaceAlpha:"0.55",lightText:"#0d0b1f",lightTextMuted:"rgba(13, 11, 31, 0.55)",lightBorder:"rgba(13, 11, 31, 0.10)",lightGlow:"rgba(124, 92, 255, 0.35)",lightShadow:"0 10px 30px -10px rgba(13, 11, 31, 0.18)",darkBg:"#06060c",darkSurface:"18 18 32",darkSurfaceAlpha:"0.55",darkText:"#f5f5ff",darkTextMuted:"rgba(245, 245, 255, 0.55)",darkBorder:"rgba(255, 255, 255, 0.08)",darkGlow:"rgba(124, 92, 255, 0.45)",darkShadow:"0 20px 60px -20px rgba(0, 0, 0, 0.7)",cosmicBg:"#0a0420",cosmicSurface:"40 18 78",cosmicSurfaceAlpha:"0.55",cosmicText:"#f0e6ff",cosmicTextMuted:"rgba(240, 230, 255, 0.55)",cosmicBorder:"rgba(200, 130, 255, 0.18)",cosmicGlow:"rgba(180, 120, 255, 0.55)",cosmicShadow:"0 20px 60px -20px rgba(80, 20, 120, 0.7)",voidBg:"#000000",voidSurface:"12 12 18",voidSurfaceAlpha:"0.5",voidText:"#e8e8f5",voidTextMuted:"rgba(232, 232, 245, 0.5)",voidBorder:"rgba(255, 255, 255, 0.06)",voidGlow:"rgba(120, 240, 255, 0.45)",voidShadow:"0 20px 60px -20px rgba(0, 0, 0, 0.9)"},z={light:{bg:h.lightBg,surface:h.lightSurface,surfaceAlpha:h.lightSurfaceAlpha,text:h.lightText,textMuted:h.lightTextMuted,accent:"#7c5cff",accentRgb:"124 92 255",border:h.lightBorder,glow:h.lightGlow,shadow:h.lightShadow},dark:{bg:h.darkBg,surface:h.darkSurface,surfaceAlpha:h.darkSurfaceAlpha,text:h.darkText,textMuted:h.darkTextMuted,accent:"#7c5cff",accentRgb:"124 92 255",border:h.darkBorder,glow:h.darkGlow,shadow:h.darkShadow},cosmic:{bg:h.cosmicBg,surface:h.cosmicSurface,surfaceAlpha:h.cosmicSurfaceAlpha,text:h.cosmicText,textMuted:h.cosmicTextMuted,accent:"#b478ff",accentRgb:"180 120 255",border:h.cosmicBorder,glow:h.cosmicGlow,shadow:h.cosmicShadow},void:{bg:h.voidBg,surface:h.voidSurface,surfaceAlpha:h.voidSurfaceAlpha,text:h.voidText,textMuted:h.voidTextMuted,accent:"#78f0ff",accentRgb:"120 240 255",border:h.voidBorder,glow:h.voidGlow,shadow:h.voidShadow}};function He(l){if(l==="auto"){const n=typeof window<"u"&&window.matchMedia&&window.matchMedia("(prefers-color-scheme: dark)").matches;return z[n?"dark":"light"]}return z[l]}function Oe(){const l=new CSSStyleSheet;return l.replaceSync(`
    :host {
      /* Geometry */
  ...
  `),l}const Ke={subtle:.4,medium:.7,intense:1,extreme:1.6},je={flat:0,medium:14,deep:32,extrude:64},hi={variant:"glass",intensity:"medium",theme:"auto",animationTrigger:"hover",accentColor:"#7c5cff",speed:.5,depth:"medium"};function We(l){const n={r:124,g:92,b:255,a:1};if(typeof document>"u")return n;const t=document.createElement("canvas").getContext("2d");if(!t)return n;t.fillStyle="#000",t.fillStyle=l;const e=t.fillStyle;if(e.startsWith("#")){const r=e.slice(1),s=parseInt(r.slice(0,2),16),o=parseInt(r.slice(2,4),16),d=parseInt(r.slice(4,6),16);return{r:s,g:o,b:d,a:1}}const i=e.match(/rgba?\(([^)]+)\)/);if(i){const r=i[1].split(",").map(s=>s.trim());return{r:parseFloat(r[0]),g:parseFloat(r[1]),b:parseFloat(r[2]),a:r.length===4?parseFloat(r[3]):1}}return n}function pi(l,n=l.a){return`rgb(${l.r} ${l.g} ${l.b} / ${n})`}function Ue(l){const n=We(l);return`${n.r} ${n.g} ${n.b}`}function Je(l){return je[l]}function k(l){return Ke[l]}function f(l,n,t){return Math.min(Math.max(l,n),t)}function bi(l,n,t){return l+(n-l)*t}function v(l,n){return l+Math.random()*(n-l)}function gi(l,n){return l.querySelector(n)}function Ge(l,n,t=window.devicePixelRatio||1){const e=document.createElement("canvas");e.width=Math.max(1,Math.floor(l*t)),e.height=Math.max(1,Math.floor(n*t)),e.style.width=`${l}px`,e.style.height=`${n}px`;const i=e.getContext("2d");return i&&i.scale(t,t),e}function _(l,n,t){return l===null?t:n.includes(l)?l:t}const Pe=["glass","morph","neural","void","aura","dimensional"],Re=["subtle","medium","intense","extreme"],De=["light","dark","auto","cosmic","void"],Ye=["hover","click","scroll","focus","proximity"],Ve=["flat","medium","deep","extrude"];function p(){return typeof window<"u"&&!!window.matchMedia&&window.matchMedia("(prefers-reduced-motion: reduce)").matches}function C(l,n=16){let t=0,e=null;return(...i)=>{const r=Date.now(),s=n-(r-t);s<=0?(e&&(clearTimeout(e),e=null),t=r,l(...i)):e||(e=setTimeout(()=>{t=Date.now(),e=null,l(...i)},s))}}function vi(l){return l<=.3?"cubic-bezier(0.34, 1.56, 0.64, 1)":"cubic-bezier(0.22, 1, 0.36, 1)"}const S=class S extends HTMLElement{constructor(){super();a(this,"shadow");a(this,"_mounted",!1);a(this,"_mutationObserver",null);a(this,"_themeMedia");a(this,"_variant","glass");a(this,"_intensity","medium");a(this,"_theme","auto");a(this,"_trigger","hover");a(this,"_accent","#7c5cff");a(this,"_speed",.5);a(this,"_depth","medium");a(this,"_onMutation",t=>{for(const e of t)e.type==="attributes"&&this._applyAttribute(e.attributeName,this.getAttribute(e.attributeName))});a(this,"_onThemeMediaChange",()=>{this._theme==="auto"&&this.applyTheme()});this.shadow=this.attachShadow({mode:"open"}),this.shadow.adoptedStyleSheets=[S.baseStyles]}get variant(){return this._variant}set variant(t){this._variant=t,this.setAttribute("variant",t)}get intensity(){return this._intensity}set intensity(t){this._intensity=t,this.setAttribute("intensity",t)}get theme(){return this._theme}set theme(t){this._theme=t,this.setAttribute("theme",t)}get animationTrigger(){return this._trigger}set animationTrigger(t){this._trigger=t,this.setAttribute("animation-trigger",t)}get accentColor(){return this._accent}set accentColor(t){this._accent=t,this.setAttribute("accent-color",t)}get speed(){return this._speed}set speed(t){this._speed=t,this.setAttribute("speed",String(t))}get depth(){return this._depth}set depth(t){this._depth=t,this.setAttribute("depth",t)}connectedCallback(){this._parseAttributes();const t=this._ensureComponentStyles();this.shadow.adoptedStyleSheets=[S.baseStyles,t],this.shadow.innerHTML=this.render(),this._theme==="auto"&&typeof window<"u"&&(this._themeMedia=window.matchMedia("(prefers-color-scheme: dark)"),this._themeMedia.addEventListener("change",this._onThemeMediaChange)),this._mutationObserver=new MutationObserver(this._onMutation),this._mutationObserver.observe(this,{attributes:!0}),this.applyTheme(),this.applyConfigTokens(),this._mounted=!0,this.mounted()}disconnectedCallback(){this._mounted=!1,this._mutationObserver?.disconnect(),this._mutationObserver=null,this._themeMedia&&(this._themeMedia.removeEventListener("change",this._onThemeMediaChange),this._themeMedia=void 0),this.unmounted()}attributeChangedCallback(t,e,i){!e||e===i||this._applyAttribute(t,i)}mounted(){}unmounted(){}onConfigChange(t){}static get observedAttributes(){return["variant","intensity","theme","animation-trigger","accent-color","speed","depth"]}_parseAttributes(){this._variant=_(this.getAttribute("variant"),Pe,"glass"),this._intensity=_(this.getAttribute("intensity"),Re,"medium"),this._theme=_(this.getAttribute("theme"),De,"auto"),this._trigger=_(this.getAttribute("animation-trigger"),Ye,"hover"),this._accent=this.getAttribute("accent-color")??"#7c5cff",this._speed=parseFloat(this.getAttribute("speed")??"0.5")||.5,this._depth=_(this.getAttribute("depth"),Ve,"medium")}_applyAttribute(t,e){const i={};switch(t){case"variant":this._variant=_(e,Pe,"glass"),i.variant=this._variant;break;case"intensity":this._intensity=_(e,Re,"medium"),i.intensity=this._intensity;break;case"theme":this._theme=_(e,De,"auto"),i.theme=this._theme,this._rebindThemeMedia(),this.applyTheme();break;case"animation-trigger":this._trigger=_(e,Ye,"hover"),i["animation-trigger"]=this._trigger;break;case"accent-color":this._accent=e??"#7c5cff",i["accent-color"]=this._accent;break;case"speed":this._speed=parseFloat(e??"0.5")||.5,i.speed=this._speed;break;case"depth":this._depth=_(e,Ve,"medium"),i.depth=this._depth;break;default:return}this.applyConfigTokens(),this._mounted&&this.onConfigChange(i)}_rebindThemeMedia(){this._themeMedia&&(this._themeMedia.removeEventListener("change",this._onThemeMediaChange),this._themeMedia=void 0),this._theme==="auto"&&typeof window<"u"&&(this._themeMedia=window.matchMedia("(prefers-color-scheme: dark)"),this._themeMedia.addEventListener("change",this._onThemeMediaChange))}applyTheme(){const t=He(this._theme),e=this.shadow.host;e.style.setProperty("--lumina-bg",t.bg),e.style.setProperty("--lumina-surface",t.surface),e.style.setProperty("--lumina-surface-alpha",t.surfaceAlpha),e.style.setProperty("--lumina-text",t.text),e.style.setProperty("--lumina-text-muted",t.textMuted),e.style.setProperty("--lumina-border",t.border),e.style.setProperty("--lumina-glow",t.glow),e.style.setProperty("--lumina-shadow",t.shadow),e.style.setProperty("--lumina-accent",this._accent),e.style.setProperty("--lumina-accent-rgb",Ue(this._accent))}applyConfigTokens(){const t=this.shadow.host;t.style.setProperty("--lumina-variant",this._variant),t.style.setProperty("--lumina-intensity",String(k(this._intensity))),t.style.setProperty("--lumina-speed",`${this._speed}s`),t.style.setProperty("--lumina-depth",`${Je(this._depth)}px`)}_ensureComponentStyles(){const t=this.constructor;let e=S._sheetCache.get(t);return e||(e=new CSSStyleSheet,e.replaceSync(this.styles()),S._sheetCache.set(t,e)),e}$(t){return this.shadow.getElementById(t)??null}$$(t){return this.shadow.querySelector(t)}$$$(t){return Array.from(this.shadow.querySelectorAll(t))}};a(S,"baseStyles",Oe()),a(S,"_sheetCache",new WeakMap);let u=S;const fi={success:"✓",warning:"!",error:"×",info:"i",glass:"i",neural:"◆"};class P extends u{constructor(){super(...arguments);a(this,"dismissTimer",null);a(this,"autoDismissMs",0)}static get observedAttributes(){return[...u.observedAttributes,"dismissible","auto-dismiss"]}get dismissible(){return this.hasAttribute("dismissible")}set dismissible(t){t?this.setAttribute("dismissible",""):this.removeAttribute("dismissible"),this.applyDismissible()}get autoDismiss(){return this.autoDismissMs}set autoDismiss(t){this.autoDismissMs=t,this.setAttribute("auto-dismiss",String(t)),this.scheduleAutoDismiss()}render(){return`
    ...
    `}mounted(){this.applyVariantIcon(),this.applyTitle(),this.applyDismissible(),this.$$(".lma__close")?.addEventListener("click",()=>this.dismiss());const t=this.getAttribute("auto-dismiss");t&&(this.autoDismissMs=parseInt(t,10)||0,this.scheduleAutoDismiss())}unmounted(){this.dismissTimer&&clearTimeout(this.dismissTimer)}onConfigChange(t){t.variant&&this.applyVariantIcon()}attributeChangedCallback(t,e,i){super.attributeChangedCallback(t,e,i),t==="dismissible"?this.applyDismissible():t==="auto-dismiss"&&i?(this.autoDismissMs=parseInt(i,10)||0,this.scheduleAutoDismiss()):t==="variant"&&this.applyVariantIcon()}applyVariantIcon(){const t=this.$$(".lma__icon");if(!t)return;const e=this.variant;t.textContent=fi[e]??"i"}applyTitle(){const t=this.$$(".lma__title");t&&!this.querySelector('[slot="title"]')&&(t.textContent=this.variant.charAt(0).toUpperCase()+this.variant.slice(1))}applyDismissible(){const t=this.$$(".lma__close");t&&(t.style.display=this.dismissible?"":"none")}scheduleAutoDismiss(){this.dismissTimer&&(clearTimeout(this.dismissTimer),this.dismissTimer=null),this.autoDismissMs>0&&(this.dismissTimer=setTimeout(()=>this.dismiss(),this.autoDismissMs))}dismiss(){if(p()){this.dispatchEvent(new CustomEvent("lumina-close",{bubbles:!0,composed:!0})),this.remove();return}const t=this.$$(".lma");t?(t.classList.add("is-dismissing"),setTimeout(()=>{this.dispatchEvent(new CustomEvent("lumina-close",{bubbles:!0,composed:!0})),this.remove()},400)):(this.dispatchEvent(new CustomEvent("lumina-close",{bubbles:!0,composed:!0})),this.remove())}}a(P,"tagName","lumina-alert"),customElements.get(P.tagName)||customElements.define(P.tagName,P);const Ze=30;class R extends u{constructor(){super(...arguments);a(this,"_suggestions",[]);a(this,"_memoryKey","");a(this,"_multi",!1);a(this,"_asyncUrl",null);a(this,"_asyncFn",null);a(this,"_selected",[]);a(this,"_query","");a(this,"filtered",[]);a(this,"highlightIdx",-1);a(this,"open",!1);a(this,"input",null);a(this,"suggestionsEl",null);a(this,"tagsEl",null);a(this,"loadingEl",null);a(this,"virtualStart",0);a(this,"asyncTimer",null);a(this,"rafId",null);a(this,"onInput",t=>{this._query=t.target.value,this._asyncFn||this._asyncUrl?this._asyncSearch(this._query):this.filter()});a(this,"onKeydown",t=>{t.key==="ArrowDown"?(t.preventDefault(),this.highlightIdx=Math.min(this.highlightIdx+1,this.filtered.length-1),this._updateHighlight(),this._scrollToHighlight()):t.key==="ArrowUp"?(t.preventDefault(),this.highlightIdx=Math.max(this.highlightIdx-1,0),this._updateHighlight(),this._scrollToHighlight()):t.key==="Enter"?(t.preventDefault(),this.highlightIdx>=0&&this.filtered[this.highlightIdx]&&this._select(this.filtered[this.highlightIdx])):t.key==="Escape"?this._close():t.key==="Backspace"&&this._multi&&!this._query&&this._selected.length>0&&this._removeTag(this._selected.length-1)});a(this,"onScroll",()=>{this.rafId&&cancelAnimationFrame(this.rafId),this.rafId=requestAnimationFrame(()=>this._renderVirtual())});a(this,"onDocClick",t=>{this.contains(t.target)||this._close()})}static get observedAttributes(){return[...u.observedAttributes,"suggestions","memory-key","multi","async-source","placeholder","min-chars","value"]}get suggestions(){return this._suggestions}set suggestions(t){this._suggestions=t,this.setAttribute("suggestions",JSON.stringify(t)),this.filter()}get memoryKey(){return this._memoryKey}set memoryKey(t){this._memoryKey=t,this.setAttribute("memory-key",t)}get multi(){return this._multi}set multi(t){this._multi=t,t?this.setAttribute("multi",""):this.removeAttribute("multi")}get value(){return this._multi?this._selected.map(t=>t.value):this._selected[0]?.value??""}set value(t){this._multi&&Array.isArray(t)?this._selected=t.map(e=>this._suggestions.find(i=>i.value===e)??{value:e,label:e}):this._selected=t?[{value:t,label:t}]:[],this._renderTags(),this._syncInput()}setAsyncSource(t){this._asyncFn=t}render(){return`
    ...
    `}mounted(){const t=this.getAttribute("suggestions");if(t)try{this._suggestions=JSON.parse(t)}catch{this._suggestions=[]}this._memoryKey=this.getAttribute("memory-key")??"",this._multi=this.hasAttribute("multi"),this._asyncUrl=this.getAttribute("async-source"),parseInt(this.getAttribute("min-chars")??"1",10),this.input=this.$$(".lmau__el"),this.suggestionsEl=this.$$(".lmau__suggestions"),this.tagsEl=this.$$(".lmau__tags"),this.loadingEl=this.$$(".lmau__loading"),this.input?.addEventListener("input",this.onInput),this.input?.addEventListener("keydown",this.onKeydown),this.input?.addEventListener("focus",()=>this.dispatchEvent(new CustomEvent("lumina-focus",{bubbles:!0,composed:!0,detail:{value:this._query}}))),this.input?.addEventListener("blur",()=>this.dispatchEvent(new CustomEvent("lumina-blur",{bubbles:!0,composed:!0,detail:{value:this._query}}))),this.suggestionsEl?.addEventListener("scroll",this.onScroll),document.addEventListener("click",this.onDocClick)}unmounted(){document.removeEventListener("click",this.onDocClick),this.asyncTimer&&clearTimeout(this.asyncTimer),this.rafId&&cancelAnimationFrame(this.rafId)}onConfigChange(t){}attributeChangedCallback(t,e,i){if(super.attributeChangedCallback(t,e,i),t==="suggestions"&&i)try{this._suggestions=JSON.parse(i),this.filter()}catch{}else if(t==="memory-key")this._memoryKey=i??"";else if(t==="multi")this._multi=i!==null;else if(t==="async-source")this._asyncUrl=i;else if(t==="value"&&i)try{this.value=JSON.parse(i)}catch{this.value=i}}async _asyncSearch(t){const e=parseInt(this.getAttribute("min-chars")??"1",10)||1;if(t.length<e){this._close();return}this.asyncTimer&&clearTimeout(this.asyncTimer),this.loadingEl?.setAttribute("data-on",""),this.asyncTimer=setTimeout(async()=>{try{let i;if(this._asyncFn)i=await this._asyncFn(t);else if(this._asyncUrl){const r=this._asyncUrl.replace("{q}",encodeURIComponent(t));i=await(await fetch(r)).json()}else i=[];this._suggestions=i,this.filter()}catch(i){this.dispatchEvent(new CustomEvent("lumina-error",{bubbles:!0,composed:!0,detail:{error:i}}))}finally{this.loadingEl?.removeAttribute("data-on")}},250)}filter(){if(!this.suggestionsEl)return;const t=this._query.toLowerCase().trim();if(t){this.filtered=this._suggestions.filter(i=>i.label.toLowerCase().includes(t));const e=this._getRecent();this.filtered.sort((i,r)=>{const s=e.includes(i.value)?0:1,o=e.includes(r.value)?0:1;return s-o})}else{const e=this._getRecent();if(e.length===0){this._close();return}this.filtered=this._suggestions.filter(i=>e.includes(i.value))}if(this.filtered.length===0){this.suggestionsEl.innerHTML='<div class="lmau__empty">Nenhum resultado encontrado.</div>',this.suggestionsEl.setAttribute("data-open",""),this.open=!0;return}this.highlightIdx=-1,this.virtualStart=0,this._renderVirtual(),this.suggestionsEl.setAttribute("data-open",""),this.open=!0}_renderVirtual(){if(!this.suggestionsEl||!this.filtered.length)return;const t=this.suggestionsEl.scrollTop,e=38,i=Math.max(0,Math.floor(t/e)-5),r=Math.min(Ze,this.filtered.length-i);if(i===this.virtualStart&&this.suggestionsEl.dataset.lastCount===String(r))return;this.virtualStart=i;const s=this._query.toLowerCase().trim(),o=this._getRecent(),d=this._selected.map(w=>w.value),c=this.filtered.slice(i,i+r);let m="",b="";const y=i*e;y>0&&(m+=`<div style="height:${y}px"></div>`),c.forEach((w,T)=>{const Be=i+T;w.category&&w.category!==b&&(m+=`<div class="lmau__category">${w.category}</div>`,b=w.category);const F=w.label.toLowerCase().indexOf(s);let mi=w.label;s&&F>=0&&(mi=w.label.slice(0,F)+`<span class="lmau__highlight">${w.label.slice(F,F+s.length)}</span>`+w.label.slice(F+s.length));const Zi=o.includes(w.value)?"data-recent":"",Qi=d.includes(w.value)?"data-selected":"";m+=`<div class="lmau__suggestion" data-idx="${Be}" data-value="${w.value}" ${Zi} ${Qi}>${mi}</div>`});const x=(this.filtered.length-(i+r))*e;x>0&&(m+=`<div style="height:${x}px"></div>`),this.suggestionsEl.innerHTML=`<div class="lmau__virtual">${m}</div>`,this.suggestionsEl.dataset.lastCount=String(r),this._bindSuggestionClicks(),this._updateHighlight()}_bindSuggestionClicks(){this.suggestionsEl?.querySelectorAll(".lmau__suggestion").forEach(t=>{t.addEventListener("click",()=>{const e=parseInt(t.getAttribute("data-idx")??"-1",10);e>=0&&this._select(this.filtered[e])}),t.addEventListener("mouseenter",()=>{this.highlightIdx=parseInt(t.getAttribute("data-idx")??"-1",10),this._updateHighlight()})})}_updateHighlight(){this.suggestionsEl?.querySelectorAll(".lmau__suggestion").forEach(t=>{const e=parseInt(t.getAttribute("data-idx")??"-1",10);t.toggleAttribute("data-highlighted",e===this.highlightIdx)}),this.highlightIdx>=0&&this.filtered[this.highlightIdx]&&this.dispatchEvent(new CustomEvent("lumina-suggestion-highlight",{bubbles:!0,composed:!0,detail:{suggestion:this.filtered[this.highlightIdx]}}))}_scrollToHighlight(){if(this.highlightIdx<0)return;const t=38,e=this.highlightIdx*t,i=e+t,r=this.suggestionsEl?.scrollTop??0,s=280;e<r?this.suggestionsEl&&(this.suggestionsEl.scrollTop=e):i>r+s&&this.suggestionsEl&&(this.suggestionsEl.scrollTop=i-s),(this.highlightIdx<this.virtualStart||this.highlightIdx>=this.virtualStart+Ze)&&(this.virtualStart=Math.max(0,this.highlightIdx-5),this._renderVirtual())}_select(t){this._multi?(this._selected.find(i=>i.value===t.value)?this._selected=this._selected.filter(i=>i.value!==t.value):this._selected.push(t),this._renderTags(),this._syncInput(),this.dispatchEvent(new CustomEvent("lumina-select",{bubbles:!0,composed:!0,detail:{value:this.value,selected:t}})),this._renderVirtual()):(this._selected=[t],this._syncInput(),this._saveRecent(t.value),this._close(),this.dispatchEvent(new CustomEvent("lumina-select",{bubbles:!0,composed:!0,detail:{value:t.value,label:t.label}})))}_removeTag(t){const e=this._selected[t];this._selected.splice(t,1),this._renderTags(),this._syncInput(),this.dispatchEvent(new CustomEvent("lumina-tag-remove",{bubbles:!0,composed:!0,detail:{removed:e}}))}_renderTags(){if(!(!this.tagsEl||!this._multi)){if(this._selected.length===0){this.tagsEl.innerHTML="";return}this.tagsEl.innerHTML=this._selected.map((t,e)=>`<span class="lmau__tag">${t.label}<button class="lmau__tag-remove" data-idx="${e}" aria-label="Remover">×</button></span>`).join(""),this.tagsEl.querySelectorAll(".lmau__tag-remove").forEach(t=>{t.addEventListener("click",e=>{e.stopPropagation();const i=parseInt(e.currentTarget.getAttribute("data-idx")??"-1",10);i>=0&&this._removeTag(i)})})}}_syncInput(){this.input&&(this._multi?(this.input.value="",this.input.placeholder=this._selected.length>0?"Adicionar outro...":this.getAttribute("placeholder")??"Digite para buscar..."):this.input.value=this._selected[0]?.label??"")}_close(){this.suggestionsEl?.removeAttribute("data-open"),this.open=!1}_getRecent(){if(!this._memoryKey)return[];try{return JSON.parse(localStorage.getItem(`lumina-autocomplete-${this._memoryKey}`)??"[]")}catch{return[]}}_saveRecent(t){if(!this._memoryKey)return;const e=this._getRecent().filter(i=>i!==t);e.unshift(t),localStorage.setItem(`lumina-autocomplete-${this._memoryKey}`,JSON.stringify(e.slice(0,5)))}}a(R,"tagName","lumina-autocomplete"),customElements.get(R.tagName)||customElements.define(R.tagName,R);class D extends u{constructor(){super(...arguments);a(this,"_max",5)}static get observedAttributes(){return[...u.observedAttributes,"max"]}render(){return'<span class="lmag" part="group"><slot></slot><span class="lmag__overflow" part="overflow"></span></span>'}styles(){return`
    ...
    `}mounted(){this.imgEl=this.$$(".lmav__img"),this.initialsEl=this.$$(".lmav__initials"),this.statusEl=this.$$(".lmav__status"),this._src=this.getAttribute("src")??"",this._name=this.getAttribute("name")??"";const t=this.getAttribute("status");this._status=t&&ti.includes(t)?t:null,this._size=_(this.getAttribute("size"),Qe,"md"),this.applySize(),this.applySrc(),this.applyInitials(),this.applyStatus(),this.applyInteractive(),this.imgEl&&(this.imgEl.addEventListener("load",()=>{this.imgEl?.setAttribute("data-loaded",""),this.initialsEl?.setAttribute("data-hidden","")}),this.imgEl.addEventListener("error",()=>{this.imgEl?.removeAttribute("data-loaded"),this.initialsEl?.removeAttribute("data-hidden")})),this.interactive&&(this.getAttribute("role")!=="button"&&this.setAttribute("role","button"),this.setAttribute("tabindex","0"),this.addEventListener("click",this.onClick),this.addEventListener("keydown",this.onKeydown))}unmounted(){this.removeEventListener("click",this.onClick),this.removeEventListener("keydown",this.onKeydown)}onConfigChange(t){}attributeChangedCallback(t,e,i){super.attributeChangedCallback(t,e,i),t==="src"?(this._src=i??"",this.applySrc()):t==="name"?(this._name=i??"",this.applyInitials()):t==="status"?(this._status=i&&ti.includes(i)?i:null,this.applyStatus()):t==="size"?(this._size=_(i,Qe,"md"),this.applySize()):t==="interactive"&&this.applyInteractive()}applySize(){this.style.setProperty("--lmav-size",`${_i[this._size]}px`)}applySrc(){this.imgEl&&(this._src?(this.imgEl.src=this._src,this.imgEl.alt=this._name||"Avatar"):(this.imgEl.removeAttribute("src"),this.imgEl.removeAttribute("data-loaded"),this.initialsEl?.removeAttribute("data-hidden")))}applyInitials(){if(!this.initialsEl)return;const t=this.computeInitials(this._name);this.initialsEl.textContent=t}applyStatus(){this.statusEl&&(this._status?(this.statusEl.setAttribute("data-status",this._status),this.style.setProperty("--lmav-status",xi[this._status]),this._status==="busy"?this.statusEl.setAttribute("data-busy",""):this.statusEl.removeAttribute("data-busy")):(this.statusEl.removeAttribute("data-status"),this.statusEl.removeAttribute("data-busy")))}applyInteractive(){this.interactive&&this._mounted?(this.getAttribute("role")!=="button"&&this.setAttribute("role","button"),this.setAttribute("tabindex","0"),this.addEventListener("click",this.onClick),this.addEventListener("keydown",this.onKeydown)):(this.removeAttribute("role"),this.removeAttribute("tabindex"),this.removeEventListener("click",this.onClick),this.removeEventListener("keydown",this.onKeydown))}computeInitials(t){if(!t)return"?";const e=t.trim().split(/\s+/);return e.length===1?e[0].slice(0,2).toUpperCase():(e[0][0]+e[e.length-1][0]).toUpperCase()}}a(Y,"tagName","lumina-avatar"),customElements.get(Y.tagName)||customElements.define(Y.tagName,Y);class V extends u{static get observedAttributes(){return[...u.observedAttributes,"pulse","dot"]}render(){return`
    ...
    `}mounted(){}unmounted(){}onConfigChange(n){}}a(V,"tagName","lumina-badge"),customElements.get(V.tagName)||customElements.define(V.tagName,V);class X extends u{static get observedAttributes(){return[...u.observedAttributes]}render(){return`
...
`}mounted(){}unmounted(){}onConfigChange(n){}emit(n,t){this.dispatchEvent(new CustomEvent(n,{bubbles:!0,composed:!0,detail:t}))}open(){this.setAttribute("open",""),this.setAttribute("data-open",""),this.emit("lumina-open")}close(){this.removeAttribute("open"),this.removeAttribute("data-open"),this.emit("lumina-close")}}a(X,"tagName","lumina-breadcrumbs"),customElements.get(X.tagName)||customElements.define(X.tagName,X);class q extends u{constructor(){super(...arguments);a(this,"onClick",()=>{this.dispatchEvent(new CustomEvent("lumina-click",{bubbles:!0,composed:!0}))});a(this,"onKeydown",t=>{(t.key==="Enter"||t.key===" ")&&(t.preventDefault(),this.onClick())})}render(){return`
    ...
    `}mounted(){this.setAttribute("role","button"),this.setAttribute("tabindex","0"),this.$$(".lmbb")?.addEventListener("click",this.onClick),this.$$(".lmbb")?.addEventListener("keydown",this.onKeydown)}unmounted(){}onConfigChange(t){}}a(q,"tagName","lumina-breath-button"),customElements.get(q.tagName)||customElements.define(q.tagName,q);class B extends u{render(){return`
    ...
    `}mounted(){this.addEventListener("pointerenter",()=>this.$$(".lmbc")?.style.setProperty("animation-play-state","paused")),this.addEventListener("pointerleave",()=>this.$$(".lmbc")?.style.setProperty("animation-play-state","running"))}unmounted(){}onConfigChange(n){}}a(B,"tagName","lumina-breath-card"),customElements.get(B.tagName)||customElements.define(B.tagName,B);class H extends u{constructor(){super(...arguments);a(this,"_multiple",!1);a(this,"_value","");a(this,"selectedValues",new Set);a(this,"observer",null);a(this,"onClick",t=>{const e=t.target.closest("[data-value]");if(!e)return;const i=e.getAttribute("data-value")??"";this._multiple?this.selectedValues.has(i)?this.selectedValues.delete(i):this.selectedValues.add(i):this.selectedValues.has(i)&&this.selectedValues.size===1?this.selectedValues.clear():(this.selectedValues.clear(),this.selectedValues.add(i)),this._value=Array.from(this.selectedValues).join(","),this.setAttribute("value",this._value),this.updateChildren(),this.dispatchEvent(new CustomEvent("lumina-change",{bubbles:!0,composed:!0,detail:{value:this._multiple?this._value:this.selectedValues.values().next().value??"",values:Array.from(this.selectedValues)}}))});a(this,"onKeydown",t=>{const e=t.target.closest("[data-value]");if(!e)return;const i=Array.from(this.querySelectorAll("[data-value]")),r=i.indexOf(e);if(r===-1)return;let s=r;if(t.key==="ArrowRight"||t.key==="ArrowDown")s=(r+1)%i.length;else if(t.key==="ArrowLeft"||t.key==="ArrowUp")s=(r-1+i.length)%i.length;else if(t.key==="Home")s=0;else if(t.key==="End")s=i.length-1;else return;t.preventDefault(),i[s].focus()})}static get observedAttributes(){return[...u.observedAttributes,"multiple","value"]}get multiple(){return this._multiple}set multiple(t){this._multiple=t,t?this.setAttribute("multiple",""):this.removeAttribute("multiple"),this.syncFromValue()}get value(){return this._value}set value(t){this._value=t,this.setAttribute("value",t),this.syncFromValue()}render(){return'<div class="lmbg" part="group"><slot></slot></div>'}styles(){return`
    ...
    `}mounted(){this._multiple=this.hasAttribute("multiple"),this._value=this.getAttribute("value")??"",this.syncFromValue(),this.observer=new MutationObserver(()=>this.syncFromValue()),this.observer.observe(this,{childList:!0,subtree:!0,attributes:!0,attributeFilter:["data-value"]}),this.addEventListener("click",this.onClick),this.addEventListener("keydown",this.onKeydown)}unmounted(){this.observer?.disconnect(),this.removeEventListener("click",this.onClick),this.removeEventListener("keydown",this.onKeydown)}onConfigChange(t){}attributeChangedCallback(t,e,i){super.attributeChangedCallback(t,e,i),t==="multiple"?(this._multiple=i!==null,this.syncFromValue()):t==="value"&&(this._value=i??"",this.syncFromValue())}syncFromValue(){this.selectedValues=new Set(this._multiple?this._value.split(",").filter(Boolean):this._value?[this._value]:[]),this.updateChildren()}updateChildren(){Array.from(this.querySelectorAll("[data-value]")).forEach(e=>{const i=e.getAttribute("data-value")??"";this.selectedValues.has(i)?e.setAttribute("data-active",""):e.removeAttribute("data-active")})}}a(H,"tagName","lumina-button-group"),customElements.get(H.tagName)||customElements.define(H.tagName,H);class A{constructor(n,t){a(this,"canvas");a(this,"ctx");a(this,"particles",[]);a(this,"rafId",0);a(this,"running",!1);a(this,"opts");a(this,"loop",()=>{if(!this.running)return;const n=this.ctx,t=this.canvas.clientWidth,e=this.canvas.clientHeight;n.clearRect(0,0,t,e);for(const i of this.particles){i.x+=i.vx,i.y+=i.vy,i.life+=1,this.opts.starfield?(i.x<0&&(i.x=t),i.x>t&&(i.x=0),i.y<0&&(i.y=e),i.y>e&&(i.y=0)):i.life>=i.maxLife&&(i.x=v(0,t),i.y=v(0,e),i.life=0);const r=this.opts.starfield?.4+.6*Math.sin(i.life/i.maxLife*Math.PI*2):1-i.life/i.maxLife;n.fillStyle=`rgba(${this.opts.rgb} / ${r})`,n.beginPath(),n.arc(i.x,i.y,i.size,0,Math.PI*2),n.fill()}if(this.opts.connect)for(let r=0;r<this.particles.length;r++)for(let s=r+1;s<this.particles.length;s++){const o=this.particles[r],d=this.particles[s],c=o.x-d.x,m=o.y-d.y,b=Math.sqrt(c*c+m*m);b<90&&(n.strokeStyle=`rgba(${this.opts.rgb} / ${(1-b/90)*.4})`,n.lineWidth=.6,n.beginPath(),n.moveTo(o.x,o.y),n.lineTo(d.x,d.y),n.stroke())}this.rafId=requestAnimationFrame(this.loop)});this.host=n;const e=n.getBoundingClientRect(),i=Math.max(1,e.width),r=Math.max(1,e.height);this.canvas=Ge(i,r),this.canvas.style.position="absolute",this.canvas.style.inset="0",this.canvas.style.width="100%",this.canvas.style.height="100%",this.canvas.style.pointerEvents="none",this.canvas.setAttribute("aria-hidden","true"),this.ctx=this.canvas.getContext("2d"),this.opts={count:t.count??40,hueRange:t.hueRange??[240,320],sizeRange:t.sizeRange??[1,3],speedRange:t.speedRange??[.2,.8],lifeRange:t.lifeRange??[120,240],spread:t.spread??Math.PI*2,rgb:t.rgb,connect:t.connect??!1,starfield:t.starfield??!1},this.spawn()}mount(n){n.appendChild(this.canvas),p()||this.start()}start(){this.running||(this.running=!0,this.loop())}stop(){this.running=!1,cancelAnimationFrame(this.rafId)}destroy(){this.stop(),this.canvas.remove()}resize(n,t){const e=window.devicePixelRatio||1;this.canvas.width=Math.max(1,Math.floor(n*e)),this.canvas.height=Math.max(1,Math.floor(t*e)),this.canvas.style.width=`${n}px`,this.canvas.style.height=`${t}px`,this.ctx.setTransform(e,0,0,e,0,0)}spawn(){const{count:n,hueRange:t,sizeRange:e,speedRange:i,lifeRange:r,spread:s}=this.opts,o=this.canvas.clientWidth,d=this.canvas.clientHeight;this.particles=[];for(let c=0;c<n;c++){const m=v(0,s),b=v(i[0],i[1]);this.particles.push({x:v(0,o),y:v(0,d),vx:Math.cos(m)*b,vy:Math.sin(m)*b,life:v(0,r[1]),maxLife:v(r[0],r[1]),size:v(e[0],e[1]),hue:v(t[0],t[1])})}}}class O extends u{constructor(){super(...arguments);a(this,"field",null);a(this,"burstCanvas",null);a(this,"burstCtx",null);a(this,"burstParticles",[]);a(this,"burstRaf",0);a(this,"contentSlot",null);a(this,"onClick",t=>{if(this.getAttribute("disabled")!==null){t.preventDefault(),t.stopPropagation();return}this.spawnBurst(t.offsetX,t.offsetY),this.dispatchEvent(new CustomEvent("lumina-press",{bubbles:!0,composed:!0}))});a(this,"onKeyDown",t=>{(t.key==="Enter"||t.key===" ")&&(t.preventDefault(),this.spawnBurst(this.clientWidth/2,this.clientHeight/2),this.dispatchEvent(new CustomEvent("lumina-press",{bubbles:!0,composed:!0})))});a(this,"tickBurst",t=>{if(!this.burstCtx||!this.burstCanvas)return;const e=this.burstCtx;e.clearRect(0,0,this.clientWidth,this.clientHeight),this.burstParticles=this.burstParticles.filter(i=>i.life<i.maxLife);for(const i of this.burstParticles){i.x+=i.vx,i.y+=i.vy,i.vx*=.94,i.vy*=.94,i.life+=1;const r=1-i.life/i.maxLife;e.fillStyle=`rgba(${t} / ${r})`,e.beginPath(),e.arc(i.x,i.y,Math.max(0,i.size*r),0,Math.PI*2),e.fill()}this.burstParticles.length>0?this.burstRaf=requestAnimationFrame(()=>this.tickBurst(t)):(this.burstRaf=0,e.clearRect(0,0,this.clientWidth,this.clientHeight))});a(this,"onPointerEnter",()=>{this.variant==="aura"&&this.contentSlot&&(this.contentSlot.style.transition="transform var(--lumina-speed) var(--lumina-ease-spring)")});a(this,"onPointerLeave",()=>{this.contentSlot&&(this.contentSlot.style.transform="")})}render(){return`
...
`;class j extends u{constructor(){super(...arguments);a(this,"_checked",!1);a(this,"_indeterminate",!1);a(this,"box",null);a(this,"onFocus",()=>{this.dispatchEvent(new CustomEvent("lumina-focus",{bubbles:!0,composed:!0,detail:{checked:this._checked}}))});a(this,"onBlur",()=>{this.dispatchEvent(new CustomEvent("lumina-blur",{bubbles:!0,composed:!0,detail:{checked:this._checked}}))});a(this,"onClick",()=>{this._indeterminate?(this._indeterminate=!1,this.removeAttribute("indeterminate"),this._checked=!0,this.setAttribute("checked","")):(this._checked=!this._checked,this._checked?this.setAttribute("checked",""):this.removeAttribute("checked")),this.updateState(),p()||(this.box?.setAttribute("data-ripple",""),setTimeout(()=>this.box?.removeAttribute("data-ripple"),600)),this.dispatchEvent(new CustomEvent("lumina-change",{bubbles:!0,composed:!0,detail:{checked:this._checked,indeterminate:this._indeterminate}}))});a(this,"onKeydown",t=>{(t.key===" "||t.key==="Enter")&&(t.preventDefault(),this.onClick())})}static get observedAttributes(){return[...u.observedAttributes,"checked","indeterminate","name","disabled","required","invalid","valid"]}get value(){return this._checked}get checked(){return this._checked}set checked(t){this._checked=t,t?this.setAttribute("checked",""):this.removeAttribute("checked"),this.updateState()}get indeterminate(){return this._indeterminate}set indeterminate(t){this._indeterminate=t,t?this.setAttribute("indeterminate",""):this.removeAttribute("indeterminate"),this.updateState()}render(){return`
    ...
    `}mounted(){this._checked=this.hasAttribute("checked"),this._indeterminate=this.hasAttribute("indeterminate"),this.box=this.$$(".lmcb__box"),this.setAttribute("role","checkbox"),this.setAttribute("tabindex","0"),this.updateState(),this.$$(".lmcb")?.addEventListener("click",this.onClick),this.addEventListener("keydown",this.onKeydown),this.addEventListener("focus",this.onFocus),this.addEventListener("blur",this.onBlur)}unmounted(){this.removeEventListener("keydown",this.onKeydown),this.removeEventListener("focus",this.onFocus),this.removeEventListener("blur",this.onBlur)}onConfigChange(t){}attributeChangedCallback(t,e,i){super.attributeChangedCallback(t,e,i),t==="checked"?(this._checked=i!==null,this.updateState()):t==="indeterminate"&&(this._indeterminate=i!==null,this.updateState())}updateState(){this.setAttribute("aria-checked",this._indeterminate?"mixed":String(this._checked))}}a(j,"tagName","lumina-checkbox"),customElements.get(j.tagName)||customElements.define(j.tagName,j);class W extends u{constructor(){super(...arguments);a(this,"_removable",!0);a(this,"_selected",!1);a(this,"_selectable",!1);a(this,"onChipClick",()=>{this._selectable&&(this._selected=!this._selected,this._selected?this.setAttribute("selected",""):this.removeAttribute("selected"),this.setAttribute("aria-pressed",String(this._selected)),this.dispatchEvent(new CustomEvent("lumina-select",{bubbles:!0,composed:!0,detail:{selected:this._selected}})))});a(this,"onKeydown",t=>{this._selectable&&(t.key==="Enter"||t.key===" ")&&(t.preventDefault(),this.onChipClick())})}static get observedAttributes(){return[...u.observedAttributes,"removable","selected","selectable"]}get removable(){return this._removable}set removable(t){this._removable=t,t?this.setAttribute("removable",""):this.removeAttribute("removable"),this.applyRemoveButton()}get selected(){return this._selected}set selected(t){this._selected=t,t?this.setAttribute("selected",""):this.removeAttribute("selected")}get selectable(){return this._selectable}set selectable(t){this._selectable=t,t?this.setAttribute("selectable",""):this.removeAttribute("selectable"),this.applyRole()}render(){return`
    ...
    `}mounted(){this._removable=this.hasAttribute("removable"),this.hasAttribute("removable")||this.setAttribute("removable",""),this._selected=this.hasAttribute("selected"),this._selectable=this.hasAttribute("selectable"),this.applyRole(),this.applyRemoveButton(),this.$$(".lmc__remove")?.addEventListener("click",t=>{t.stopPropagation(),this.removeWithAnimation()}),this._selectable&&(this.addEventListener("click",this.onChipClick),this.addEventListener("keydown",this.onKeydown))}unmounted(){this.removeEventListener("click",this.onChipClick),this.removeEventListener("keydown",this.onKeydown)}onConfigChange(t){}attributeChangedCallback(t,e,i){super.attributeChangedCallback(t,e,i),t==="removable"?(this._removable=i!==null,this.applyRemoveButton()):t==="selected"?this._selected=i!==null:t==="selectable"&&(this._selectable=i!==null,this.applyRole())}applyRole(){this._selectable?(this.getAttribute("role")!=="button"&&this.setAttribute("role","button"),this.setAttribute("tabindex","0"),this.setAttribute("aria-pressed",String(this._selected))):(this.removeAttribute("role"),this.removeAttribute("tabindex"),this.removeAttribute("aria-pressed"))}applyRemoveButton(){const t=this.$$(".lmc__remove");t&&(t.style.display=this._removable?"":"none")}removeWithAnimation(){if(this.dispatchEvent(new CustomEvent("lumina-remove",{bubbles:!0,composed:!0})),p()){this.remove();return}const t=this.$$(".lmc");t?(t.classList.add("is-removing"),setTimeout(()=>this.remove(),400)):this.remove()}}a(W,"tagName","lumina-chip"),customElements.get(W.tagName)||customElements.define(W.tagName,W);function ei(l){const n=parseInt(l.slice(1,3),16)/255,t=parseInt(l.slice(3,5),16)/255,e=parseInt(l.slice(5,7),16)/255,i=Math.max(n,t,e),r=Math.min(n,t,e);let s=0,o=0;const d=(i+r)/2;if(i!==r){const c=i-r;switch(o=d>.5?c/(2-i-r):c/(i+r),i){case n:s=(t-e)/c+(t<e?6:0);break;case t:s=(e-n)/c+2;break;case e:s=(n-t)/c+4;break}s/=6}return[s*360,o*100,d*100]}function M(l,n,t){n/=100,t/=100;const e=o=>(o+l/30)%12,i=n*Math.min(t,1-t),r=o=>t-i*Math.max(-1,Math.min(e(o)-3,Math.min(9-e(o),1))),s=o=>Math.round(o*255).toString(16).padStart(2,"0");return`#${s(r(0))}${s(r(8))}${s(r(4))}`}class U extends u{constructor(){super(...arguments);a(this,"_value","#7c5cff");a(this,"trigger",null);a(this,"panel",null);a(this,"swatch",null);a(this,"hueSlider",null);a(this,"lightSlider",null);a(this,"history",[]);a(this,"_open",!1);a(this,"onDocClick",t=>{!this.contains(t.target)&&this._open&&this.toggle()})}static get observedAttributes(){return[...u.observedAttributes,"value","name","disabled","required","invalid","valid"]}get value(){return this._value}set value(t){this._value=t,this.setAttribute("value",t),this.updatePreview()}render(){return`
    ...
    `}mounted(){this._value=this.getAttribute("value")??"#7c5cff",this.trigger=this.$$(".lmcp__trigger"),this.panel=this.$$(".lmcp__panel"),this.swatch=this.$$(".lmcp__swatch"),this.hueSlider=this.$$(".lmcp__hue"),this.lightSlider=this.$$(".lmcp__light"),this.updatePreview(),this.trigger?.addEventListener("click",()=>this.toggle()),this.trigger?.addEventListener("focus",()=>this.dispatchEvent(new CustomEvent("lumina-focus",{bubbles:!0,composed:!0,detail:{value:this._value}}))),this.trigger?.addEventListener("blur",()=>this.dispatchEvent(new CustomEvent("lumina-blur",{bubbles:!0,composed:!0,detail:{value:this._value}}))),this.hueSlider?.addEventListener("input",()=>this.updateFromSliders()),this.$$(".lmcp__sat")?.addEventListener("input",()=>this.updateFromSliders()),this.lightSlider?.addEventListener("input",()=>this.updateFromSliders()),document.addEventListener("click",this.onDocClick),this.renderHistory()}unmounted(){document.removeEventListener("click",this.onDocClick)}onConfigChange(t){}attributeChangedCallback(t,e,i){super.attributeChangedCallback(t,e,i),t==="value"&&(this._value=i??"#7c5cff",this.updatePreview())}toggle(){this._open=!this._open,this._open?(this.setAttribute("data-open",""),this.updateSliders(),this.renderHarmony()):this.removeAttribute("data-open")}updatePreview(){this.swatch&&(this.swatch.style.background=this._value);const t=this.$$(".lmcp__value");t&&(t.textContent=this._value);const e=this.$$(".lmcp__preview");e&&(e.style.background=this._value,e.style.setProperty("--lmcp-current",this._value)),this.style.setProperty("--lmcp-current",this._value)}updateSliders(){const[t,e,i]=ei(this._value);this.hueSlider&&(this.hueSlider.value=String(Math.round(t)));const r=this.$$(".lmcp__sat");r&&(r.value=String(Math.round(e))),this.lightSlider&&(this.lightSlider.value=String(Math.round(i)))}updateFromSliders(){const t=parseFloat(this.hueSlider?.value??"0"),e=parseFloat(this.$$(".lmcp__sat")?.value??"100"),i=parseFloat(this.lightSlider?.value??"68");this._value=M(t,e,i),this.setAttribute("value",this._value),this.updatePreview(),this.renderHarmony(),this.dispatchEvent(new CustomEvent("lumina-color-change",{bubbles:!0,composed:!0,detail:{value:this._value,h:t,s:e,l:i}}))}renderHarmony(){const t=this.$$(".lmcp__harmony");if(!t)return;const[e,i,r]=ei(this._value),s=[{label:"Comp",colors:[M((e+180)%360,i,r)]},{label:"Analog",colors:[M((e+30)%360,i,r),M((e+330)%360,i,r)]},{label:"Triad",colors:[M((e+120)%360,i,r),M((e+240)%360,i,r)]}];t.innerHTML='<div class="lmcp__harmony-label">Paletas harmônicas</div>',s.forEach(o=>{const d=document.createElement("div");d.className="lmcp__harmony-swatches",d.style.marginBottom="4px",o.colors.forEach(c=>{const m=document.createElement("div");m.className="lmcp__harmony-swatch",m.style.background=c,m.title=c,m.addEventListener("click",()=>{this.value=c,this.addToHistory(c),this.dispatchEvent(new CustomEvent("lumina-color-change",{bubbles:!0,composed:!0,detail:{value:c}}))}),d.appendChild(m)}),t.appendChild(d)})}addToHistory(t){this.history=[t,...this.history.filter(e=>e!==t)].slice(0,8),this.renderHistory()}renderHistory(){const t=this.$$(".lmcp__history");t&&(t.innerHTML="",this.history.length!==0&&this.history.forEach(e=>{const i=document.createElement("div");i.className="lmcp__history-swatch",i.style.background=e,i.title=e,i.addEventListener("click",()=>{this.value=e,this.dispatchEvent(new CustomEvent("lumina-color-change",{bubbles:!0,composed:!0,detail:{value:e}}))}),t.appendChild(i)}))}}a(U,"tagName","lumina-color-picker"),customElements.get(U.tagName)||customElements.define(U.tagName,U);class J extends u{constructor(){super(...arguments);a(this,"_shortcut","");a(this,"onClick",()=>{this.dispatchEvent(new CustomEvent("lumina-click",{bubbles:!0,composed:!0}))});a(this,"onKeydown",t=>{(t.key==="Enter"||t.key===" ")&&(t.preventDefault(),this.onClick())});a(this,"globalKeydown",t=>{if(!this._shortcut)return;const e=this._shortcut.toLowerCase().split("+").map(c=>c.trim()),i=e[e.length-1],r=e.includes("cmd")||e.includes("meta")||e.includes("⌘"),s=e.includes("ctrl")||e.includes("control"),o=e.includes("shift"),d=e.includes("alt")||e.includes("option");t.key.toLowerCase()===i&&!r==!t.metaKey&&!s==!t.ctrlKey&&!o==!t.shiftKey&&!d==!t.altKey&&(t.preventDefault(),this.dispatchEvent(new CustomEvent("lumina-shortcut",{bubbles:!0,composed:!0,detail:{shortcut:this._shortcut}})),this.dispatchEvent(new CustomEvent("lumina-click",{bubbles:!0,composed:!0})))})}static get observedAttributes(){return[...u.observedAttributes,"shortcut"]}get shortcut(){return this._shortcut}set shortcut(t){this._shortcut=t,this.setAttribute("shortcut",t),this.renderShortcut()}render(){return`
...
`}mounted(){}unmounted(){}onConfigChange(n){}emit(n,t){this.dispatchEvent(new CustomEvent(n,{bubbles:!0,composed:!0,detail:t}))}open(){this.setAttribute("open",""),this.setAttribute("data-open",""),this.emit("lumina-open")}close(){this.removeAttribute("open"),this.removeAttribute("data-open"),this.emit("lumina-close")}}a(G,"tagName","lumina-command-palette"),customElements.get(G.tagName)||customElements.define(G.tagName,G);class Z extends u{constructor(){super(...arguments);a(this,"_open",!1);a(this,"_title","");a(this,"_message","");a(this,"_confirmLabel","Confirmar");a(this,"_cancelLabel","Cancelar");a(this,"_destructive",!1);a(this,"prevFocus",null)}static get observedAttributes(){return[...u.observedAttributes,"open","title","message","confirm-label","cancel-label","destructive"]}get open(){return this._open}set open(t){t?this.show():this.hide()}render(){return`
    ...
    `}mounted(){this.glow=this.$$(".lumina-container__glow"),this.addEventListener("pointermove",this.onPointerMove),this.maybeInitField()}unmounted(){this.removeEventListener("pointermove",this.onPointerMove),this.field?.destroy(),this.field=null}onConfigChange(t){(t.variant||t.intensity)&&(this.field?.destroy(),this.field=null,this.maybeInitField())}maybeInitField(){const t=this.variant;if(!(t==="neural"||t==="void"||t==="aura"))return;const i=this.$$(".lumina-container__field");if(!i)return;const r=this.shadow.host.style.getPropertyValue("--lumina-accent-rgb").trim()||"124 92 255",s=k(this.intensity);this.field=new A(this.shadow.host,{count:Math.round(60*s),rgb:r,sizeRange:[.6,2],speedRange:[.1,.4],lifeRange:[180,320],connect:t==="neural",starfield:t==="void"}),this.field.mount(i)}}a(Q,"tagName","lumina-container"),customElements.get(Q.tagName)||customElements.define(Q.tagName,Q);class tt extends u{render(){return'<div class="lmca" part="root"><div class="lmca__sensor" part="sensor" aria-hidden="true"></div><div class="lmca__output" part="output"><slot></slot></div></div>'}styles(){return`
    ...
    `}mounted(){this.detectContext()}unmounted(){}onConfigChange(n){}detectContext(){let n="page",t=this.parentElement;for(;t;){const e=t.tagName.toLowerCase();if(e==="form"){n="form";break}if(e.startsWith("lumina-")){if(e.includes("modal")||e.includes("dialog")){n="modal";break}if(e.includes("drawer")){n="drawer";break}if(e.includes("sidebar")){n="sidebar";break}if(e.includes("card")){n="card";break}}t=t.parentElement}this.setAttribute("data-context",n),this.dispatchEvent(new CustomEvent("lumina-context-change",{bubbles:!0,composed:!0,detail:{context:n}}))}}a(tt,"tagName","lumina-context-aware"),customElements.get(tt.tagName)||customElements.define(tt.tagName,tt);class et extends u{constructor(){super(...arguments);a(this,"_autoAdapt",!0);a(this,"observer",null)}static get observedAttributes(){return[...u.observedAttributes,"auto-adapt"]}get autoAdapt(){return this._autoAdapt}set autoAdapt(t){this._autoAdapt=t,t?this.setAttribute("auto-adapt",""):this.removeAttribute("auto-adapt")}render(){return`
    ...
    `}mounted(){this._value=this.getAttribute("value")??"",this._floatingLabel=this.hasAttribute("floating-label"),this.input=this.$$(".lmci__el"),this.input&&(this.input.value=this._value,this.input.addEventListener("input",this.onInput),this.input.addEventListener("focus",this.onFocus),this.input.addEventListener("blur",this.onBlur)),this.detectContext(),this.observer=new MutationObserver(()=>this.detectContext()),this.observer.observe(document.body,{childList:!0,subtree:!0}),this._updateFloatingState()}unmounted(){this.observer?.disconnect(),this.input?.removeEventListener("input",this.onInput),this.input?.removeEventListener("focus",this.onFocus),this.input?.removeEventListener("blur",this.onBlur)}onConfigChange(t){}attributeChangedCallback(t,e,i){super.attributeChangedCallback(t,e,i),t==="value"&&i!==null?(this._value=i,this.input&&(this.input.value=i),this._updateFloatingState()):t==="disabled"&&this.input?this.input.disabled=i!==null:t==="floating-label"&&(this._floatingLabel=i!==null)}_updateFloatingState(){this.toggleAttribute("data-has-value",this._value.length>0)}detectContext(){let t="standalone",e=this.parentElement;for(;e;){const r=e.tagName.toLowerCase();if(r==="form"){t="form";break}if(r.startsWith("lumina-")&&(r.includes("modal")||r.includes("dialog"))){t="modal";break}if(r.startsWith("lumina-")&&r.includes("card")){t="card";break}if(r.startsWith("lumina-")&&r.includes("sidebar")){t="sidebar";break}if(r.startsWith("lumina-")&&r.includes("drawer")){t="modal";break}e=e.parentElement}const i=this.getAttribute("data-context");this.setAttribute("data-context",t),i!==t&&this.dispatchEvent(new CustomEvent("lumina-context-change",{bubbles:!0,composed:!0,detail:{context:t}}))}}a(it,"tagName","lumina-context-input"),customElements.get(it.tagName)||customElements.define(it.tagName,it);class at extends u{constructor(){super(...arguments);a(this,"_items",[]);a(this,"menu",null);a(this,"_open",!1);a(this,"onContextmenu",t=>{this.contains(t.target)&&(t.preventDefault(),this.show(t.clientX,t.clientY))});a(this,"onDocClick",t=>{!this.contains(t.target)&&this._open&&this.hide()});a(this,"onKeydown",t=>{t.key==="Escape"&&this._open&&this.hide()})}static get observedAttributes(){return[...u.observedAttributes,"items"]}render(){return'<div class="lmcm" part="menu" role="menu" aria-hidden="true"></div><slot></slot>'}styles(){return`
      :host { display: block; font-family: var(--lumina-font-sans); color: var(--lumina-text); }
    ...
    `}mounted(){this.menu=this.$$(".lmcm");const t=this.getAttribute("items");if(t)try{this._items=JSON.parse(t)}catch{this._items=[]}this.renderItems(),document.addEventListener("click",this.onDocClick),document.addEventListener("contextmenu",this.onContextmenu),document.addEventListener("keydown",this.onKeydown)}unmounted(){document.removeEventListener("click",this.onDocClick),document.removeEventListener("contextmenu",this.onContextmenu),document.removeEventListener("keydown",this.onKeydown)}onConfigChange(t){}attributeChangedCallback(t,e,i){if(super.attributeChangedCallback(t,e,i),t==="items"&&i)try{this._items=JSON.parse(i),this.renderItems()}catch{}}renderItems(t,e){const i=e??this._items,r=t??this.menu;r&&(t||(r.innerHTML=""),i.forEach(s=>{if(s.separator){const d=document.createElement("div");d.className="lmcm__separator",d.setAttribute("part","separator"),r.appendChild(d);return}const o=document.createElement("div");if(o.className="lmcm__item",o.setAttribute("part","item"),o.setAttribute("role","menuitem"),s.disabled&&o.setAttribute("disabled",""),o.innerHTML=`<span class="lmcm__item-icon">${s.icon??""}</span><span class="lmcm__item-label">${s.label}</span>${s.shortcut?`<span class="lmcm__item-shortcut">${s.shortcut}</span>`:""}`,s.submenu&&s.submenu.length>0){const d=document.createElement("div");d.className="lmcm__submenu",this.renderItems(d,s.submenu),o.appendChild(d),o.innerHTML+='<span style="margin-left:4px;">▸</span>'}else o.addEventListener("click",()=>{this.dispatchEvent(new CustomEvent("lumina-select",{bubbles:!0,composed:!0,detail:{value:s.value??s.label,label:s.label}})),this.hide()});r.appendChild(o)}))}show(t,e){this.menu&&(this._open=!0,this.menu.setAttribute("data-open",""),this.menu.style.left=`${t}px`,this.menu.style.top=`${e}px`,requestAnimationFrame(()=>{if(!this.menu)return;const i=this.menu.getBoundingClientRect();i.right>window.innerWidth&&(this.menu.style.left=`${t-i.width}px`),i.bottom>window.innerHeight&&(this.menu.style.top=`${e-i.height}px`)}),this.dispatchEvent(new CustomEvent("lumina-show",{bubbles:!0,composed:!0,detail:{x:t,y:e}})))}hide(){!this._open||!this.menu||(this.menu.setAttribute("data-closing",""),setTimeout(()=>{this.menu?.removeAttribute("data-open"),this.menu?.removeAttribute("data-closing"),this._open=!1,this.dispatchEvent(new CustomEvent("lumina-hide",{bubbles:!0,composed:!0}))},200))}}a(at,"tagName","lumina-context-menu"),customElements.get(at.tagName)||customElements.define(at.tagName,at);class rt extends u{constructor(){super(...arguments);a(this,"_columns",[]);a(this,"_data",[]);a(this,"selected",new Set)}static get observedAttributes(){return[...u.observedAttributes,"columns","data"]}render(){return'<div class="lmdg" part="root"><div class="lmdg__header-row" part="header-row" data-header></div><div class="lmdg__body" data-body></div></div>'}styles(){return`
    ...
    `}mounted(){const t=this.getAttribute("columns"),e=this.getAttribute("data");if(t)try{this._columns=JSON.parse(t)}catch{}if(e)try{this._data=JSON.parse(e)}catch{}this.renderGrid()}unmounted(){}onConfigChange(t){}attributeChangedCallback(t,e,i){if(super.attributeChangedCallback(t,e,i),t==="columns"&&i)try{this._columns=JSON.parse(i)}catch{}else if(t==="data"&&i)try{this._data=JSON.parse(i)}catch{}this.renderGrid()}renderGrid(){const t=this.$$(".lmdg__header-row"),e=this.$$(".lmdg__body");!t||!e||(t.innerHTML='<div class="lmdg__checkbox"><input type="checkbox" class="lmdg__select-all" /></div>',this._columns.forEach((i,r)=>{const s=document.createElement("div");s.className="lmdg__header-cell",s.textContent=i,s.setAttribute("draggable","true"),s.dataset.idx=String(r),s.addEventListener("dragstart",()=>s.setAttribute("data-dragging","")),s.addEventListener("dragend",()=>s.removeAttribute("data-dragging")),s.addEventListener("dragover",o=>o.preventDefault()),s.addEventListener("drop",()=>{const o=parseInt(s.dataset.idx??"0");o!==r&&(this._columns.splice(r,0,this._columns.splice(o,1)[0]),this.renderGrid())}),t.appendChild(s)}),e.innerHTML="",this._data.forEach((i,r)=>{const s=document.createElement("div");s.className="lmdg__row",s.dataset.idx=String(r);const o=document.createElement("div");o.className="lmdg__checkbox",o.innerHTML=`<input type="checkbox" ${this.selected.has(r)?"checked":""} />`,o.querySelector("input")?.addEventListener("change",()=>{this.selected.has(r)?this.selected.delete(r):this.selected.add(r),s.toggleAttribute("data-selected",this.selected.has(r)),this.dispatchEvent(new CustomEvent("lumina-select",{bubbles:!0,composed:!0,detail:{index:r,selected:Array.from(this.selected)}}))}),s.appendChild(o),this._columns.forEach(d=>{const c=document.createElement("div");c.className="lmdg__cell",c.textContent=String(i[d]??""),s.appendChild(c)}),s.addEventListener("click",d=>{d.target.matches("input")||(this.selected.has(r)?this.selected.delete(r):this.selected.add(r),s.toggleAttribute("data-selected",this.selected.has(r)),o.querySelector("input").checked=this.selected.has(r))}),e.appendChild(s)}),this.$$(".lmdg__select-all")?.addEventListener("change",i=>{const r=i.target.checked;this.selected=r?new Set(this._data.map((s,o)=>o)):new Set,e.querySelectorAll(".lmdg__row").forEach((s,o)=>{s.toggleAttribute("data-selected",this.selected.has(o));const d=s.querySelector("input");d&&(d.checked=this.selected.has(o))})}))}}a(rt,"tagName","lumina-data-grid"),customElements.get(rt.tagName)||customElements.define(rt.tagName,rt);const yi=["Janeiro","Fevereiro","Março","Abril","Maio","Junho","Julho","Agosto","Setembro","Outubro","Novembro","Dezembro"],wi=["D","S","T","Q","Q","S","S"];class st extends u{constructor(){super(...arguments);a(this,"_value","");a(this,"viewDate",new Date);a(this,"trigger",null);a(this,"calendar",null);a(this,"_open",!1);a(this,"onDocClick",t=>{!this.contains(t.target)&&this._open&&this.toggle()})}static get observedAttributes(){return[...u.observedAttributes,"value","name","disabled","required","invalid","valid"]}get value(){return this._value}set value(t){this._value=t,this.setAttribute("value",t),this.updateTrigger()}render(){return`
    ...
    `}mounted(){if(this._value=this.getAttribute("value")??"",this._value){const t=new Date(this._value);isNaN(t.getTime())||(this.viewDate=t)}this.trigger=this.$$(".lmdp__trigger"),this.calendar=this.$$(".lmdp__calendar"),this.updateTrigger(),this.renderWeekdays(),this.renderDays(),this.trigger?.addEventListener("click",()=>this.toggle()),this.trigger?.addEventListener("focus",()=>this.dispatchEvent(new CustomEvent("lumina-focus",{bubbles:!0,composed:!0,detail:{value:this._value}}))),this.trigger?.addEventListener("blur",()=>this.dispatchEvent(new CustomEvent("lumina-blur",{bubbles:!0,composed:!0,detail:{value:this._value}}))),this.$$(".lmdp__prev")?.addEventListener("click",()=>{this.viewDate.setMonth(this.viewDate.getMonth()-1),this.renderDays()}),this.$$(".lmdp__next")?.addEventListener("click",()=>{this.viewDate.setMonth(this.viewDate.getMonth()+1),this.renderDays()}),document.addEventListener("click",this.onDocClick)}unmounted(){document.removeEventListener("click",this.onDocClick)}onConfigChange(t){}attributeChangedCallback(t,e,i){super.attributeChangedCallback(t,e,i),t==="value"&&(this._value=i??"",this.updateTrigger(),this.renderDays())}toggle(){this._open=!this._open,this._open?this.setAttribute("data-open",""):this.removeAttribute("data-open")}updateTrigger(){const t=this.$$(".lmdp__value");t&&(t.textContent=this._value?this.formatDate(new Date(this._value)):"Selecionar data...")}formatDate(t){return`${String(t.getDate()).padStart(2,"0")}/${String(t.getMonth()+1).padStart(2,"0")}/${t.getFullYear()}`}renderWeekdays(){const t=this.$$(".lmdp__weekdays");t&&(t.innerHTML=wi.map(e=>`<div class="lmdp__weekday">${e}</div>`).join(""))}renderDays(){const t=this.$$(".lmdp__days"),e=this.$$(".lmdp__month");if(!t||!e)return;const i=this.viewDate.getFullYear(),r=this.viewDate.getMonth();e.textContent=`${yi[r]} ${i}`;const s=new Date(i,r,1).getDay(),o=new Date(i,r+1,0).getDate(),d=new Date(i,r,0).getDate(),c=new Date;let m="";for(let x=s-1;x>=0;x--)m+=`<div class="lmdp__day" data-outside data-day="${d-x}">${d-x}</div>`;for(let x=1;x<=o;x++){const w=`${i}-${String(r+1).padStart(2,"0")}-${String(x).padStart(2,"0")}`,T=x===c.getDate()&&r===c.getMonth()&&i===c.getFullYear(),Be=w===this._value;m+=`<div class="lmdp__day" data-day="${x}" data-date="${w}" ${T?"data-today":""} ${Be?"data-selected":""}>${x}</div>`}const y=(7-(s+o)%7)%7;for(let x=1;x<=y;x++)m+=`<div class="lmdp__day" data-outside data-day="${x}">${x}</div>`;t.innerHTML=m,t.querySelectorAll(".lmdp__day[data-date]").forEach(x=>{x.addEventListener("click",()=>{this._value=x.getAttribute("data-date")??"",this.setAttribute("value",this._value),this.updateTrigger(),this.renderDays(),this.dispatchEvent(new CustomEvent("lumina-date-change",{bubbles:!0,composed:!0,detail:{value:this._value}})),this.toggle()})})}}a(st,"tagName","lumina-date-picker"),customElements.get(st.tagName)||customElements.define(st.tagName,st);class nt extends u{constructor(){super(...arguments);a(this,"onMove",t=>{const e=this.getAttribute("depth")??"medium";if(e==="flat")return;const i=this.getBoundingClientRect(),r=(t.clientX-i.left)/i.width-.5,s=(t.clientY-i.top)/i.height-.5,o=e==="extrude"?1:e==="deep"?.7:.4,d=this.$$(".lmdc__children");d&&(d.style.transform=`rotateY(${r*10*o}deg) rotateX(${-s*10*o}deg)`),this.dispatchEvent(new CustomEvent("lumina-depth-change",{bubbles:!0,composed:!0,detail:{depth:e,rx:-s*10*o,ry:r*10*o}}))})}static get observedAttributes(){return[...u.observedAttributes,"depth"]}render(){return'<div class="lmdc" part="controller"><div class="lmdc__children" part="children"><slot></slot></div></div>'}styles(){return`
    ...
    `}mounted(){this.hasAttribute("depth")||this.setAttribute("depth","medium"),this.addEventListener("pointermove",this.onMove)}unmounted(){this.removeEventListener("pointermove",this.onMove)}onConfigChange(t){}}a(nt,"tagName","lumina-depth-controller"),customElements.get(nt.tagName)||customElements.define(nt.tagName,nt);class ot extends u{constructor(){super(...arguments);a(this,"_open",!1);a(this,"_title","");a(this,"_confirmLabel","Confirmar");a(this,"_cancelLabel","Cancelar");a(this,"prevFocus",null);a(this,"onKeydown",t=>{this._open&&t.key==="Escape"&&(t.preventDefault(),this.hide())})}static get observedAttributes(){return[...u.observedAttributes,"open","title","confirm-label","cancel-label"]}get open(){return this._open}set open(t){t?this.show():this.hide()}render(){return`
    ...
    `}mounted(){this._interactive=this.getAttribute("interactive")!=="false",this.layers=Array.from(this.$$$(".lmdc__layer")),this._interactive&&!p()&&(this.addEventListener("pointermove",this.onMove),this.addEventListener("pointerleave",this.onLeave))}unmounted(){cancelAnimationFrame(this.raf),this.removeEventListener("pointermove",this.onMove),this.removeEventListener("pointerleave",this.onLeave)}onConfigChange(t){}attributeChangedCallback(t,e,i){super.attributeChangedCallback(t,e,i),t==="interactive"&&(this._interactive=i!=="false")}}a(lt,"tagName","lumina-dimensional-card"),customElements.get(lt.tagName)||customElements.define(lt.tagName,lt);const ii=["left","right","bottom"],ai=["sm","md","lg","full"],ki={sm:"320px",md:"420px",lg:"560px",full:"100%"};class ut extends u{constructor(){super(...arguments);a(this,"_open",!1);a(this,"_side","right");a(this,"_size","md");a(this,"backdrop",null);a(this,"panel",null);a(this,"prevFocus",null);a(this,"swipeStart",0);a(this,"swiping",!1);a(this,"onKeydown",t=>{if(this._open&&(t.key==="Escape"&&(t.preventDefault(),this.hide()),t.key==="Tab")){const e=Array.from(this.shadow.querySelectorAll('button, [tabindex]:not([tabindex="-1"]), input'));if(e.length===0)return;t.shiftKey&&document.activeElement===e[0]?(t.preventDefault(),e[e.length-1].focus()):!t.shiftKey&&document.activeElement===e[e.length-1]&&(t.preventDefault(),e[0].focus())}});a(this,"onTouchStart",t=>{t.touches.length===1&&(this.swipeStart=this._side==="left"||this._side==="right"?t.touches[0].clientX:t.touches[0].clientY,this.swiping=!0)});a(this,"onTouchMove",t=>{if(!this.swiping||!this.panel)return;const e=this._side==="bottom"?t.touches[0].clientY:t.touches[0].clientX,i=this._side==="left"?e-this.swipeStart:this._side==="right"?this.swipeStart-e:e-this.swipeStart;i>0&&(this._side==="bottom"?this.panel.style.transform=`translateY(${i}px)`:this.panel.style.transform=`translateX(${this._side==="left"?i:-i}px)`)});a(this,"onTouchEnd",t=>{if(!this.swiping||!this.panel)return;this.swiping=!1;const e=this._side==="bottom"?t.changedTouches[0].clientY:t.changedTouches[0].clientX,i=this._side==="left"?e-this.swipeStart:this._side==="right"?this.swipeStart-e:e-this.swipeStart;this.panel.style.transform="",i>80&&this.hide()})}static get observedAttributes(){return[...u.observedAttributes,"open","side","size"]}get open(){return this._open}set open(t){t?this.show():this.hide()}render(){return`
    ...
    `}mounted(){this.backdrop=this.$$(".lmd"),this.panel=this.$$(".lmd__drawer"),this._placement=_(this.getAttribute("placement"),ri,"left"),this._size=_(this.getAttribute("size"),si,"md"),this.applyPlacement(),this.applySize(),this.backdrop?.addEventListener("click",()=>this.hide()),this.$$(".lmd__close")?.addEventListener("click",()=>this.hide()),this.panel?.addEventListener("touchstart",this.onTouchStart,{passive:!0}),this.panel?.addEventListener("touchmove",this.onTouchMove,{passive:!0}),this.panel?.addEventListener("touchend",this.onTouchEnd),document.addEventListener("keydown",this.onKeydown),this.hasAttribute("open")&&requestAnimationFrame(()=>this.show())}unmounted(){this.panel?.removeEventListener("touchstart",this.onTouchStart),this.panel?.removeEventListener("touchmove",this.onTouchMove),this.panel?.removeEventListener("touchend",this.onTouchEnd),document.removeEventListener("keydown",this.onKeydown),document.body.style.overflow=""}onConfigChange(t){}attributeChangedCallback(t,e,i){super.attributeChangedCallback(t,e,i),t==="open"?i!==null?this.show():this.hide():t==="placement"?(this._placement=_(i,ri,"left"),this.applyPlacement()):t==="size"&&(this._size=_(i,si,"md"),this.applySize())}applyPlacement(){}applySize(){this.style.setProperty("--lmd-width",Ei[this._size])}show(){this._open||(this._open=!0,this.setAttribute("data-open",""),this.setAttribute("open",""),this.previouslyFocused=document.activeElement,document.body.style.overflow="hidden",this.dispatchEvent(new CustomEvent("lumina-open",{bubbles:!0,composed:!0})),setTimeout(()=>this.focusFirst(),120))}hide(){this._open&&(this._open=!1,this.removeAttribute("data-open"),this.removeAttribute("open"),document.body.style.overflow="",this.previouslyFocused?.focus(),this.dispatchEvent(new CustomEvent("lumina-close",{bubbles:!0,composed:!0})))}focusFirst(){this.shadow.querySelector('button, [tabindex]:not([tabindex="-1"]), input, a[href]')?.focus()}}a(dt,"tagName","lumina-drawer"),customElements.get(dt.tagName)||customElements.define(dt.tagName,dt);class ct extends u{constructor(){super(...arguments);a(this,"_echoCount",3);a(this,"container",null);a(this,"onClick",t=>{const e=this.getBoundingClientRect(),i=t.clientX-e.left,r=t.clientY-e.top;this.spawnEchoes(i,r),this.dispatchEvent(new CustomEvent("lumina-click",{bubbles:!0,composed:!0})),this.dispatchEvent(new CustomEvent("lumina-echo",{bubbles:!0,composed:!0,detail:{x:i,y:r}}))});a(this,"onKeydown",t=>{if(t.key==="Enter"||t.key===" "){t.preventDefault();const e=this.getBoundingClientRect();this.spawnEchoes(e.width/2,e.height/2),this.dispatchEvent(new CustomEvent("lumina-click",{bubbles:!0,composed:!0}))}})}static get observedAttributes(){return[...u.observedAttributes,"echo-count"]}get echoCount(){return this._echoCount}set echoCount(t){this._echoCount=t,this.setAttribute("echo-count",String(t))}render(){return`
    ...
    `}mounted(){this._echoCount=parseInt(this.getAttribute("echo-count")??"3",10)||3,this.container=this.$$(".lmeb__echo"),this.setAttribute("role","button"),this.setAttribute("tabindex","0"),this.$$(".lmeb")?.addEventListener("click",this.onClick),this.$$(".lmeb")?.addEventListener("keydown",this.onKeydown)}unmounted(){}onConfigChange(t){}attributeChangedCallback(t,e,i){super.attributeChangedCallback(t,e,i),t==="echo-count"&&(this._echoCount=parseInt(i??"3",10)||3)}spawnEchoes(t,e){if(!(p()||!this.container))for(let i=0;i<this._echoCount;i++)setTimeout(()=>{const r=document.createElement("span");r.className="lmeb__wave",r.style.left=`${t}px`,r.style.top=`${e}px`,r.style.width="20px",r.style.height="20px",this.container.appendChild(r),setTimeout(()=>r.remove(),1500)},i*150)}}a(ct,"tagName","lumina-echo-button"),customElements.get(ct.tagName)||customElements.define(ct.tagName,ct);class mt extends u{constructor(){super(...arguments);a(this,"_echoIntensity",.7);a(this,"echoLayer",null);a(this,"onClick",t=>{const e=this.getBoundingClientRect(),i=t.clientX-e.left,r=t.clientY-e.top;this.spawnEcho(i,r,3),this.dispatchEvent(new CustomEvent("lumina-echo",{bubbles:!0,composed:!0,detail:{x:i,y:r,intensity:this._echoIntensity,type:"click"}}))});a(this,"onHover",()=>{const t=this.getBoundingClientRect();this.spawnEcho(t.width/2,t.height/2,1),this.dispatchEvent(new CustomEvent("lumina-echo",{bubbles:!0,composed:!0,detail:{type:"hover",intensity:this._echoIntensity}}))})}static get observedAttributes(){return[...u.observedAttributes,"echo-intensity"]}get echoIntensity(){return this._echoIntensity}set echoIntensity(t){this._echoIntensity=f(t,0,1),this.setAttribute("echo-intensity",String(this._echoIntensity))}render(){return`
    ...
    `}mounted(){this._echoIntensity=f(parseFloat(this.getAttribute("echo-intensity")??"0.7")||.7,0,1),this.echoLayer=this.$$(".lmec__echo"),this.addEventListener("click",this.onClick),this.addEventListener("pointerenter",this.onHover)}unmounted(){this.removeEventListener("click",this.onClick),this.removeEventListener("pointerenter",this.onHover)}onConfigChange(t){}attributeChangedCallback(t,e,i){super.attributeChangedCallback(t,e,i),t==="echo-intensity"&&(this._echoIntensity=f(parseFloat(i??"0.7")||.7,0,1))}spawnEcho(t,e,i=1){if(this.echoLayer)for(let r=0;r<i;r++)setTimeout(()=>{const s=document.createElement("span");s.className="lmec__wave",s.style.left=`${t}px`,s.style.top=`${e}px`,s.style.width="20px",s.style.height="20px",s.style.opacity=String(this._echoIntensity),this.echoLayer.appendChild(s),setTimeout(()=>s.remove(),1500)},r*200)}}a(mt,"tagName","lumina-echo-card"),customElements.get(mt.tagName)||customElements.define(mt.tagName,mt);class ht extends u{constructor(){super(...arguments);a(this,"canvas",null);a(this,"ctx",null);a(this,"echoes",[]);a(this,"raf",0);a(this,"onInteract",t=>{const e=t,i=this.getBoundingClientRect(),r=e.clientX?e.clientX-i.left:i.width/2,s=e.clientY?e.clientY-i.top:i.height/2;this.echoes.push({x:r,y:s,radius:0,life:0,maxLife:60}),this.querySelectorAll("lumina-card, lumina-button, lumina-badge, lumina-chip").forEach((o,d)=>{setTimeout(()=>{o.style.transition="box-shadow 0.4s var(--lumina-ease-out)";const c=o.style.boxShadow;o.style.boxShadow="0 0 20px rgb(var(--lumina-accent-rgb) / 0.6)",setTimeout(()=>{o.style.boxShadow=c},400)},d*50)}),this.dispatchEvent(new CustomEvent("lumina-echo",{bubbles:!0,composed:!0,detail:{x:r,y:s}})),this.dispatchEvent(new CustomEvent("lumina-pulse",{bubbles:!0,composed:!0}))});a(this,"tick",()=>{if(!this.ctx||!this.canvas){this.raf=requestAnimationFrame(this.tick);return}const t=window.devicePixelRatio||1,e=this.clientWidth,i=this.clientHeight;this.canvas.width!==e*t&&(this.canvas.width=e*t,this.canvas.height=i*t,this.canvas.style.width=`${e}px`,this.canvas.style.height=`${i}px`,this.ctx.setTransform(t,0,0,t,0,0)),this.ctx.clearRect(0,0,e,i);const r=this.shadow.host.style.getPropertyValue("--lumina-accent-rgb").trim()||"124 92 255";this.echoes=this.echoes.filter(s=>s.life<s.maxLife);for(const s of this.echoes){s.life+=1,s.radius=s.life/s.maxLife*Math.max(e,i)*.5;const o=(1-s.life/s.maxLife)*.3*(this.getAttribute("variant")==="intense"?1.5:this.getAttribute("variant")==="subtle"?.5:1);this.ctx.strokeStyle=`rgba(${r} / ${o})`,this.ctx.lineWidth=2,this.ctx.beginPath(),this.ctx.arc(s.x,s.y,s.radius,0,Math.PI*2),this.ctx.stroke()}this.raf=requestAnimationFrame(this.tick)})}render(){return'<div class="lmes" part="root"><div class="lmes__source" part="source"><slot></slot></div><canvas class="lmes__echoes" aria-hidden="true"></canvas></div>'}styles(){return`
    ...
    `}mounted(){this.canvas=this.$$(".lmes__echoes"),this.ctx=this.canvas?.getContext("2d")??null,this.addEventListener("lumina-click",this.onInteract),this.addEventListener("lumina-press",this.onInteract),this.addEventListener("click",this.onInteract),p()||(this.raf=requestAnimationFrame(this.tick))}unmounted(){cancelAnimationFrame(this.raf)}onConfigChange(t){}}a(ht,"tagName","lumina-echo-system"),customElements.get(ht.tagName)||customElements.define(ht.tagName,ht);const ni=["bottom-right","bottom-left","top-right","top-left"];class pt extends u{constructor(){super(...arguments);a(this,"_extended",!1);a(this,"_position","bottom-right")}static get observedAttributes(){return[...u.observedAttributes,"extended","position"]}get extended(){return this._extended}set extended(t){this._extended=t,t?this.setAttribute("extended",""):this.removeAttribute("extended")}get position(){return this._position}set position(t){this._position=t,this.setAttribute("position",t)}render(){return`
    ...
    `}mounted(){this._extended=this.hasAttribute("extended"),this._position=_(this.getAttribute("position"),ni,"bottom-right"),this.applyPosition(),this.getAttribute("role")!=="button"&&this.setAttribute("role","button"),this.setAttribute("tabindex","0"),this.$$(".lmfb")?.addEventListener("click",()=>this.dispatchEvent(new CustomEvent("lumina-click",{bubbles:!0,composed:!0})))}unmounted(){}onConfigChange(t){}attributeChangedCallback(t,e,i){super.attributeChangedCallback(t,e,i),t==="extended"?this._extended=i!==null:t==="position"&&(this._position=_(i,ni,"bottom-right"),this.applyPosition())}applyPosition(){}}a(pt,"tagName","lumina-fab"),customElements.get(pt.tagName)||customElements.define(pt.tagName,pt);class bt extends u{constructor(){super(...arguments);a(this,"_accept","");a(this,"_multiple",!1);a(this,"_maxSize",0);a(this,"files",[]);a(this,"dropzone",null);a(this,"fileInput",null);a(this,"previewEl",null);a(this,"progressEl",null)}static get observedAttributes(){return[...u.observedAttributes,"accept","multiple","max-size","name","disabled","required","invalid","valid"]}get accept(){return this._accept}set accept(t){this._accept=t,this.setAttribute("accept",t)}get multiple(){return this._multiple}set multiple(t){this._multiple=t,t?this.setAttribute("multiple",""):this.removeAttribute("multiple")}get maxSize(){return this._maxSize}set maxSize(t){this._maxSize=t,this.setAttribute("max-size",String(t))}render(){return`
...
`}mounted(){}unmounted(){}onConfigChange(n){}emit(n,t){this.dispatchEvent(new CustomEvent(n,{bubbles:!0,composed:!0,detail:t}))}open(){this.setAttribute("open",""),this.setAttribute("data-open",""),this.emit("lumina-open")}close(){this.removeAttribute("open"),this.removeAttribute("data-open"),this.emit("lumina-close")}}a(gt,"tagName","lumina-floating-nav"),customElements.get(gt.tagName)||customElements.define(gt.tagName,gt);const Ci=l=>l==null||l===!1||typeof l=="string"&&!l.trim()||Array.isArray(l)&&l.length===0?"Campo obrigatório":null,Ai=l=>l?/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(String(l))?null:"Email inválido":null,$i=l=>{if(!l)return null;try{const n=new URL(String(l));return["http:","https:"].includes(n.protocol)?null:"URL deve ser http(s)"}catch{return"URL inválida"}};function Li(l){return n=>n==null||n===""?null:typeof n=="number"?n<l?`Mínimo: ${l}`:null:String(n).length<l?`Mínimo de ${l} caracteres`:null}function Si(l){return n=>n==null||n===""?null:typeof n=="number"?n>l?`Máximo: ${l}`:null:String(n).length>l?`Máximo de ${l} caracteres`:null}function zi(l,n="Formato inválido"){return t=>t?l.test(String(t))?null:n:null}const Mi=l=>l&&isNaN(Number(String(l).replace(/[.,\s]/g,"")))?"Deve ser um número":null,Ni=l=>l?/^-?\d+$/.test(String(l).trim())?null:"Deve ser um número inteiro":null,Ii=l=>l?/^[a-zA-ZÀ-ÿ\s]+$/.test(String(l))?null:"Apenas letras":null,Ti=l=>l?/^[a-zA-Z0-9]+$/.test(String(l))?null:"Apenas letras e números":null,Fi=l=>{if(!l)return null;const n=String(l).replace(/[\s\-().]/g,"");return/^\+\d{7,15}$/.test(n)?null:"Telefone inválido (use +55 11 99999-9999)"},Pi=l=>{if(!l)return null;const n=String(l).replace(/\D/g,"");if(n.length!==10&&n.length!==11)return"Telefone inválido";const t=parseInt(n.slice(0,2),10);return t<11||t>99?"DDD inválido":null},Ri=l=>{if(!l)return null;const n=String(l).replace(/\D/g,"");if(n.length!==11)return"CPF deve ter 11 dígitos";if(/^(\d)\1{10}$/.test(n))return"CPF inválido";let t=0;for(let i=0;i<9;i++)t+=parseInt(n[i],10)*(10-i);let e=11-t%11;if(e>=10&&(e=0),e!==parseInt(n[9],10))return"CPF inválido";t=0;for(let i=0;i<10;i++)t+=parseInt(n[i],10)*(11-i);return e=11-t%11,e>=10&&(e=0),e===parseInt(n[10],10)?null:"CPF inválido"},Di=l=>{if(!l)return null;const n=String(l).replace(/\D/g,"");if(n.length!==14)return"CNPJ deve ter 14 dígitos";if(/^(\d)\1{13}$/.test(n))return"CNPJ inválido";const t=e=>{const i=e===12?[5,4,3,2,9,8,7,6,5,4,3,2]:[6,5,4,3,2,9,8,7,6,5,4,3,2];let r=0;for(let o=0;o<e;o++)r+=parseInt(n[o],10)*i[o];const s=r%11;return s<2?0:11-s};return t(12)!==parseInt(n[12],10)||t(13)!==parseInt(n[13],10)?"CNPJ inválido":null},Yi=l=>{if(!l)return null;const n=String(l).replace(/\D/g,"");if(n.length<13||n.length>19)return"Cartão inválido";let t=0,e=!1;for(let i=n.length-1;i>=0;i--){let r=parseInt(n[i],10);e&&(r*=2,r>9&&(r-=9)),t+=r,e=!e}return t%10===0?null:"Cartão inválido"},Vi=l=>{if(!l)return null;const n=String(l).trim();let t,e,i;if(/^\d{4}-\d{2}-\d{2}$/.test(n))[t,e,i]=n.split("-").map(Number);else if(/^\d{2}\/\d{2}\/\d{4}$/.test(n))[i,e,t]=n.split("/").map(Number);else return"Data inválida (use YYYY-MM-DD ou DD/MM/YYYY)";const r=new Date(t,e-1,i);return r.getFullYear()!==t||r.getMonth()!==e-1||r.getDate()!==i?"Data inexistente":null},Xi=l=>l?/^#([0-9a-fA-F]{3}|[0-9a-fA-F]{6}|[0-9a-fA-F]{8})$/.test(String(l))?null:"Cor hex inválida":null;function qi(l){return(n,t={})=>n!==t[l]?`Deve ser igual a ${l}`:null}function Bi(l){const n=l.split(/\s+/).filter(Boolean),t=[];for(const e of n)if(e==="required")t.push({name:"required",fn:Ci});else if(e==="email")t.push({name:"email",fn:Ai});else if(e==="url")t.push({name:"url",fn:$i});else if(e==="number")t.push({name:"number",fn:Mi});else if(e==="integer")t.push({name:"integer",fn:Ni});else if(e==="alpha")t.push({name:"alpha",fn:Ii});else if(e==="alnum")t.push({name:"alnum",fn:Ti});else if(e==="phone-intl")t.push({name:"phone-intl",fn:Fi});else if(e==="phone-br")t.push({name:"phone-br",fn:Pi});else if(e==="cpf")t.push({name:"cpf",fn:Ri});else if(e==="cnpj")t.push({name:"cnpj",fn:Di});else if(e==="credit-card")t.push({name:"credit-card",fn:Yi});else if(e==="date")t.push({name:"date",fn:Vi});else if(e==="hex-color")t.push({name:"hex-color",fn:Xi});else if(e.startsWith("min:"))t.push({name:"min",fn:Li(parseFloat(e.slice(4)))});else if(e.startsWith("max:"))t.push({name:"max",fn:Si(parseFloat(e.slice(4)))});else if(e.startsWith("pattern:")){const i=e.slice(8);try{const r=new RegExp(i);t.push({name:"pattern",fn:zi(r)})}catch{}}else e.startsWith("match:")&&t.push({name:"match",fn:qi(e.slice(6))});return t}function Hi(l,n,t={},e={}){for(const{name:i,fn:r}of n){const s=r(l,t);if(s)return e[i]??s}return null}class vt extends u{constructor(){super(...arguments);a(this,"syncValidators",new Map);a(this,"asyncValidators",new Map);a(this,"asyncValidating",new Set);a(this,"validateMode","submit");a(this,"dirtyFields",new Set);a(this,"_childObserver",null);a(this,"_onChildMutation",t=>{let e=!1;for(const i of t)if(i.addedNodes.length>0){e=!0;break}e&&this._propagateConfig()});a(this,"onFieldChange",t=>{const i=t.target.getAttribute("name");i&&(this.dirtyFields.add(i),this.validateMode==="change"&&this.validateField(i))});a(this,"onFieldBlur",t=>{const i=t.target.getAttribute("name");i&&(this.dirtyFields.add(i),(this.validateMode==="blur"||this.validateMode==="change")&&this.validateField(i))});a(this,"onNativeFieldChange",t=>{const e=t.target;e.hasAttribute("name")&&(e.tagName.toLowerCase().startsWith("lumina-")||this.onFieldChange(t))});a(this,"onNativeFieldBlur",t=>{const e=t.target;e.hasAttribute("name")&&(e.tagName.toLowerCase().startsWith("lumina-")||this.onFieldBlur(t))});a(this,"onSubmit",async t=>{t.preventDefault();const e=this.validate();if(Object.keys(e).length===0&&this.asyncValidators.size>0){const s=await this.validateAsync();if(Object.keys(s).length>0){this.dispatchEvent(new CustomEvent("lumina-submit",{bubbles:!0,composed:!0,detail:{values:this.getValues(),errors:s,valid:!1}}));return}}const i=this.getValues(),r=Object.keys(e).length===0;this.dispatchEvent(new CustomEvent("lumina-submit",{bubbles:!0,composed:!0,detail:{values:i,errors:e,valid:r}}))});a(this,"onReset",t=>{t.preventDefault(),this.clearErrors(),this.dirtyFields.clear(),this._getFields().forEach(e=>{"value"in e?e.value="":e.removeAttribute("value")}),this.dispatchEvent(new CustomEvent("lumina-reset",{bubbles:!0,composed:!0,detail:{}}))})}static get observedAttributes(){return[...u.observedAttributes,"validate-on"]}render(){return`
    ...
    `}mounted(){const t=this.$$(".lfm");t?.addEventListener("submit",this.onSubmit),t?.addEventListener("reset",this.onReset),this.validateMode=this.getAttribute("validate-on")??"submit",this.addEventListener("lumina-change",this.onFieldChange),this.addEventListener("lumina-blur",this.onFieldBlur),this.addEventListener("change",this.onNativeFieldChange),this.addEventListener("blur",this.onNativeFieldBlur,!0),this._propagateConfig(),this._childObserver=new MutationObserver(this._onChildMutation),this._childObserver.observe(this,{childList:!0,subtree:!0})}_propagateConfig(){const t=[],e=this.getAttribute("variant"),i=this.getAttribute("intensity"),r=this.getAttribute("accent-color"),s=this.getAttribute("theme"),o=this.getAttribute("speed");if(e&&t.push(["variant",e]),i&&t.push(["intensity",i]),r&&t.push(["accent-color",r]),s&&t.push(["theme",s]),o&&t.push(["speed",o]),t.length===0)return;this.querySelectorAll("*").forEach(c=>{const m=c.tagName.toLowerCase();if(!(!m.startsWith("lumina-")||c===this)&&!(m==="lumina-form-field"||m==="lumina-form-list"))for(const[b,y]of t)c.hasAttribute(b)||c.setAttribute(b,y)})}unmounted(){const t=this.$$(".lfm");t?.removeEventListener("submit",this.onSubmit),t?.removeEventListener("reset",this.onReset),this.removeEventListener("lumina-change",this.onFieldChange),this.removeEventListener("lumina-blur",this.onFieldBlur),this.removeEventListener("change",this.onNativeFieldChange),this.removeEventListener("blur",this.onNativeFieldBlur,!0),this._childObserver?.disconnect(),this._childObserver=null}onConfigChange(t){this._propagateConfig()}attributeChangedCallback(t,e,i){super.attributeChangedCallback(t,e,i),t==="validate-on"&&i&&(this.validateMode=i??"submit")}setValidator(t,e){this.syncValidators.set(t,e)}setAsyncValidator(t,e){this.asyncValidators.set(t,e)}_getFields(){return Array.from(this.querySelectorAll("[name]"))}_getFieldValue(t){const e=t.tagName.toLowerCase();return e==="lumina-masked-input"?t.value??"":e==="lumina-switch"||e==="lumina-checkbox"?t.checked??!1:e==="lumina-autocomplete"||e==="lumina-radio-group"||e==="lumina-multi-select"?t.value??"":"value"in t?t.value:t.getAttribute("value")??""}getValues(){const t={};return this._getFields().forEach(e=>{const i=e.getAttribute("name");i&&(t[i]=this._getFieldValue(e))}),t}validate(){const t={},e=this.getValues();return this._getFields().forEach(i=>{const r=i.getAttribute("name");if(!r)return;const s=i.getAttribute("data-validate"),o=e[r];let d=null;s&&(d=this._runRules(o,s,i,e)),!d&&this.syncValidators.has(r)&&(d=this.syncValidators.get(r)(o,e)),d&&(t[r]=d),!d&&this.asyncValidators.has(r)&&this._runAsyncValidator(r,o,e)}),this.setErrors(t),t}async validateAsync(){const t=this.validate(),e=this.getValues(),i=Array.from(this.asyncValidators.keys()),r=await Promise.all(i.map(async s=>{if(t[s])return[s,t[s]];const o=await this.asyncValidators.get(s)(e[s],e);return[s,o]}));for(const[s,o]of r)o&&(t[s]=o);return this.setErrors(t),t}validateField(t){const e=this._getFieldByName(t);if(!e)return null;const i=this.getValues(),r=i[t],s=e.getAttribute("data-validate");let o=null;return s&&(o=this._runRules(r,s,e,i)),!o&&this.syncValidators.has(t)&&(o=this.syncValidators.get(t)(r,i)),o?this.setFieldError(t,o):(this.clearFieldError(t),this.asyncValidators.has(t)&&this._runAsyncValidator(t,r,i)),o}_getFieldByName(t){return this.querySelector(`[name="${t}"]`)}async _runAsyncValidator(t,e,i){if(!this.asyncValidating.has(t)){this.asyncValidating.add(t),this._setFieldLoading(t,!0);try{const r=await this.asyncValidators.get(t)(e,i);r?this.setFieldError(t,r):this.clearFieldError(t)}catch{this.setFieldError(t,"Erro ao validar")}finally{this.asyncValidating.delete(t),this._setFieldLoading(t,!1)}}}_setFieldLoading(t,e){const i=this._getFieldByName(t);if(!i)return;const r=this._findFieldWrapper(i);e?(i.setAttribute("data-loading",""),r?.setAttribute("data-loading","")):(i.removeAttribute("data-loading"),r?.removeAttribute("data-loading"))}_runRules(t,e,i,r){const s=Bi(e),o={};return i.getAttributeNames().forEach(d=>{if(d.startsWith("data-msg-")){const c=d.slice(9);o[c]=i.getAttribute(d)??""}}),Hi(t,s,r,o)}setFieldError(t,e){const i=this._getFieldByName(t);if(!i)return;const r=this._findFieldWrapper(i);if(i.setAttribute("invalid",""),i.removeAttribute("valid"),r){r.setAttribute("invalid",""),r.removeAttribute("valid");const s=r.querySelector('[slot="error"]');s&&(s.textContent=e)}}clearFieldError(t){const e=this._getFieldByName(t);if(!e)return;const i=this._findFieldWrapper(e);e.removeAttribute("invalid");const r=this._getFieldValue(e);if(r&&e.setAttribute("valid",""),i){i.removeAttribute("invalid"),r&&i.setAttribute("valid","");const s=i.querySelector('[slot="error"]');s&&(s.textContent="")}}setErrors(t){this._getFields().forEach(e=>{const i=e.getAttribute("name");if(!i)return;const r=this._findFieldWrapper(e);if(t[i]){if(e.setAttribute("invalid",""),e.removeAttribute("valid"),r){r.setAttribute("invalid",""),r.removeAttribute("valid");const s=r.querySelector('[slot="error"]');s&&(s.textContent=t[i])}}else{e.removeAttribute("invalid");const s=this._getFieldValue(e);s&&e.setAttribute("valid",""),r&&(r.removeAttribute("invalid"),s&&r.setAttribute("valid",""))}})}clearErrors(){this._getFields().forEach(t=>{t.removeAttribute("invalid"),t.removeAttribute("valid");const e=this._findFieldWrapper(t);if(e){e.removeAttribute("invalid"),e.removeAttribute("valid");const i=e.querySelector('[slot="error"]');i&&(i.textContent="")}})}_findFieldWrapper(t){let e=t.parentElement;for(;e&&e!==this;){if(e.tagName.toLowerCase()==="lumina-form-field")return e;e=e.parentElement}return null}}a(vt,"tagName","lumina-form"),customElements.get(vt.tagName)||customElements.define(vt.tagName,vt);class ft extends u{static get observedAttributes(){return[...u.observedAttributes,"label","hint","required","invalid","valid"]}get label(){return this.getAttribute("label")??""}set label(n){this.setAttribute("label",n)}get hint(){return this.getAttribute("hint")??""}set hint(n){this.setAttribute("hint",n)}get required(){return this.hasAttribute("required")}set required(n){n?this.setAttribute("required",""):this.removeAttribute("required")}get invalid(){return this.hasAttribute("invalid")}set invalid(n){n?this.setAttribute("invalid",""):this.removeAttribute("invalid")}get valid(){return this.hasAttribute("valid")}set valid(n){n?this.setAttribute("valid",""):this.removeAttribute("valid")}render(){const n=this.getAttribute("label")??"",t=this.getAttribute("hint")??"",e=this.hasAttribute("required");return`
    ...
    `}mounted(){this.canvas=this.$$(".lmfo__canvas"),this.ctx=this.canvas?.getContext("2d")??null,this.hasAttribute("open")&&requestAnimationFrame(()=>this.show()),document.addEventListener("keydown",t=>{t.key==="Escape"&&this._open&&this.hide()})}unmounted(){cancelAnimationFrame(this.raf)}onConfigChange(t){}attributeChangedCallback(t,e,i){super.attributeChangedCallback(t,e,i),t==="open"&&(i!==null?this.show():this.hide())}show(){this._open||(this._open=!0,this.setAttribute("data-open",""),this.setAttribute("open",""),document.body.style.overflow="hidden",p()||(this.resize(),this.spawnParticles(),this.raf=requestAnimationFrame(this.tick)),this.dispatchEvent(new CustomEvent("lumina-open",{bubbles:!0,composed:!0})))}hide(){this._open&&(this._open=!1,this.removeAttribute("data-open"),this.removeAttribute("open"),document.body.style.overflow="",cancelAnimationFrame(this.raf),this.dispatchEvent(new CustomEvent("lumina-close",{bubbles:!0,composed:!0})))}resize(){if(!this.canvas||!this.ctx)return;const t=window.devicePixelRatio||1;this.canvas.width=window.innerWidth*t,this.canvas.height=window.innerHeight*t,this.ctx.setTransform(t,0,0,t,0,0)}spawnParticles(){const t=window.innerWidth/2,e=window.innerHeight/2;for(let i=0;i<60;i++)this.particles.push({x:t,y:e,angle:Math.random()*Math.PI*2,radius:100+Math.random()*400,life:0,size:v(1,3)})}}a(xt,"tagName","lumina-fullscreen-overlay"),customElements.get(xt.tagName)||customElements.define(xt.tagName,xt);class yt extends u{constructor(){super(...arguments);a(this,"_gestures",["hold","swipe","double-tap"]);a(this,"_holdDelay",500);a(this,"pointerStartX",0);a(this,"pointerStartY",0);a(this,"pointerStartTime",0);a(this,"holdTimer",null);a(this,"lastTapTime",0);a(this,"feedback",null);a(this,"onPointerDown",t=>{this.pointerStartX=t.clientX,this.pointerStartY=t.clientY,this.pointerStartTime=Date.now(),this._gestures.includes("hold")&&(this.holdTimer=setTimeout(()=>{this.emitGesture("hold"),this.holdTimer=null},this._holdDelay))});a(this,"onPointerMove",t=>{if(!this.holdTimer)return;const e=Math.abs(t.clientX-this.pointerStartX),i=Math.abs(t.clientY-this.pointerStartY);(e>10||i>10)&&(clearTimeout(this.holdTimer),this.holdTimer=null)});a(this,"onPointerUp",t=>{if(this.holdTimer){clearTimeout(this.holdTimer),this.holdTimer=null;const e=t.clientX-this.pointerStartX,i=t.clientY-this.pointerStartY,r=Math.sqrt(e*e+i*i),s=Date.now()-this.pointerStartTime;if(this._gestures.includes("swipe")&&r>40&&s<500){this.emitGesture("swipe");return}const o=Date.now();if(this._gestures.includes("double-tap")&&o-this.lastTapTime<300){this.emitGesture("double-tap"),this.lastTapTime=0;return}this.lastTapTime=o,this.dispatchEvent(new CustomEvent("lumina-click",{bubbles:!0,composed:!0}))}});a(this,"onPointerCancel",()=>{this.holdTimer&&(clearTimeout(this.holdTimer),this.holdTimer=null)});a(this,"onKeydown",t=>{(t.key==="Enter"||t.key===" ")&&(t.preventDefault(),this.dispatchEvent(new CustomEvent("lumina-click",{bubbles:!0,composed:!0})))})}static get observedAttributes(){return[...u.observedAttributes,"gestures","hold-delay"]}get gestures(){return this._gestures}set gestures(t){this._gestures=t,this.setAttribute("gestures",t.join(","))}get holdDelay(){return this._holdDelay}set holdDelay(t){this._holdDelay=t,this.setAttribute("hold-delay",String(t))}render(){return`
    ...
    `}mounted(){this._blur=parseFloat(this.getAttribute("blur")??"18")||18,this.applyBlur(),this.addEventListener("pointermove",this.onPointerMove)}unmounted(){this.removeEventListener("pointermove",this.onPointerMove)}onConfigChange(t){}attributeChangedCallback(t,e,i){super.attributeChangedCallback(t,e,i),t==="blur"&&(this._blur=parseFloat(i??"18")||18,this.applyBlur())}applyBlur(){this.style.setProperty("--lmgc-blur",`${this._blur}px`)}}a(wt,"tagName","lumina-glass-card"),customElements.get(wt.tagName)||customElements.define(wt.tagName,wt);class kt extends u{constructor(){super(...arguments);a(this,"_glowIntensity",.6);a(this,"onMove",C(t=>{const e=this.getBoundingClientRect(),i=(t.clientX-e.left)/e.width*100,r=(t.clientY-e.top)/e.height*100;this.style.setProperty("--lx",`${i}%`),this.style.setProperty("--ly",`${r}%`),this.dispatchEvent(new CustomEvent("lumina-hover",{bubbles:!0,composed:!0,detail:{x:i,y:r}}))},16))}static get observedAttributes(){return[...u.observedAttributes,"glow-intensity"]}get glowIntensity(){return this._glowIntensity}set glowIntensity(t){this._glowIntensity=f(t,0,1),this.setAttribute("glow-intensity",String(this._glowIntensity)),this.applyGlow()}render(){return`
    ...
    `}mounted(){this._glowIntensity=f(parseFloat(this.getAttribute("glow-intensity")??"0.6")||.6,0,1),this.applyGlow(),this.addEventListener("pointermove",this.onMove)}unmounted(){this.removeEventListener("pointermove",this.onMove)}onConfigChange(t){}attributeChangedCallback(t,e,i){super.attributeChangedCallback(t,e,i),t==="glow-intensity"&&(this._glowIntensity=f(parseFloat(i??"0.6")||.6,0,1),this.applyGlow())}applyGlow(){this.style.setProperty("--lmgl-intensity",String(this._glowIntensity))}}a(kt,"tagName","lumina-glow-card"),customElements.get(kt.tagName)||customElements.define(kt.tagName,kt);class Et extends u{constructor(){super(...arguments);a(this,"_columns",3)}static get observedAttributes(){return[...u.observedAttributes,"columns"]}render(){return'<div class="lmgr" part="grid"><slot></slot></div>'}styles(){return`
    ...
    `}mounted(){this._columns=parseInt(this.getAttribute("columns")??"3",10)||3,this.style.setProperty("--lmgr-cols",String(this._columns)),this.applyStagger()}unmounted(){}onConfigChange(t){}attributeChangedCallback(t,e,i){super.attributeChangedCallback(t,e,i),t==="columns"&&(this._columns=parseInt(i??"3",10)||3,this.style.setProperty("--lmgr-cols",String(this._columns)))}applyStagger(){this.querySelectorAll("*").forEach((t,e)=>{t.style.animationDelay=`${e*.05}s`})}}a(Et,"tagName","lumina-grid"),customElements.get(Et.tagName)||customElements.define(Et.tagName,Et);function $(l){const n=[];for(const t of l)switch(t){case"#":n.push({type:"input",char:t,test:e=>/\d/.test(e)});break;case"A":n.push({type:"input",char:t,test:e=>/[a-zA-Z]/.test(e)});break;case"?":n.push({type:"input",char:t,test:e=>/[a-zA-Z0-9]/.test(e)});break;case"*":n.push({type:"input",char:t,test:()=>!0});break;default:n.push({type:"literal",char:t})}return n}function Xe(l,n){let t="",e="",i=0,r=0;for(let s=0;s<n.length&&i<l.length;s++){const o=n[s];if(o.type==="literal"){t+=o.char;continue}for(;i<l.length;){const d=l[i];if(i+=1,o.test(d)){t+=d,e+=d,r=t.length;break}}}return{formatted:t,clean:e,cursor:r}}function Oi(l,n){for(let t=n;t<l.length;t++)if(l[t].type==="input")return t;return-1}$("###.###.###-##"),$("##.###.###/####-##"),$("(##) #####-####"),$("#### #### #### ####"),$("####-##-##"),$("##/##/####"),$("#####-###");class Ct extends u{constructor(){super(...arguments);a(this,"input",null);a(this,"tokens",[]);a(this,"_mask","");a(this,"_cleanValue","");a(this,"_formatter",null);a(this,"_floatingLabel",!1);a(this,"onInput",t=>{if(!this.input)return;const i=t.inputType==="deleteContentBackward",r=this.input.value;if(this._formatter){const d=this._formatter.format(r),c=this._formatter.parse(r);this.input.value=d,this._cleanValue=c,this._updateFloatingState(),this._emitChange(c,d);return}if(this.tokens.length===0){this._cleanValue=r,this._updateFloatingState(),this._emitChange(r,r);return}const s=Xe(r,this.tokens);this.input.value=s.formatted,this._cleanValue=s.clean,this._updateFloatingState();const o=i?this.input.selectionStart??0:s.cursor;this.input.setSelectionRange(o,o),this._emitChange(s.clean,s.formatted)});a(this,"onKeydown",t=>{if(!this.input||this.tokens.length===0||t.key==="Backspace"||t.key==="Delete"||t.key==="ArrowLeft"||t.key==="ArrowRight"||t.ctrlKey||t.metaKey||t.altKey||t.key.length!==1)return;const e=this.input.selectionStart??0,i=this._tokenIndexAt(e);if(i<0)return;const r=Oi(this.tokens,i);if(r<0){t.preventDefault();return}if(!this.tokens[r].test(t.key)){t.preventDefault();return}});a(this,"onFocus",()=>{this.dispatchEvent(new CustomEvent("lumina-focus",{bubbles:!0,composed:!0,detail:{}}))});a(this,"onBlur",()=>{this.dispatchEvent(new CustomEvent("lumina-blur",{bubbles:!0,composed:!0,detail:{value:this._cleanValue}}))})}static get observedAttributes(){return[...u.observedAttributes,"mask","placeholder","value","name","disabled","required","invalid","valid","type","floating-label"]}get floatingLabel(){return this._floatingLabel}set floatingLabel(t){this._floatingLabel=t,t?this.setAttribute("floating-label",""):this.removeAttribute("floating-label"),this._updateFloatingState()}get value(){return this._cleanValue}set value(t){this._setCleanValue(t)}get formattedValue(){return this.input?.value??""}set formattedValue(t){this.input&&(this.input.value=t)}get mask(){return this._mask}set mask(t){this._mask=t,this.setAttribute("mask",t),this.tokens=t?$(t):[],this._refreshFromInput()}get formatter(){return this._formatter}set formatter(t){this._formatter=t,this._refreshFromInput()}setCleanValue(t){this._setCleanValue(t)}getCleanValue(){return this._cleanValue}render(){const t=this._floatingLabel?"":`placeholder="${this.getAttribute("placeholder")??""}"`;return`
    ...
    `}mounted(){this.input=this.$$(".lmf__el"),this._mask=this.getAttribute("mask")??"",this.tokens=this._mask?$(this._mask):[],this._floatingLabel=this.hasAttribute("floating-label");const t=this.getAttribute("value");t!==null&&this._setCleanValue(t,!1),this.input?.addEventListener("input",this.onInput),this.input?.addEventListener("keydown",this.onKeydown),this.input?.addEventListener("focus",this.onFocus),this.input?.addEventListener("blur",this.onBlur),this._updateFloatingState()}_updateFloatingState(){if(!this.input)return;const t=this.input.value.length>0,e=this.$$(".lmf");e&&e.classList.toggle("lmf--has-value",t)}unmounted(){this.input?.removeEventListener("input",this.onInput),this.input?.removeEventListener("keydown",this.onKeydown),this.input?.removeEventListener("focus",this.onFocus),this.input?.removeEventListener("blur",this.onBlur)}onConfigChange(t){}attributeChangedCallback(t,e,i){super.attributeChangedCallback(t,e,i),t==="mask"&&i!==null?(this.tokens=$(i),this._refreshFromInput()):t==="value"&&i!==null?this._setCleanValue(i,!1):t==="floating-label"&&(this._floatingLabel=i!==null,this._mounted&&(this.shadow.innerHTML=this.render(),this.input=this.$$(".lmf__el"),this.input&&(this.input.value=this.formattedValue||this._cleanValue,this.input.addEventListener("input",this.onInput),this.input.addEventListener("keydown",this.onKeydown),this.input.addEventListener("focus",this.onFocus),this.input.addEventListener("blur",this.onBlur)),this._updateFloatingState()))}_tokenIndexAt(t){let e=0;for(let i=0;i<this.tokens.length;i++){if(e>=t)return i;e+=1}return this.tokens.length}_setCleanValue(t,e=!0){this._cleanValue=t,this.input&&(this._formatter?this.input.value=this._formatter.format(t):this.tokens.length>0?this.input.value=Xe(t,this.tokens).formatted:this.input.value=t),this.setAttribute("value",t),this._updateFloatingState(),e&&this._emitChange(t,this.formattedValue)}_refreshFromInput(){if(!this.input)return;const t=this.input.value;this._formatter?this._cleanValue=this._formatter.parse(t):this.tokens.length>0?this._cleanValue=Xe(t,this.tokens).clean:this._cleanValue=t}_emitChange(t,e){this.dispatchEvent(new CustomEvent("lumina-change",{bubbles:!0,composed:!0,detail:{value:t,formattedValue:e}}))}}a(Ct,"tagName","lumina-masked-input"),customElements.get(Ct.tagName)||customElements.define(Ct.tagName,Ct);class At extends u{constructor(){super(...arguments);a(this,"holo",null);a(this,"onMove",C(t=>{const e=this.getBoundingClientRect(),i=(t.clientX-e.left)/e.width-.5,r=(t.clientY-e.top)/e.height-.5,s=Math.atan2(r,i)*(180/Math.PI)+180;this.style.setProperty("--holo-angle",`${s}deg`);const o=this.$$(".lmho");o&&(o.style.transform=`perspective(800px) rotateY(${i*15}deg) rotateX(${-r*15}deg)`),this.dispatchEvent(new CustomEvent("lumina-hover",{bubbles:!0,composed:!0,detail:{angle:s,x:i,y:r}}))},16));a(this,"onLeave",()=>{const t=this.$$(".lmho");t&&(t.style.transform="")})}render(){return`
    ...
    `}mounted(){this.holo=this.$$(".lmho__holo"),this.addEventListener("pointermove",this.onMove),this.addEventListener("pointerleave",this.onLeave)}unmounted(){this.removeEventListener("pointermove",this.onMove),this.removeEventListener("pointerleave",this.onLeave)}onConfigChange(t){}}a(At,"tagName","lumina-holo-card"),customElements.get(At.tagName)||customElements.define(At.tagName,At);class $t extends u{constructor(){super(...arguments);a(this,"_expandOnHover",!0);a(this,"onEnter",()=>{this.dispatchEvent(new CustomEvent("lumina-hover",{bubbles:!0,composed:!0,detail:{hovering:!0}})),this._expandOnHover&&this.dispatchEvent(new CustomEvent("lumina-expand",{bubbles:!0,composed:!0,detail:{expanded:!0}}))});a(this,"onLeave",()=>{this.dispatchEvent(new CustomEvent("lumina-hover",{bubbles:!0,composed:!0,detail:{hovering:!1}}))})}static get observedAttributes(){return[...u.observedAttributes,"expand-on-hover"]}get expandOnHover(){return this._expandOnHover}set expandOnHover(t){this._expandOnHover=t,t?this.setAttribute("expand-on-hover",""):this.removeAttribute("expand-on-hover")}render(){return`
    ...
    `}mounted(){this._expandOnHover=this.getAttribute("expand-on-hover")!=="false",this.addEventListener("pointerenter",this.onEnter),this.addEventListener("pointerleave",this.onLeave)}unmounted(){this.removeEventListener("pointerenter",this.onEnter),this.removeEventListener("pointerleave",this.onLeave)}onConfigChange(t){}attributeChangedCallback(t,e,i){super.attributeChangedCallback(t,e,i),t==="expand-on-hover"&&(this._expandOnHover=i!=="false")}}a($t,"tagName","lumina-hover-card"),customElements.get($t.tagName)||customElements.define($t.tagName,$t);const oi=["sm","md","lg"],Ki={sm:32,md:40,lg:52},li=["circle","square"];class Lt extends u{constructor(){super(...arguments);a(this,"_size","md");a(this,"_shape","circle");a(this,"_disabled",!1);a(this,"burstCanvas",null);a(this,"burstCtx",null);a(this,"burstParticles",[]);a(this,"burstRaf",0);a(this,"onClick",t=>{if(this._disabled){t.preventDefault(),t.stopPropagation();return}const e=this.getBoundingClientRect(),i=t.offsetX>=0?t.offsetX:e.width/2,r=t.offsetY>=0?t.offsetY:e.height/2;this.spawnBurst(i,r),this.dispatchEvent(new CustomEvent("lumina-click",{bubbles:!0,composed:!0}))});a(this,"tickBurst",t=>{if(this.burstCtx){this.burstCtx.clearRect(0,0,this.clientWidth,this.clientHeight),this.burstParticles=this.burstParticles.filter(e=>e.life<e.maxLife);for(const e of this.burstParticles){e.x+=e.vx,e.y+=e.vy,e.vx*=.94,e.vy*=.94,e.life+=1;const i=1-e.life/e.maxLife;this.burstCtx.fillStyle=`rgba(${t} / ${i})`,this.burstCtx.beginPath(),this.burstCtx.arc(e.x,e.y,Math.max(0,e.size*i),0,Math.PI*2),this.burstCtx.fill()}this.burstParticles.length>0?this.burstRaf=requestAnimationFrame(()=>this.tickBurst(t)):(this.burstRaf=0,this.burstCtx.clearRect(0,0,this.clientWidth,this.clientHeight))}})}static get observedAttributes(){return[...u.observedAttributes,"size","shape","disabled"]}get size(){return this._size}set size(t){this._size=t,this.setAttribute("size",t)}get shape(){return this._shape}set shape(t){this._shape=t,this.setAttribute("shape",t)}get disabled(){return this._disabled}set disabled(t){this._disabled=t,t?this.setAttribute("disabled",""):this.removeAttribute("disabled")}render(){return`
    ...
    `}mounted(){this._size=_(this.getAttribute("size"),oi,"md"),this._shape=_(this.getAttribute("shape"),li,"circle"),this._disabled=this.hasAttribute("disabled"),this.applySize(),this.applyShape(),this.getAttribute("role")!=="button"&&this.setAttribute("role","button"),this.setAttribute("tabindex",this._disabled?"-1":"0"),this.burstCanvas=this.$$(".lmib__particles"),this.burstCtx=this.burstCanvas?.getContext("2d")??null,this.$$(".lmib")?.addEventListener("click",this.onClick),this.$$(".lmib")?.addEventListener("pointerenter",()=>this.emitHover(!0)),this.$$(".lmib")?.addEventListener("pointerleave",()=>this.emitHover(!1))}unmounted(){cancelAnimationFrame(this.burstRaf)}onConfigChange(t){}attributeChangedCallback(t,e,i){super.attributeChangedCallback(t,e,i),t==="size"?(this._size=_(i,oi,"md"),this.applySize()):t==="shape"?(this._shape=_(i,li,"circle"),this.applyShape()):t==="disabled"&&(this._disabled=i!==null,this.setAttribute("tabindex",this._disabled?"-1":"0"))}applySize(){this.style.setProperty("--lmib-size",`${Ki[this._size]}px`)}applyShape(){}emitHover(t){this.dispatchEvent(new CustomEvent("lumina-hover",{bubbles:!0,composed:!0,detail:{hovering:t}}))}spawnBurst(t,e){if(p()||!this.burstCtx||!this.burstCanvas)return;const i=window.devicePixelRatio||1,r=this.clientWidth,s=this.clientHeight;this.burstCanvas.width=r*i,this.burstCanvas.height=s*i,this.burstCanvas.style.width=`${r}px`,this.burstCanvas.style.height=`${s}px`,this.burstCtx.setTransform(i,0,0,i,0,0);const o=this.shadow.host.style.getPropertyValue("--lumina-accent-rgb").trim()||"124 92 255",d=k(this.intensity),c=Math.round(12*d);for(let m=0;m<c;m++){const b=m/c*Math.PI*2+Math.random()*.4,y=1.5+Math.random()*3*d;this.burstParticles.push({x:t,y:e,vx:Math.cos(b)*y,vy:Math.sin(b)*y,life:0,maxLife:30+Math.random()*20,size:v(1,2.5)})}this.burstRaf||this.tickBurst(o)}}a(Lt,"tagName","lumina-icon-button"),customElements.get(Lt.tagName)||customElements.define(Lt.tagName,Lt);class St extends u{constructor(){super(...arguments);a(this,"_src","");a(this,"_zoom",1);a(this,"_maxZoom",5);a(this,"img",null);a(this,"panX",0);a(this,"panY",0);a(this,"dragging",!1);a(this,"dragStartX",0);a(this,"dragStartY",0);a(this,"onWheel",t=>{t.preventDefault(),this.zoom=this._zoom+(t.deltaY>0?-.2:.2)});a(this,"onPointerDown",t=>{this._zoom<=1||(this.dragging=!0,this.dragStartX=t.clientX-this.panX,this.dragStartY=t.clientY-this.panY,this.$$(".lmiz")?.setAttribute("data-dragging",""),this.img?.setAttribute("data-dragging",""))});a(this,"onPointerMove",t=>{this.dragging&&(this.panX=t.clientX-this.dragStartX,this.panY=t.clientY-this.dragStartY,this.updateTransform())});a(this,"onPointerUp",()=>{this.dragging&&(this.dragging=!1,this.$$(".lmiz")?.removeAttribute("data-dragging"),this.img?.removeAttribute("data-dragging"))});a(this,"onDblClick",()=>{this._zoom>1?(this.zoom=1,this.panX=0,this.panY=0):this.zoom=this._maxZoom})}static get observedAttributes(){return[...u.observedAttributes,"src","zoom","max-zoom"]}get zoom(){return this._zoom}set zoom(t){this._zoom=f(t,1,this._maxZoom),this.updateTransform(),this.dispatchEvent(new CustomEvent("lumina-zoom-change",{bubbles:!0,composed:!0,detail:{zoom:this._zoom}}))}render(){return`
    ...
    `}mounted(){this._src=this.getAttribute("src")??"",this._zoom=parseFloat(this.getAttribute("zoom")??"1")||1,this._maxZoom=parseFloat(this.getAttribute("max-zoom")??"5")||5,this.img=this.$$(".lmiz__img"),this.img&&this._src&&(this.img.src=this._src);const t=this.$$(".lmiz");t?.addEventListener("wheel",this.onWheel),t?.addEventListener("pointerdown",this.onPointerDown),document.addEventListener("pointermove",this.onPointerMove),document.addEventListener("pointerup",this.onPointerUp),t?.addEventListener("dblclick",this.onDblClick),this.$$('.lmiz__btn[data-action="in"]')?.addEventListener("click",()=>{this.zoom=this._zoom+.5}),this.$$('.lmiz__btn[data-action="out"]')?.addEventListener("click",()=>{this.zoom=this._zoom-.5}),this.$$('.lmiz__btn[data-action="reset"]')?.addEventListener("click",()=>{this.zoom=1,this.panX=0,this.panY=0,this.updateTransform()}),this.updateTransform()}unmounted(){document.removeEventListener("pointermove",this.onPointerMove),document.removeEventListener("pointerup",this.onPointerUp)}onConfigChange(t){}attributeChangedCallback(t,e,i){super.attributeChangedCallback(t,e,i),t==="src"&&i&&this.img?this.img.src=i:t==="zoom"&&(this._zoom=f(parseFloat(i??"1")||1,1,this._maxZoom),this.updateTransform())}updateTransform(){if(!this.img)return;this.img.style.transform=`translate(${this.panX}px, ${this.panY}px) scale(${this._zoom})`;const t=this.$$(".lmiz__level");t&&(t.textContent=`${Math.round(this._zoom*100)}%`);const e=this.$$(".lmiz");e&&(this._zoom>1?e.setAttribute("data-zoomed",""):e.removeAttribute("data-zoomed"))}}a(St,"tagName","lumina-image-zoom"),customElements.get(St.tagName)||customElements.define(St.tagName,St);class zt extends u{constructor(){super(...arguments);a(this,"field",null);a(this,"input",null);a(this,"echo",null);a(this,"echoCtx",null);a(this,"echoRipples",[]);a(this,"echoRaf",0);a(this,"_floatingLabel",!1);a(this,"onInput",t=>{const e=t.target;this.spawnEcho(),this._updateFloatingState(),this.dispatchEvent(new CustomEvent("lumina-change",{detail:{value:e.value},bubbles:!0,composed:!0}))});a(this,"onFocus",()=>{(this.variant==="neural"||this.variant==="aura")&&this.spawnField(),this.dispatchEvent(new CustomEvent("lumina-focus",{detail:{value:this.input?.value??""},bubbles:!0,composed:!0}))});a(this,"onBlur",()=>{this.field?.destroy(),this.field=null,this.dispatchEvent(new CustomEvent("lumina-blur",{detail:{value:this.input?.value??""},bubbles:!0,composed:!0}))});a(this,"onKeyDown",t=>{t.key==="Enter"&&this.dispatchEvent(new CustomEvent("lumina-submit",{detail:{value:this.input?.value??""},bubbles:!0,composed:!0}))});a(this,"tickEcho",()=>{if(!this.echoCtx)return;const t=this.shadow.host.style.getPropertyValue("--lumina-accent-rgb").trim()||"124 92 255",e=this.clientWidth,i=this.clientHeight;this.echoCtx.clearRect(0,0,e,i),this.echoRipples=this.echoRipples.filter(r=>r.life<r.maxLife);for(const r of this.echoRipples){r.life+=1;const s=r.life/r.maxLife,o=4+s*30,d=(1-s)*.6;this.echoCtx.strokeStyle=`rgba(${t} / ${d})`,this.echoCtx.lineWidth=1.5,this.echoCtx.beginPath(),this.echoCtx.arc(r.x,r.y,o,0,Math.PI*2),this.echoCtx.stroke()}this.echoRipples.length>0?this.echoRaf=requestAnimationFrame(this.tickEcho):this.echoRaf=0})}static get observedAttributes(){return[...u.observedAttributes,"type","placeholder","value","label","disabled","required","invalid","name","floating-label"]}get floatingLabel(){return this._floatingLabel}set floatingLabel(t){this._floatingLabel=t,t?this.setAttribute("floating-label",""):this.removeAttribute("floating-label"),this._updateFloatingState()}get value(){return this.input?.value??""}set value(t){this.input&&(this.input.value=t),this.setAttribute("value",t),this._updateFloatingState()}render(){const t=this._floatingLabel?"":`placeholder="${this.getAttribute("placeholder")??""}"`;return`
    ...
    `}mounted(){if(this.input=this.$$(".lumina-input__el"),this.echo=this.$$(".lumina-input__echo"),this.echoCtx=this.echo?.getContext("2d")??null,this._floatingLabel=this.hasAttribute("floating-label"),this.input){this.input.addEventListener("input",this.onInput),this.input.addEventListener("focus",this.onFocus),this.input.addEventListener("blur",this.onBlur),this.input.addEventListener("keydown",this.onKeyDown);const t=this.getAttribute("value");t!==null&&(this.input.value=t)}this._updateFloatingState()}_updateFloatingState(){if(!this.input)return;const t=this.input.value.length>0,e=this.$$(".lumina-input");e&&e.classList.toggle("lumina-input--has-value",t)}unmounted(){this.input?.removeEventListener("input",this.onInput),this.input?.removeEventListener("focus",this.onFocus),this.input?.removeEventListener("blur",this.onBlur),this.input?.removeEventListener("keydown",this.onKeyDown),this.field?.destroy(),this.field=null,cancelAnimationFrame(this.echoRaf)}onConfigChange(t){(t.variant||t.intensity)&&(this.field?.destroy(),this.field=null)}attributeChangedCallback(t,e,i){super.attributeChangedCallback(t,e,i),t==="value"&&i!==null&&this.input?(this.input.value=i,this._updateFloatingState()):t==="floating-label"&&(this._floatingLabel=i!==null,this._mounted&&(this.shadow.innerHTML=this.render(),this.input=this.$$(".lumina-input__el"),this.input&&(this.input.value=this.getAttribute("value")??"",this.input.addEventListener("input",this.onInput),this.input.addEventListener("focus",this.onFocus),this.input.addEventListener("blur",this.onBlur),this.input.addEventListener("keydown",this.onKeyDown)),this._updateFloatingState()))}spawnField(){if(this.field)return;const t=this.$$(".lumina-input__field");if(!t)return;const e=this.shadow.host.style.getPropertyValue("--lumina-accent-rgb").trim()||"124 92 255",i=k(this.intensity);this.field=new A(this.shadow.host,{count:Math.round(18*i),rgb:e,sizeRange:[.6,1.8],speedRange:[.2,.5],lifeRange:[80,140],connect:this.variant==="neural"}),this.field.mount(t)}spawnEcho(){if(p()||!this.echoCtx||!this.echo||!this.input)return;const t=window.devicePixelRatio||1,e=this.clientWidth,i=this.clientHeight;this.echo.width=e*t,this.echo.height=i*t,this.echo.style.width=`${e}px`,this.echo.style.height=`${i}px`,this.echoCtx.setTransform(t,0,0,t,0,0);const r=window.getComputedStyle(this.input),s=parseFloat(r.fontSize),o=parseFloat(r.paddingLeft),d=this.input.value.length*s*.55,c=Math.min(o+d+2,e-8),m=i/2;this.echoRipples.push({x:c,y:m,life:0,maxLife:30}),this.echoRaf||this.tickEcho()}}a(zt,"tagName","lumina-input"),customElements.get(zt.tagName)||customElements.define(zt.tagName,zt);class Mt extends u{constructor(){super(...arguments);a(this,"_images",[]);a(this,"_currentIdx",0);a(this,"_open",!1);a(this,"zoom",1);a(this,"img",null);a(this,"onWheel",t=>{t.preventDefault(),this.zoom=Math.max(1,Math.min(5,this.zoom+(t.deltaY>0?-.2:.2))),this.img&&(this.img.style.transform=`scale(${this.zoom})`,this.zoom>1?this.img.setAttribute("data-zoom",""):this.img.removeAttribute("data-zoom"))});a(this,"onKeydown",t=>{this._open&&(t.key==="Escape"?this.hide():t.key==="ArrowLeft"?this.navigate(-1):t.key==="ArrowRight"&&this.navigate(1))})}static get observedAttributes(){return[...u.observedAttributes,"src","images"]}render(){return`
    ...
    `}mounted(){this.surface=this.$$(".lmlc__surface"),this.addEventListener("pointermove",this.onMove),this.addEventListener("pointerleave",this.onLeave),this.addEventListener("click",this.onClick)}unmounted(){cancelAnimationFrame(this.raf),this.removeEventListener("pointermove",this.onMove),this.removeEventListener("pointerleave",this.onLeave),this.removeEventListener("click",this.onClick)}onConfigChange(t){}}a(Nt,"tagName","lumina-liquid-card"),customElements.get(Nt.tagName)||customElements.define(Nt.tagName,Nt);class It extends u{constructor(){super(...arguments);a(this,"draggedIdx",-1)}static get observedAttributes(){return[...u.observedAttributes,"sortable"]}render(){return'<ul class="lmls" part="list"><slot></slot></ul>'}styles(){return`
      :host { display: block; font-family: var(--lumina-font-sans); color: var(--lumina-text); }
    ...
    `}mounted(){this.applyStagger(),this.hasAttribute("sortable")&&this.setupDragDrop()}unmounted(){}onConfigChange(t){}applyStagger(){this.querySelectorAll("li, [data-list-item]").forEach((e,i)=>{e.style.animationDelay=`${i*.06}s`})}setupDragDrop(){const t=this.querySelectorAll("li, [data-list-item]");t.forEach((e,i)=>{e.setAttribute("draggable","true"),e.addEventListener("dragstart",()=>{this.draggedIdx=i,e.setAttribute("data-dragging","")}),e.addEventListener("dragend",()=>{e.removeAttribute("data-dragging"),t.forEach(r=>r.removeAttribute("data-drag-over"))}),e.addEventListener("dragover",r=>{r.preventDefault(),i!==this.draggedIdx&&e.setAttribute("data-drag-over","")}),e.addEventListener("dragleave",()=>e.removeAttribute("data-drag-over")),e.addEventListener("drop",r=>{if(r.preventDefault(),e.removeAttribute("data-drag-over"),this.draggedIdx>=0&&this.draggedIdx!==i){const s=e.parentElement;if(!s)return;const d=Array.from(s.children)[this.draggedIdx];i<this.draggedIdx?s.insertBefore(d,e):s.insertBefore(d,e.nextSibling),this.applyStagger(),this.dispatchEvent(new CustomEvent("lumina-reorder",{bubbles:!0,composed:!0,detail:{from:this.draggedIdx,to:i}}))}this.draggedIdx=-1})})}}a(It,"tagName","lumina-list"),customElements.get(It.tagName)||customElements.define(It.tagName,It);class Tt extends u{constructor(){super(...arguments);a(this,"_size",64);a(this,"_overlay",!1);a(this,"_text","");a(this,"field",null);a(this,"fieldHost",null)}static get observedAttributes(){return[...u.observedAttributes,"size","overlay","text"]}get size(){return this._size}set size(t){this._size=t,this.setAttribute("size",String(t)),this.applySize()}get overlay(){return this._overlay}set overlay(t){this._overlay=t,t?this.setAttribute("overlay",""):this.removeAttribute("overlay")}get text(){return this._text}set text(t){this._text=t,this.setAttribute("text",t),this.applyText()}render(){return`
    ...
    `}mounted(){this.fieldHost=this.$$(".lml__particles"),this._size=parseFloat(this.getAttribute("size")??"64")||64,this._overlay=this.hasAttribute("overlay"),this._text=this.getAttribute("text")??"",this.applySize(),this.applyText(),p()||this.maybeInitField()}unmounted(){this.field?.destroy(),this.field=null}onConfigChange(t){t.variant&&(this.field?.destroy(),this.field=null,this.maybeInitField())}attributeChangedCallback(t,e,i){super.attributeChangedCallback(t,e,i),t==="size"?(this._size=parseFloat(i??"64")||64,this.applySize()):t==="overlay"?this._overlay=i!==null:t==="text"&&(this._text=i??"",this.applyText())}applySize(){this.style.setProperty("--lml-size",`${this._size}px`)}applyText(){const t=this.$$(".lml__text");t&&(t.textContent=this._text)}maybeInitField(){if(!this.fieldHost)return;const t=this.variant;if(t!=="neural"&&t!=="void")return;const e=this.shadow.host.style.getPropertyValue("--lumina-accent-rgb").trim()||(t==="void"?"120 240 255":"124 92 255");this.field=new A(this.shadow.host,{count:24,rgb:e,sizeRange:[.6,1.8],speedRange:[.2,.6],lifeRange:[100,200],connect:t==="neural",starfield:t==="void"}),this.field.mount(this.fieldHost)}}a(Tt,"tagName","lumina-loading"),customElements.get(Tt.tagName)||customElements.define(Tt.tagName,Tt);class Ft extends u{constructor(){super(...arguments);a(this,"_strength",.4);a(this,"btn",null);a(this,"targetX",0);a(this,"targetY",0);a(this,"currentX",0);a(this,"currentY",0);a(this,"raf",0);a(this,"tracking",!1);a(this,"onPointerMove",t=>{if(!this.btn)return;const e=this.getBoundingClientRect(),i=e.left+e.width/2,r=e.top+e.height/2,s=(t.clientX-i)*this._strength,o=(t.clientY-r)*this._strength;this.targetX=s,this.targetY=o,this.tracking||(this.tracking=!0,this.dispatchEvent(new CustomEvent("lumina-magnetic-start",{bubbles:!0,composed:!0,detail:{strength:this._strength}})),this.tick())});a(this,"onPointerLeave",()=>{this.targetX=0,this.targetY=0});a(this,"tick",()=>{this.btn&&(this.currentX+=(this.targetX-this.currentX)*.15,this.currentY+=(this.targetY-this.currentY)*.15,this.btn.style.transform=`translate(${this.currentX}px, ${this.currentY}px)`,Math.abs(this.targetX-this.currentX)>.1||Math.abs(this.targetY-this.currentY)>.1||Math.abs(this.currentX)>.1||Math.abs(this.currentY)>.1?this.raf=requestAnimationFrame(this.tick):(this.tracking=!1,this.btn.style.transform=""))});a(this,"onClick",()=>{this.dispatchEvent(new CustomEvent("lumina-click",{bubbles:!0,composed:!0}))});a(this,"onKeydown",t=>{(t.key==="Enter"||t.key===" ")&&(t.preventDefault(),this.onClick())})}static get observedAttributes(){return[...u.observedAttributes,"magnetic-strength"]}get magneticStrength(){return this._strength}set magneticStrength(t){this._strength=f(t,0,1),this.setAttribute("magnetic-strength",String(this._strength))}render(){return`
    ...
    `}mounted(){this._strength=f(parseFloat(this.getAttribute("magnetic-strength")??"0.4")||.4,0,1),this.btn=this.$$(".lmmb"),this.setAttribute("role","button"),this.setAttribute("tabindex","0"),p()||(this.addEventListener("pointermove",this.onPointerMove),this.addEventListener("pointerleave",this.onPointerLeave)),this.btn?.addEventListener("click",this.onClick),this.btn?.addEventListener("keydown",this.onKeydown)}unmounted(){cancelAnimationFrame(this.raf)}onConfigChange(t){}attributeChangedCallback(t,e,i){super.attributeChangedCallback(t,e,i),t==="magnetic-strength"&&(this._strength=f(parseFloat(i??"0.4")||.4,0,1))}}a(Ft,"tagName","lumina-magnetic-button"),customElements.get(Ft.tagName)||customElements.define(Ft.tagName,Ft);class Pt extends u{static get observedAttributes(){return[...u.observedAttributes]}render(){return`
      <nav class="lmc" part="bar">
        <div class="lmc__glow" part="glow" aria-hidden="true"></div>
        <div class="lmc__inner"><slot></slot></div>
      </nav>
...
`}mounted(){}unmounted(){}onConfigChange(n){}emit(n,t){this.dispatchEvent(new CustomEvent(n,{bubbles:!0,composed:!0,detail:t}))}open(){this.setAttribute("open",""),this.setAttribute("data-open",""),this.emit("lumina-open")}close(){this.removeAttribute("open"),this.removeAttribute("data-open"),this.emit("lumina-close")}}a(Pt,"tagName","lumina-mega-menu"),customElements.get(Pt.tagName)||customElements.define(Pt.tagName,Pt);class Rt extends u{constructor(){super(...arguments);a(this,"_memoryEnabled",!0);a(this,"canvas",null);a(this,"ctx",null);a(this,"memory",[]);a(this,"raf",0);a(this,"hoverCount",0);a(this,"clickCount",0);a(this,"totalTime",0);a(this,"lastTime",0);a(this,"onMove",t=>{const e=this.getBoundingClientRect(),i=t.clientX-e.left,r=t.clientY-e.top;this.memory.push({x:i,y:r,age:0,intensity:1}),this.memory.length>100&&this.memory.shift()});a(this,"onClick",()=>{this.clickCount++,this.updateWarmth(),this.dispatchEvent(new CustomEvent("lumina-memory-update",{bubbles:!0,composed:!0,detail:{hovers:this.hoverCount,clicks:this.clickCount,time:this.totalTime}}))});a(this,"onEnter",()=>{this.hoverCount++,this.updateWarmth()});a(this,"onLeave",()=>{this.updateWarmth()});a(this,"tick",()=>{const t=Date.now(),e=(t-this.lastTime)/1e3;if(this.lastTime=t,this.matches(":hover")&&(this.totalTime+=e),this.ctx&&this.canvas){const i=window.devicePixelRatio||1,r=this.clientWidth,s=this.clientHeight;this.canvas.width!==r*i&&(this.canvas.width=r*i,this.canvas.height=s*i,this.canvas.style.width=`${r}px`,this.canvas.style.height=`${s}px`,this.ctx.setTransform(i,0,0,i,0,0)),this.ctx.clearRect(0,0,r,s);const o=this.shadow.host.style.getPropertyValue("--lumina-accent-rgb").trim()||"124 92 255";this.memory=this.memory.filter(d=>d.age<60);for(const d of this.memory){d.age+=1;const c=(1-d.age/60)*.4;this.ctx.fillStyle=`rgba(${o} / ${c})`,this.ctx.beginPath(),this.ctx.arc(d.x,d.y,3+d.age*.3,0,Math.PI*2),this.ctx.fill()}}this.raf=requestAnimationFrame(this.tick)})}static get observedAttributes(){return[...u.observedAttributes,"memory-enabled"]}get memoryEnabled(){return this._memoryEnabled}set memoryEnabled(t){this._memoryEnabled=t,t?this.setAttribute("memory-enabled",""):this.removeAttribute("memory-enabled")}render(){return`
    ...
    `}mounted(){this.dialog=this.$$(".lumina-modal"),this.backdrop=this.$$(".lumina-modal__backdrop"),this.portal=this.$$(".lumina-modal__portal"),this.$$(".lumina-modal__close")?.addEventListener("click",()=>this.close()),this.backdrop?.addEventListener("click",()=>{this.getAttribute("closable")!=="false"&&this.close()}),document.addEventListener("keydown",this.onKeyDown),this.hasAttribute("open")&&requestAnimationFrame(()=>this.showModal())}unmounted(){document.removeEventListener("keydown",this.onKeyDown),this.dialog?.open&&this.dialog.close()}onConfigChange(t){}showModal(){if(!(this._open||!this.dialog)){this.previouslyFocused=document.activeElement,this._open=!0,this.setAttribute("data-open",""),this.setAttribute("open","");try{this.dialog.showModal()}catch{}requestAnimationFrame(()=>{this.$$('button, [tabindex]:not([tabindex="-1"]), input, a[href]')?.focus()}),this.dispatchEvent(new CustomEvent("lumina-open",{bubbles:!0,composed:!0}))}}close(){!this._open||!this.dialog||(this._open=!1,this.removeAttribute("data-open"),this.removeAttribute("open"),p()?this.dialog.close():setTimeout(()=>this.dialog?.close(),350),this.previouslyFocused?.focus(),this.dispatchEvent(new CustomEvent("lumina-close",{bubbles:!0,composed:!0})))}}a(Dt,"tagName","lumina-modal"),customElements.get(Dt.tagName)||customElements.define(Dt.tagName,Dt);const N={pill:"polygon(0 0, 100% 0, 100% 100%, 0 100%)",squircle:"polygon(20% 0, 80% 0, 100% 20%, 100% 80%, 80% 100%, 20% 100%, 0 80%, 0 20%)",hexagon:"polygon(25% 0, 75% 0, 100% 50%, 75% 100%, 25% 100%, 0 50%)",diamond:"polygon(50% 0, 100% 50%, 50% 100%, 0 50%)",star:"polygon(50% 0, 61% 35%, 98% 35%, 68% 57%, 79% 91%, 50% 70%, 21% 91%, 32% 57%, 2% 35%, 39% 35%)"};class Yt extends u{constructor(){super(...arguments);a(this,"_from","pill");a(this,"_to","squircle");a(this,"iconEl",null);a(this,"onEnter",()=>{const t=this.$$(".lmob");t&&(t.style.clipPath=N[this._to]??N.squircle),this._from.length<=2&&this._to.length<=2&&this.iconEl&&(this.iconEl.textContent=this._to),this.dispatchEvent(new CustomEvent("lumina-morph-start",{bubbles:!0,composed:!0,detail:{from:this._from,to:this._to}}))});a(this,"onLeave",()=>{const t=this.$$(".lmob");t&&(t.style.clipPath=N[this._from]??N.pill),this._from.length<=2&&this._to.length<=2&&this.iconEl&&(this.iconEl.textContent=this._from),this.dispatchEvent(new CustomEvent("lumina-morph-end",{bubbles:!0,composed:!0,detail:{from:this._to,to:this._from}}))});a(this,"onClick",()=>{this.dispatchEvent(new CustomEvent("lumina-click",{bubbles:!0,composed:!0}))});a(this,"onKeydown",t=>{(t.key==="Enter"||t.key===" ")&&(t.preventDefault(),this.onClick())})}static get observedAttributes(){return[...u.observedAttributes,"from","to"]}get from(){return this._from}set from(t){this._from=t,this.setAttribute("from",t),this.applyShape()}get to(){return this._to}set to(t){this._to=t,this.setAttribute("to",t),this.applyShape()}render(){return`
    ...
    `}mounted(){this._from=this.getAttribute("from")??"pill",this._to=this.getAttribute("to")??"squircle",this.iconEl=this.$$(".lmob__icon"),this.applyShape(),this.getAttribute("role")!=="button"&&this.setAttribute("role","button"),this.setAttribute("tabindex","0"),this.$$(".lmob")?.addEventListener("click",this.onClick),this.$$(".lmob")?.addEventListener("keydown",this.onKeydown),this.addEventListener("pointerenter",this.onEnter),this.addEventListener("pointerleave",this.onLeave)}unmounted(){}onConfigChange(t){}attributeChangedCallback(t,e,i){super.attributeChangedCallback(t,e,i),t==="from"?(this._from=i??"pill",this.applyShape()):t==="to"&&(this._to=i??"squircle",this.applyShape())}applyShape(){const t=this.$$(".lmob");t&&(t.style.clipPath=N[this._from]??N.pill)}}a(Yt,"tagName","lumina-morph-button"),customElements.get(Yt.tagName)||customElements.define(Yt.tagName,Yt);const ui={subtle:{rest:"polygon(0 0, 100% 0, 100% 100%, 0 100%)",hover:"polygon(3% 0, 97% 0, 100% 50%, 97% 100%, 3% 100%, 0 50%)"},intense:{rest:"polygon(8% 0, 92% 0, 100% 8%, 100% 92%, 92% 100%, 8% 100%, 0 92%, 0 8%)",hover:"polygon(0 0, 100% 0, 100% 100%, 0 100%)"},extreme:{rest:"polygon(50% 0, 100% 38%, 82% 100%, 18% 100%, 0 38%)",hover:"polygon(20% 0, 80% 0, 100% 50%, 80% 100%, 20% 100%, 0 50%)"}};class Vt extends u{constructor(){super(...arguments);a(this,"card",null);a(this,"onEnter",()=>{this.applyShape("hover"),this.dispatchEvent(new CustomEvent("lumina-morph-start",{bubbles:!0,composed:!0,detail:{variant:this.variant,state:"hover"}}))});a(this,"onLeave",()=>{this.applyShape("rest"),this.dispatchEvent(new CustomEvent("lumina-morph-end",{bubbles:!0,composed:!0,detail:{variant:this.variant,state:"rest"}}))})}render(){return`
      <article class="lmmc" part="card">
        <div class="lmmc__surface" part="surface">
          <slot></slot>
        </div>
    ...
    `}mounted(){this.card=this.$$(".lmmc"),this.applyShape("rest"),this.addEventListener("pointerenter",this.onEnter),this.addEventListener("pointerleave",this.onLeave)}unmounted(){this.removeEventListener("pointerenter",this.onEnter),this.removeEventListener("pointerleave",this.onLeave)}onConfigChange(t){t.variant&&this.applyShape("rest")}applyShape(t){if(!this.card)return;const e=ui[this.variant]??ui.subtle;this.card.style.clipPath=e[t]}}a(Vt,"tagName","lumina-morph-card"),customElements.get(Vt.tagName)||customElements.define(Vt.tagName,Vt);const L=["lumina-button","lumina-card","lumina-badge","lumina-chip","lumina-input","lumina-toggle-button"];class Xt extends u{constructor(){super(...arguments);a(this,"_target","lumina-button");a(this,"stage",null);a(this,"currentIdx",0)}static get observedAttributes(){return[...u.observedAttributes,"target"]}render(){return`
    ...
    `}mounted(){this.stage=this.$$(".lmml__stage"),this._target=this.getAttribute("target")??L[0],this.currentIdx=Math.max(0,L.indexOf(this._target)),this.renderTimeline(),this.renderTarget(),this.$$('.lmml__btn[data-dir="prev"]')?.addEventListener("click",()=>this.morph(-1)),this.$$('.lmml__btn[data-dir="next"]')?.addEventListener("click",()=>this.morph(1))}unmounted(){}onConfigChange(t){}attributeChangedCallback(t,e,i){super.attributeChangedCallback(t,e,i),t==="target"&&(this._target=i??L[0],this.currentIdx=Math.max(0,L.indexOf(this._target)),this.renderTarget(),this.renderTimeline())}morph(t){this.currentIdx=(this.currentIdx+t+L.length)%L.length,this._target=L[this.currentIdx],this.setAttribute("target",this._target),this.renderTarget(),this.renderTimeline(),this.dispatchEvent(new CustomEvent("lumina-morph",{bubbles:!0,composed:!0,detail:{target:this._target,index:this.currentIdx}}))}renderTarget(){if(!this.stage)return;const t=this._target,e=document.createElement(t);e.setAttribute("variant","glass"),e.setAttribute("intensity","intense"),e.setAttribute("accent-color","#7c5cff"),t==="lumina-button"||t==="lumina-toggle-button"?e.textContent="Morph me":t==="lumina-card"?e.innerHTML='<h3 slot="title">Morph Card</h3><p>Morphing em tempo real.</p>':t==="lumina-badge"?(e.textContent="MORPH",e.setAttribute("dot","")):t==="lumina-chip"?e.textContent="Morph Chip":t==="lumina-input"&&e.setAttribute("placeholder","Morph input..."),this.stage.innerHTML="",this.stage.appendChild(e);const i=this.$$(".lmml__label");i&&(i.textContent=`<${t}>`)}renderTimeline(){const t=this.$$(".lmml__timeline");t&&(t.innerHTML="",L.forEach((e,i)=>{const r=document.createElement("div");r.className="lmml__dot",i===this.currentIdx&&r.setAttribute("data-active",""),r.addEventListener("click",()=>{this.currentIdx=i,this._target=e,this.setAttribute("target",e),this.renderTarget(),this.renderTimeline()}),t.appendChild(r)}))}}a(Xt,"tagName","lumina-morph-lab"),customElements.get(Xt.tagName)||customElements.define(Xt.tagName,Xt);class qt extends u{constructor(){super(...arguments);a(this,"_options",[]);a(this,"_selected",[]);a(this,"_max",0);a(this,"chipsEl",null);a(this,"menuEl",null);a(this,"searchEl",null);a(this,"_open",!1);a(this,"draggedChip",null);a(this,"toggleMenu",t=>{t?.stopPropagation(),this._open=!this._open,this._open?(this.setAttribute("data-open",""),setTimeout(()=>this.searchEl?.focus(),50)):this.removeAttribute("data-open")});a(this,"onDocClick",t=>{!this.contains(t.target)&&this._open&&this.toggleMenu()})}static get observedAttributes(){return[...u.observedAttributes,"options","value","max","name","disabled","required","invalid","valid"]}get value(){return this._selected.join(",")}set value(t){this._selected=t?t.split(","):[],this.setAttribute("value",t),this.renderChips()}get options(){return this._options}set options(t){this._options=t,this.setAttribute("options",JSON.stringify(t)),this.renderMenu()}get max(){return this._max}set max(t){this._max=t,this.setAttribute("max",String(t))}render(){return`
    ...
    `),n.adoptedStyleSheets=[t],n.innerHTML="<slot></slot>",this.setAttribute("role","button"),this.setAttribute("tabindex","0"),this.addEventListener("keydown",e=>{(e.key==="Enter"||e.key===" ")&&(e.preventDefault(),this.click())})}}a(Ht,"tagName","lumina-nav-item"),customElements.get(Bt.tagName)||customElements.define(Bt.tagName,Bt),customElements.get(Ht.tagName)||customElements.define(Ht.tagName,Ht);class Ot extends u{constructor(){super(...arguments);a(this,"_particleCount",20);a(this,"field",null);a(this,"fieldHost",null);a(this,"onClick",()=>{this.dispatchEvent(new CustomEvent("lumina-click",{bubbles:!0,composed:!0}))});a(this,"onKeydown",t=>{(t.key==="Enter"||t.key===" ")&&(t.preventDefault(),this.onClick())})}static get observedAttributes(){return[...u.observedAttributes,"particle-count"]}get particleCount(){return this._particleCount}set particleCount(t){this._particleCount=t,this.setAttribute("particle-count",String(t)),this.rebuildField()}render(){return`
    ...
    `}mounted(){this._particleCount=parseInt(this.getAttribute("particle-count")??"20",10)||20,this.fieldHost=this.$$(".lmnb__field"),this.setAttribute("role","button"),this.setAttribute("tabindex","0"),this.$$(".lmnb")?.addEventListener("click",this.onClick),this.$$(".lmnb")?.addEventListener("keydown",this.onKeydown),p()||this.buildField()}unmounted(){this.field?.destroy(),this.field=null}onConfigChange(t){(t.intensity||t["accent-color"])&&this.rebuildField()}attributeChangedCallback(t,e,i){super.attributeChangedCallback(t,e,i),t==="particle-count"&&(this._particleCount=parseInt(i??"20",10)||20,this.rebuildField())}rebuildField(){this.field?.destroy(),this.field=null,p()||this.buildField()}buildField(){if(!this.fieldHost)return;const t=this.shadow.host.style.getPropertyValue("--lumina-accent-rgb").trim()||"124 92 255",e=k(this.intensity);this.field=new A(this.shadow.host,{count:Math.round(this._particleCount*e),rgb:t,sizeRange:[.6,1.8],speedRange:[.15,.5],lifeRange:[100,200],connect:!0}),this.field.mount(this.fieldHost)}}a(Ot,"tagName","lumina-neural-button"),customElements.get(Ot.tagName)||customElements.define(Ot.tagName,Ot);class Kt extends u{constructor(){super(...arguments);a(this,"_particleCount",40);a(this,"field",null);a(this,"fieldHost",null);a(this,"onMove",()=>{this.dispatchEvent(new CustomEvent("lumina-hover",{bubbles:!0,composed:!0}))});a(this,"onClick",()=>{this.dispatchEvent(new CustomEvent("lumina-interact",{bubbles:!0,composed:!0,detail:{type:"click"}}))})}static get observedAttributes(){return[...u.observedAttributes,"particle-count"]}get particleCount(){return this._particleCount}set particleCount(t){this._particleCount=t,this.setAttribute("particle-count",String(t)),this.rebuildField()}render(){return`
    ...
    `}mounted(){this._particleCount=parseInt(this.getAttribute("particle-count")??"40",10)||40,this.fieldHost=this.$$(".lmnc__particles"),p()||this.buildField(),this.addEventListener("pointermove",this.onMove),this.addEventListener("click",this.onClick)}unmounted(){this.field?.destroy(),this.field=null}onConfigChange(t){(t.intensity||t["accent-color"])&&this.rebuildField()}attributeChangedCallback(t,e,i){super.attributeChangedCallback(t,e,i),t==="particle-count"&&(this._particleCount=parseInt(i??"40",10)||40,this.rebuildField())}rebuildField(){this.field?.destroy(),this.field=null,p()||this.buildField()}buildField(){if(!this.fieldHost)return;const t=this.shadow.host.style.getPropertyValue("--lumina-accent-rgb").trim()||"124 92 255",e=k(this.intensity);this.field=new A(this.shadow.host,{count:Math.round(this._particleCount*e),rgb:t,sizeRange:[.6,2],speedRange:[.1,.4],lifeRange:[120,240],connect:!0,starfield:this.variant==="void"}),this.field.mount(this.fieldHost)}}a(Kt,"tagName","lumina-neural-card"),customElements.get(Kt.tagName)||customElements.define(Kt.tagName,Kt);const ji=["bom","ótimo","excelente","feliz","amor","perfeito","incrível","sucesso","ganhar","vitória","❤","👍","😊","🎉","✨","💪","🚀","💯"],Wi=["ruim","péssimo","triste","ódio","erro","falha","perder","problema","droga","👎","😢","💀","🔥","⚠","💔","😡"],Ui={positive:{color:"#22c55e",glow:"34 197 94"},negative:{color:"#ef4444",glow:"239 68 68"},neutral:{color:"var(--lumina-accent)",glow:"var(--lumina-accent-rgb)"}};class jt extends u{constructor(){super(...arguments);a(this,"input",null);a(this,"reactionEl",null);a(this,"currentSentiment","neutral");a(this,"_floatingLabel",!1);a(this,"onInput",t=>{const e=t.target.value,i=e.toLowerCase();this._updateFloatingState(),this.dispatchEvent(new CustomEvent("lumina-input",{bubbles:!0,composed:!0,detail:{value:e}})),this.dispatchEvent(new CustomEvent("lumina-change",{bubbles:!0,composed:!0,detail:{value:e}}));let r="neutral",s="",o=0,d=0;for(const c of ji)i.includes(c.toLowerCase())&&o++;for(const c of Wi)i.includes(c.toLowerCase())&&d++;if(o>d?(r="positive",s="😊"):d>o?(r="negative",s="😟"):e.length>0&&(s="✨"),r!==this.currentSentiment){this.currentSentiment=r;const c=Ui[r];this.style.setProperty("--lmni-color",c.color),this.style.setProperty("--lmni-glow",c.glow),this.dispatchEvent(new CustomEvent("lumina-sentiment-change",{bubbles:!0,composed:!0,detail:{sentiment:r}}))}this.reactionEl&&(s?(this.reactionEl.textContent=s,this.reactionEl.setAttribute("data-show","")):this.reactionEl.removeAttribute("data-show"))});a(this,"onFocus",()=>{this.dispatchEvent(new CustomEvent("lumina-focus",{bubbles:!0,composed:!0,detail:{value:this.value}}))});a(this,"onBlur",()=>{this.dispatchEvent(new CustomEvent("lumina-blur",{bubbles:!0,composed:!0,detail:{value:this.value}}))})}static get observedAttributes(){return[...u.observedAttributes,"value","placeholder","name","disabled","required","invalid","valid","floating-label"]}get value(){return this.input?.value??""}set value(t){this.input&&(this.input.value=t),this.setAttribute("value",t),this._updateFloatingState()}get floatingLabel(){return this._floatingLabel}set floatingLabel(t){this._floatingLabel=t,t?this.setAttribute("floating-label",""):this.removeAttribute("floating-label"),this._updateFloatingState()}render(){const t=this._floatingLabel?"":`placeholder="${this.getAttribute("placeholder")??"Digite algo..."}"`;return`
    ...
    `}mounted(){this.input=this.$$(".lmni__el"),this.reactionEl=this.$$(".lmni__reaction"),this.input?.addEventListener("input",this.onInput),this.input?.addEventListener("focus",this.onFocus),this.input?.addEventListener("blur",this.onBlur),this._updateFloatingState()}unmounted(){this.input?.removeEventListener("input",this.onInput),this.input?.removeEventListener("focus",this.onFocus),this.input?.removeEventListener("blur",this.onBlur)}onConfigChange(t){}attributeChangedCallback(t,e,i){super.attributeChangedCallback(t,e,i),t==="value"&&this.input&&i!==null?(this.input.value=i,this._updateFloatingState()):t==="disabled"&&this.input?this.input.disabled=i!==null:t==="floating-label"&&(this._floatingLabel=i!==null)}_updateFloatingState(){this.toggleAttribute("data-has-value",this.value.length>0)}}a(jt,"tagName","lumina-neural-input"),customElements.get(jt.tagName)||customElements.define(jt.tagName,jt);class Wt extends u{constructor(){super(...arguments);a(this,"_progress",0);a(this,"canvas",null);a(this,"ctx",null);a(this,"nodes",[]);a(this,"raf",0);a(this,"allNodes",[]);a(this,"tick",()=>{if(!this.ctx||!this.canvas){this.raf=requestAnimationFrame(this.tick);return}const t=this.canvas.clientWidth||80;this.ctx.clearRect(0,0,t,t);const e=this.shadow.host.style.getPropertyValue("--lumina-accent-rgb").trim()||"124 92 255";for(const r of this.nodes)r.x+=r.vx,r.y+=r.vy,(r.x<t*.15||r.x>t*.85)&&(r.vx*=-1),(r.y<t*.15||r.y>t*.85)&&(r.vy*=-1);const i=t*.35;for(let r=0;r<this.nodes.length;r++)for(let s=r+1;s<this.nodes.length;s++){const o=this.nodes[r],d=this.nodes[s],c=o.x-d.x,m=o.y-d.y,b=Math.sqrt(c*c+m*m);if(b<i){const y=(1-b/i)*.4;this.ctx.strokeStyle=`rgba(${e} / ${y})`,this.ctx.lineWidth=1,this.ctx.beginPath(),this.ctx.moveTo(o.x,o.y),this.ctx.lineTo(d.x,d.y),this.ctx.stroke()}}for(const r of this.nodes)this.ctx.fillStyle=`rgba(${e} / 0.9)`,this.ctx.beginPath(),this.ctx.arc(r.x,r.y,3,0,Math.PI*2),this.ctx.fill(),this.ctx.fillStyle=`rgba(${e} / 0.3)`,this.ctx.beginPath(),this.ctx.arc(r.x,r.y,6,0,Math.PI*2),this.ctx.fill();this.raf=requestAnimationFrame(this.tick)})}static get observedAttributes(){return[...u.observedAttributes,"progress"]}get progress(){return this._progress}set progress(t){this._progress=f(t,0,100),this.setAttribute("progress",String(this._progress)),this.updateNodes(),this.dispatchEvent(new CustomEvent("lumina-progress",{bubbles:!0,composed:!0,detail:{progress:this._progress}}))}render(){return`
    ...
    `}mounted(){this._progress=f(parseFloat(this.getAttribute("progress")??"0")||0,0,100);const t=this.getAttribute("variant")==="intense"?100:this.getAttribute("variant")==="subtle"?60:80;this.style.setProperty("--lmnl-size",`${t}px`),this.canvas=this.$$(".lmnl__network"),this.ctx=this.canvas?.getContext("2d")??null,this.initNodes(t),this.updateNodes(),p()||(this.resize(),this.raf=requestAnimationFrame(this.tick))}unmounted(){cancelAnimationFrame(this.raf)}onConfigChange(t){}attributeChangedCallback(t,e,i){super.attributeChangedCallback(t,e,i),t==="progress"&&(this._progress=f(parseFloat(i??"0")||0,0,100),this.updateNodes())}initNodes(t){this.allNodes=[];for(let i=0;i<12;i++)this.allNodes.push({x:v(t*.2,t*.8),y:v(t*.2,t*.8),vx:v(-.3,.3),vy:v(-.3,.3)})}updateNodes(){const t=Math.ceil(this._progress/100*this.allNodes.length);this.nodes=this.allNodes.slice(0,Math.max(1,t))}resize(){if(!this.canvas||!this.ctx)return;const t=window.devicePixelRatio||1,e=this.canvas.clientWidth||80;this.canvas.width=e*t,this.canvas.height=e*t,this.ctx.setTransform(t,0,0,t,0,0)}}a(Wt,"tagName","lumina-neural-loader"),customElements.get(Wt.tagName)||customElements.define(Wt.tagName,Wt);class Ut extends u{constructor(){super(...arguments);a(this,"_count",0);a(this,"_prevCount",0);a(this,"badge",null);a(this,"countEl",null);a(this,"onClick",()=>{this.dispatchEvent(new CustomEvent("lumina-click",{bubbles:!0,composed:!0,detail:{count:this._count}})),this._count>0&&(this._prevCount=this._count,this._count=0,this.setAttribute("count","0"),this.updateDisplay(),this.dispatchEvent(new CustomEvent("lumina-clear",{bubbles:!0,composed:!0})))})}static get observedAttributes(){return[...u.observedAttributes,"count"]}get count(){return this._count}set count(t){this._prevCount=this._count,this._count=Math.max(0,t),this.setAttribute("count",String(this._count)),this.updateDisplay(),this._count>this._prevCount&&this.popAnimation()}render(){return`
...
`}mounted(){}unmounted(){}onConfigChange(n){}emit(n,t){this.dispatchEvent(new CustomEvent(n,{bubbles:!0,composed:!0,detail:t}))}open(){this.setAttribute("open",""),this.setAttribute("data-open",""),this.emit("lumina-open")}close(){this.removeAttribute("open"),this.removeAttribute("data-open"),this.emit("lumina-close")}}a(Jt,"tagName","lumina-orbital-nav"),customElements.get(Jt.tagName)||customElements.define(Jt.tagName,Jt);class Gt extends u{static get observedAttributes(){return[...u.observedAttributes,"page","total"]}get page(){return parseFloat(this.getAttribute("page")??"0")||0}set page(n){this.setAttribute("page",String(n))}get total(){return parseFloat(this.getAttribute("total")??"0")||0}set total(n){this.setAttribute("total",String(n))}render(){return`
      <nav class="lmc" part="bar">
        <div class="lmc__glow" part="glow" aria-hidden="true"></div>
        <div class="lmc__inner"><slot></slot></div>
      </nav>
...
`}mounted(){}unmounted(){}onConfigChange(n){}emit(n,t){this.dispatchEvent(new CustomEvent(n,{bubbles:!0,composed:!0,detail:t}))}open(){this.setAttribute("open",""),this.setAttribute("data-open",""),this.emit("lumina-open")}close(){this.removeAttribute("open"),this.removeAttribute("data-open"),this.emit("lumina-close")}}a(Gt,"tagName","lumina-pagination"),customElements.get(Gt.tagName)||customElements.define(Gt.tagName,Gt);class Zt extends u{constructor(){super(...arguments);a(this,"layerBack",null);a(this,"layerMid",null);a(this,"layerFront",null);a(this,"onMove",C(t=>{const e=this.getBoundingClientRect(),i=(t.clientX-e.left)/e.width-.5,r=(t.clientY-e.top)/e.height-.5;this.layerBack&&(this.layerBack.style.transform=`translateX(${i*30}px) translateY(${r*30}px)`),this.layerMid&&(this.layerMid.style.transform=`translateX(${i*18}px) translateY(${r*18}px)`),this.layerFront&&(this.layerFront.style.transform=`translateX(${i*8}px) translateY(${r*8}px)`),this.dispatchEvent(new CustomEvent("lumina-parallax",{bubbles:!0,composed:!0,detail:{x:i,y:r}}))},16));a(this,"onLeave",()=>{this.layerBack&&(this.layerBack.style.transform=""),this.layerMid&&(this.layerMid.style.transform=""),this.layerFront&&(this.layerFront.style.transform="")})}render(){return`
    ...
    `}mounted(){this.layerBack=this.$$(".lmpc__layer--back"),this.layerMid=this.$$(".lmpc__layer--mid"),this.layerFront=this.$$(".lmpc__layer--front"),p()||(this.addEventListener("pointermove",this.onMove),this.addEventListener("pointerleave",this.onLeave))}unmounted(){this.removeEventListener("pointermove",this.onMove),this.removeEventListener("pointerleave",this.onLeave)}onConfigChange(t){}}a(Zt,"tagName","lumina-parallax-card"),customElements.get(Zt.tagName)||customElements.define(Zt.tagName,Zt);class Qt extends u{constructor(){super(...arguments);a(this,"_particleCount",50);a(this,"field",null);a(this,"fieldHost",null);a(this,"burstCanvas",null);a(this,"burstCtx",null);a(this,"burstParticles",[]);a(this,"burstRaf",0);a(this,"onClick",t=>{const e=this.getBoundingClientRect(),i=t.clientX-e.left,r=t.clientY-e.top;this.spawnBurst(i,r),this.dispatchEvent(new CustomEvent("lumina-particle-interact",{bubbles:!0,composed:!0,detail:{x:i,y:r,type:"click"}}))});a(this,"tickBurst",t=>{if(this.burstCtx){this.burstCtx.clearRect(0,0,this.clientWidth,this.clientHeight),this.burstParticles=this.burstParticles.filter(e=>e.life<e.maxLife);for(const e of this.burstParticles){e.x+=e.vx,e.y+=e.vy,e.vx*=.94,e.vy*=.94,e.life+=1;const i=1-e.life/e.maxLife;this.burstCtx.fillStyle=`rgba(${t} / ${i})`,this.burstCtx.beginPath(),this.burstCtx.arc(e.x,e.y,Math.max(0,e.size*i),0,Math.PI*2),this.burstCtx.fill()}this.burstParticles.length>0?this.burstRaf=requestAnimationFrame(()=>this.tickBurst(t)):(this.burstRaf=0,this.burstCtx.clearRect(0,0,this.clientWidth,this.clientHeight))}})}static get observedAttributes(){return[...u.observedAttributes,"particle-count"]}get particleCount(){return this._particleCount}set particleCount(t){this._particleCount=t,this.setAttribute("particle-count",String(t)),this.rebuildField()}render(){return`
    ...
    `}mounted(){this._particleCount=parseInt(this.getAttribute("particle-count")??"50",10)||50,this.fieldHost=this.$$(".lmpa__particles"),this.burstCanvas=this.$$(".lmpa__burst"),this.burstCtx=this.burstCanvas?.getContext("2d")??null,p()||this.buildField(),this.addEventListener("click",this.onClick)}unmounted(){this.field?.destroy(),this.field=null,cancelAnimationFrame(this.burstRaf)}onConfigChange(t){(t.intensity||t["accent-color"])&&this.rebuildField()}attributeChangedCallback(t,e,i){super.attributeChangedCallback(t,e,i),t==="particle-count"&&(this._particleCount=parseInt(i??"50",10)||50,this.rebuildField())}rebuildField(){this.field?.destroy(),this.field=null,p()||this.buildField()}buildField(){if(!this.fieldHost)return;const t=this.shadow.host.style.getPropertyValue("--lumina-accent-rgb").trim()||"124 92 255",e=k(this.intensity);this.field=new A(this.shadow.host,{count:Math.round(this._particleCount*e),rgb:t,sizeRange:[.6,2],speedRange:[.1,.5],lifeRange:[120,240],connect:this.variant==="neural",starfield:this.variant==="void"}),this.field.mount(this.fieldHost)}spawnBurst(t,e){if(p()||!this.burstCtx||!this.burstCanvas)return;const i=window.devicePixelRatio||1,r=this.clientWidth,s=this.clientHeight;this.burstCanvas.width=r*i,this.burstCanvas.height=s*i,this.burstCanvas.style.width=`${r}px`,this.burstCanvas.style.height=`${s}px`,this.burstCtx.setTransform(i,0,0,i,0,0);const o=this.shadow.host.style.getPropertyValue("--lumina-accent-rgb").trim()||"124 92 255",d=k(this.intensity),c=Math.round(20*d);for(let m=0;m<c;m++){const b=m/c*Math.PI*2+Math.random()*.4,y=2+Math.random()*4*d;this.burstParticles.push({x:t,y:e,vx:Math.cos(b)*y,vy:Math.sin(b)*y,life:0,maxLife:40+Math.random()*30,size:v(1,2.5)})}this.burstRaf||this.tickBurst(o)}}a(Qt,"tagName","lumina-particle-card"),customElements.get(Qt.tagName)||customElements.define(Qt.tagName,Qt);class te extends u{constructor(){super(...arguments);a(this,"_count",60);a(this,"_mode","plain");a(this,"field",null);a(this,"host",null)}static get observedAttributes(){return[...u.observedAttributes,"count","mode"]}render(){return'<div class="lmps" part="root"><div class="lmps__bg" aria-hidden="true"></div><div class="lmps__canvas" part="canvas" aria-hidden="true"></div><div class="lmps__content"><slot></slot></div></div>'}styles(){return`
    ...
    `}mounted(){this._count=parseInt(this.getAttribute("count")??"60",10)||60,this._mode=this.getAttribute("mode")??"plain",this.host=this.$$(".lmps__canvas"),p()||this.buildField()}unmounted(){this.field?.destroy(),this.field=null}onConfigChange(t){(t.intensity||t["accent-color"]||t.variant)&&this.rebuild()}attributeChangedCallback(t,e,i){super.attributeChangedCallback(t,e,i),t==="count"?(this._count=parseInt(i??"60",10)||60,this.rebuild()):t==="mode"&&(this._mode=i??"plain",this.rebuild())}rebuild(){this.field?.destroy(),this.field=null,p()||this.buildField()}buildField(){if(!this.host)return;const t=this.shadow.host.style.getPropertyValue("--lumina-accent-rgb").trim()||"124 92 255",e=k(this.intensity);this.field=new A(this.shadow.host,{count:Math.round(this._count*e),rgb:t,sizeRange:[.6,2.5],speedRange:[.1,.6],lifeRange:[120,280],connect:this._mode==="connect",starfield:this._mode==="starfield"}),this.field.mount(this.host)}burst(t,e,i=20){this.dispatchEvent(new CustomEvent("lumina-particle-burst",{bubbles:!0,composed:!0,detail:{x:t,y:e,count:i}}))}}a(te,"tagName","lumina-particle-system"),customElements.get(te.tagName)||customElements.define(te.tagName,te);class ee extends u{constructor(){super(...arguments);a(this,"_value","");a(this,"_visible",!1);a(this,"_floatingLabel",!1);a(this,"input",null);a(this,"strengthBar",null);a(this,"canvas",null);a(this,"ctx",null);a(this,"particles",[]);a(this,"raf",0);a(this,"onInput",t=>{this._value=t.target.value,this.updateStrength(),this._updateFloatingState(),this.dispatchEvent(new CustomEvent("lumina-change",{bubbles:!0,composed:!0,detail:{value:this._value}}))});a(this,"onFocus",()=>{this.dispatchEvent(new CustomEvent("lumina-focus",{bubbles:!0,composed:!0,detail:{value:this._value}}))});a(this,"onBlur",()=>{this.dispatchEvent(new CustomEvent("lumina-blur",{bubbles:!0,composed:!0,detail:{value:this._value}}))});a(this,"toggleVisibility",()=>{this._visible=!this._visible,this.input&&(this.input.type=this._visible?"text":"password",this.spawnRevealParticles()),this.dispatchEvent(new CustomEvent("lumina-visibility-toggle",{bubbles:!0,composed:!0,detail:{visible:this._visible}}))});a(this,"tick",t=>{if(this.ctx){this.ctx.clearRect(0,0,this.clientWidth,this.clientHeight),this.particles=this.particles.filter(e=>e.life<e.maxLife);for(const e of this.particles){e.x+=e.vx,e.y+=e.vy,e.vy+=.05,e.life+=1;const i=1-e.life/e.maxLife;this.ctx.fillStyle=`rgba(${t} / ${i})`,this.ctx.beginPath(),this.ctx.arc(e.x,e.y,2*i,0,Math.PI*2),this.ctx.fill()}this.particles.length>0?this.raf=requestAnimationFrame(()=>this.tick(t)):(this.raf=0,this.ctx.clearRect(0,0,this.clientWidth,this.clientHeight))}})}static get observedAttributes(){return[...u.observedAttributes,"value","placeholder","name","disabled","required","invalid","valid","floating-label"]}get value(){return this._value}set value(t){this._value=t,this.setAttribute("value",t),this.input&&(this.input.value=t),this.updateStrength()}render(){const t=this._floatingLabel?"":`placeholder="${this.getAttribute("placeholder")??"Digite sua senha..."}"`;return`
    ...
    `}mounted(){this.portal=this.$$(".lmpb__portal"),this.canvas=this.$$(".lmpb__particles"),this.ctx=this.canvas?.getContext("2d")??null,this.setAttribute("role","button"),this.setAttribute("tabindex","0"),this.$$(".lmpb")?.addEventListener("click",this.onClick),this.$$(".lmpb")?.addEventListener("keydown",this.onKeydown)}unmounted(){cancelAnimationFrame(this.raf)}onConfigChange(t){}openPortal(){p()||this.portalActive||(this.portalActive=!0,this.portal?.classList.add("is-active"),this.spawnVortex(),this.dispatchEvent(new CustomEvent("lumina-portal-open",{bubbles:!0,composed:!0})),setTimeout(()=>{this.portal?.classList.remove("is-active"),this.portalActive=!1},1500))}spawnVortex(){if(!this.ctx||!this.canvas)return;const t=window.devicePixelRatio||1,e=this.clientWidth,i=this.clientHeight;this.canvas.width=e*t,this.canvas.height=i*t,this.canvas.style.width=`${e}px`,this.canvas.style.height=`${i}px`,this.ctx.setTransform(t,0,0,t,0,0);const r=this.shadow.host.style.getPropertyValue("--lumina-accent-rgb").trim()||"120 240 255",s=k(this.intensity),o=Math.round(24*s),d=e/2,c=i/2;for(let m=0;m<o;m++)this.particles.push({x:d+Math.cos(m)*(40+Math.random()*60),y:c+Math.sin(m)*(40+Math.random()*60),angle:Math.random()*Math.PI*2,radius:40+Math.random()*60,life:0,maxLife:60+Math.random()*30,size:v(1,2.5)});this.raf||this.tick(r,d,c)}}a(ae,"tagName","lumina-portal-button"),customElements.get(ae.tagName)||customElements.define(ae.tagName,ae);class re extends u{static get observedAttributes(){return[...u.observedAttributes]}render(){return`
      <nav class="lmc" part="bar">
        <div class="lmc__glow" part="glow" aria-hidden="true"></div>
        <div class="lmc__inner"><slot></slot></div>
      </nav>
...
`}mounted(){}unmounted(){}onConfigChange(n){}emit(n,t){this.dispatchEvent(new CustomEvent(n,{bubbles:!0,composed:!0,detail:t}))}open(){this.setAttribute("open",""),this.setAttribute("data-open",""),this.emit("lumina-open")}close(){this.removeAttribute("open"),this.removeAttribute("data-open"),this.emit("lumina-close")}}a(re,"tagName","lumina-progress-nav"),customElements.get(re.tagName)||customElements.define(re.tagName,re);class se extends u{constructor(){super(...arguments);a(this,"fill",null);a(this,"head",null);a(this,"canvas",null);a(this,"ctx",null);a(this,"trail",[]);a(this,"raf",0);a(this,"_value",0);a(this,"tick",()=>{if(!this.ctx||!this.canvas||!this.fill){this.raf=requestAnimationFrame(this.tick);return}const t=window.devicePixelRatio||1,e=this.clientWidth,i=this.clientHeight;if((this.canvas.width!==Math.floor(e*t)||this.canvas.height!==Math.floor(i*t))&&(this.canvas.width=Math.max(1,Math.floor(e*t)),this.canvas.height=Math.max(1,Math.floor(i*t)),this.canvas.style.width=`${e}px`,this.canvas.style.height=`${i}px`,this.ctx.setTransform(t,0,0,t,0,0)),this._value>0&&this._value<this.max&&!p()){const s=this._value/this.max*e,o=k(this.intensity);Math.random()<.4*o&&this.trail.push({x:s,y:i/2,vx:v(-.3,.6),vy:v(-.8,.8),life:0,maxLife:30+Math.random()*20,size:v(.5,1.6)})}this.ctx.clearRect(0,0,e,i);const r=this.shadow.host.style.getPropertyValue("--lumina-accent-rgb").trim()||"124 92 255";this.trail=this.trail.filter(s=>s.life<s.maxLife);for(const s of this.trail){s.x+=s.vx,s.y+=s.vy,s.vy+=.02,s.life+=1;const o=(1-s.life/s.maxLife)*.8;this.ctx.fillStyle=`rgba(${r} / ${o})`,this.ctx.beginPath(),this.ctx.arc(s.x,s.y,s.size,0,Math.PI*2),this.ctx.fill()}this.raf=requestAnimationFrame(this.tick)})}static get observedAttributes(){return[...u.observedAttributes,"value","max","indeterminate"]}get value(){return this._value}set value(t){this._value=Math.min(Math.max(t,0),this.max),this.setAttribute("value",String(this._value)),this.renderValue()}get max(){return parseFloat(this.getAttribute("max")??"100")||100}render(){return`
    ...
    `}mounted(){this.fill=this.$$(".lumina-progress__fill"),this.head=this.$$(".lumina-progress__head"),this.canvas=this.$$(".lumina-progress__trail"),this.ctx=this.canvas?.getContext("2d")??null;const t=parseFloat(this.getAttribute("value")??"0")||0;this._value=Math.min(Math.max(t,0),this.max),this.renderValue(),p()||(this.raf=requestAnimationFrame(this.tick))}unmounted(){cancelAnimationFrame(this.raf)}onConfigChange(t){}renderValue(){if(!this.fill)return;const t=this._value/this.max*100;this.fill.style.width=`${t}%`,this.setAttribute("aria-valuenow",String(this._value));const e=this.shadow.querySelector('[role="progressbar"]');e&&e.setAttribute("aria-valuenow",String(this._value))}}a(se,"tagName","lumina-progress"),customElements.get(se.tagName)||customElements.define(se.tagName,se);class ne extends u{constructor(){super(...arguments);a(this,"_pulseIntensity",.7)}static get observedAttributes(){return[...u.observedAttributes,"intensity"]}get pulseIntensity(){return this._pulseIntensity}set pulseIntensity(t){this._pulseIntensity=f(t,0,1),this.setAttribute("intensity",String(this._pulseIntensity)),this.applyIntensity()}render(){return`
    ...
    `}mounted(){this._pulseIntensity=f(parseFloat(this.getAttribute("intensity")??"0.7")||.7,0,1),this.applyIntensity()}unmounted(){}onConfigChange(t){}attributeChangedCallback(t,e,i){super.attributeChangedCallback(t,e,i),t==="intensity"&&(this._pulseIntensity=f(parseFloat(i??"0.7")||.7,0,1),this.applyIntensity())}applyIntensity(){this.style.setProperty("--lmpi-intensity",String(this._pulseIntensity))}}a(ne,"tagName","lumina-pulse-indicator"),customElements.get(ne.tagName)||customElements.define(ne.tagName,ne);class oe extends u{constructor(){super(...arguments);a(this,"_value","");a(this,"indicator",null);a(this,"observer",null);a(this,"onClick",t=>{const e=t.target.closest("[data-value]");e&&(this._value=e.getAttribute("data-value")??"",this.setAttribute("value",this._value),this.updateActive(),this.moveIndicator(),this.dispatchEvent(new CustomEvent("lumina-change",{bubbles:!0,composed:!0,detail:{value:this._value}})))});a(this,"onKeydown",t=>{const e=t.target.closest("[data-value]");if(!e)return;const i=Array.from(this.querySelectorAll("[data-value]")),r=i.indexOf(e);if(r===-1)return;let s=r;if(t.key==="ArrowRight"||t.key==="ArrowDown")s=(r+1)%i.length;else if(t.key==="ArrowLeft"||t.key==="ArrowUp")s=(r-1+i.length)%i.length;else return;t.preventDefault(),i[s].focus(),this._value=i[s].getAttribute("data-value")??"",this.setAttribute("value",this._value),this.updateActive(),this.moveIndicator(),this.dispatchEvent(new CustomEvent("lumina-change",{bubbles:!0,composed:!0,detail:{value:this._value}}))})}static get observedAttributes(){return[...u.observedAttributes,"value","name","disabled","required","invalid","valid"]}get value(){return this._value}set value(t){this._value=t,this.setAttribute("value",t),this.moveIndicator()}render(){return`
    ...
    `}mounted(){this._rippleColor=this.getAttribute("ripple-color")??"",this._rippleDuration=parseInt(this.getAttribute("ripple-duration")??"600",10)||600,this._multi=this.hasAttribute("multi")||this.getAttribute("multi")===null?!0:this.hasAttribute("multi"),this.applyDuration(),this.container=this.$$(".lmrb__ripple"),this.setAttribute("role","button"),this.setAttribute("tabindex","0"),this.$$(".lmrb")?.addEventListener("click",this.onClick),this.$$(".lmrb")?.addEventListener("keydown",this.onKeydown)}unmounted(){}onConfigChange(t){}attributeChangedCallback(t,e,i){super.attributeChangedCallback(t,e,i),t==="ripple-color"?this._rippleColor=i??"":t==="ripple-duration"?(this._rippleDuration=parseInt(i??"600",10)||600,this.applyDuration()):t==="multi"&&(this._multi=i!==null)}applyDuration(){this.style.setProperty("--lmrb-duration",`${this._rippleDuration}ms`)}spawnRipple(t,e){if(p()||!this.container)return;this._multi||(this.container.innerHTML="");const i=document.createElement("span");i.className="lmrb__ripple-dot",i.style.left=`${t}px`,i.style.top=`${e}px`,i.style.width="20px",i.style.height="20px",i.style.background=this._rippleColor||"rgb(var(--lumina-accent-rgb) / 0.4)",this.container.appendChild(i),setTimeout(()=>i.remove(),this._rippleDuration+50)}}a(de,"tagName","lumina-ripple-button"),customElements.get(de.tagName)||customElements.define(de.tagName,de);class ce extends u{constructor(){super(...arguments);a(this,"_value","");a(this,"_suggestions",[]);a(this,"_voice",!1);a(this,"_floatingLabel",!1);a(this,"input",null);a(this,"suggestionsEl",null);a(this,"iconEl",null);a(this,"onInput",t=>{this._value=t.target.value,this.updateIcon(),this.filterSuggestions(),this._updateFloatingState(),this.dispatchEvent(new CustomEvent("lumina-change",{bubbles:!0,composed:!0,detail:{value:this._value}})),this.dispatchEvent(new CustomEvent("lumina-search",{bubbles:!0,composed:!0,detail:{value:this._value}}))});a(this,"onFocus",()=>{this.dispatchEvent(new CustomEvent("lumina-focus",{bubbles:!0,composed:!0,detail:{value:this._value}}))});a(this,"onBlur",()=>{this.dispatchEvent(new CustomEvent("lumina-blur",{bubbles:!0,composed:!0,detail:{value:this._value}}))});a(this,"onIconClick",()=>{this._value&&(this.value="",this.input?.focus())});a(this,"onDocClick",t=>{this.contains(t.target)||this.suggestionsEl?.removeAttribute("data-open")});a(this,"onVoiceClick",()=>{const t=this.$$(".lms__voice");if(!("webkitSpeechRecognition"in window)&&!("SpeechRecognition"in window)){this.dispatchEvent(new CustomEvent("lumina-voice-error",{bubbles:!0,composed:!0,detail:{message:"Speech Recognition not supported"}}));return}const e=window.SpeechRecognition||window.webkitSpeechRecognition,i=new e;i.lang="pt-BR",i.interimResults=!0,i.onstart=()=>{t?.setAttribute("recording",""),this.dispatchEvent(new CustomEvent("lumina-voice-start",{bubbles:!0,composed:!0}))},i.onresult=r=>{const s=Array.from(r.results).map(o=>o[0].transcript).join("");this.value=s},i.onend=()=>{t?.removeAttribute("recording"),this.dispatchEvent(new CustomEvent("lumina-voice-end",{bubbles:!0,composed:!0}))},i.start()})}static get observedAttributes(){return[...u.observedAttributes,"value","suggestions","voice","placeholder","name","disabled","required","invalid","valid","floating-label"]}get value(){return this._value}set value(t){this._value=t,this.setAttribute("value",t),this.input&&(this.input.value=t),this.updateIcon(),this.filterSuggestions()}get suggestions(){return this._suggestions}set suggestions(t){this._suggestions=t,this.setAttribute("suggestions",JSON.stringify(t)),this.filterSuggestions()}get voice(){return this._voice}set voice(t){this._voice=t,t?this.setAttribute("voice",""):this.removeAttribute("voice")}render(){const t=this._floatingLabel?"":`placeholder="${this.getAttribute("placeholder")??"Buscar..."}"`;return`
...
`}mounted(){}unmounted(){}onConfigChange(n){}emit(n,t){this.dispatchEvent(new CustomEvent(n,{bubbles:!0,composed:!0,detail:t}))}open(){this.setAttribute("open",""),this.setAttribute("data-open",""),this.emit("lumina-open")}close(){this.removeAttribute("open"),this.removeAttribute("data-open"),this.emit("lumina-close")}}a(he,"tagName","lumina-sidebar"),customElements.get(he.tagName)||customElements.define(he.tagName,he);class pe extends u{constructor(){super(...arguments);a(this,"canvas",null);a(this,"ctx",null);a(this,"drawing",!1);a(this,"lastX",0);a(this,"lastY",0);a(this,"points",[]);a(this,"inkDrops",[]);a(this,"rafId",0);a(this,"onPointerDown",t=>{this.drawing=!0;const e=this.getPos(t);this.lastX=e.x,this.lastY=e.y,this.points=[{x:e.x,y:e.y,p:t.pressure||.5}],this.dispatchEvent(new CustomEvent("lumina-signature-start",{bubbles:!0,composed:!0}))});a(this,"onPointerMove",t=>{if(!this.drawing||!this.ctx)return;const e=this.getPos(t);if(this.points.push({x:e.x,y:e.y,p:t.pressure||.5}),this.points.length>=3){const i=this.points[this.points.length-3],r=this.points[this.points.length-2],s=this.points[this.points.length-1],o=(i.x+r.x)/2,d=(i.y+r.y)/2,c=(r.x+s.x)/2,m=(r.y+s.y)/2,b=Math.max(1,2+(t.pressure||.5)*2);this.ctx.strokeStyle=this.shadow.host.style.getPropertyValue("--lumina-accent").trim()||"#7c5cff",this.ctx.lineWidth=b,this.ctx.lineCap="round",this.ctx.lineJoin="round",this.ctx.beginPath(),this.ctx.moveTo(o,d),this.ctx.quadraticCurveTo(r.x,r.y,c,m),this.ctx.stroke()}Math.random()<.05&&this.inkDrops.push({x:e.x+(Math.random()-.5)*4,y:e.y+(Math.random()-.5)*4,radius:0,life:0}),this.lastX=e.x,this.lastY=e.y});a(this,"onPointerUp",()=>{this.drawing&&(this.drawing=!1,this.dispatchEvent(new CustomEvent("lumina-signature-end",{bubbles:!0,composed:!0})))});a(this,"rafLoop",()=>{if(this.ctx&&this.canvas){const t=this.shadow.host.style.getPropertyValue("--lumina-accent").trim()||"#7c5cff";this.inkDrops=this.inkDrops.filter(e=>e.life<20);for(const e of this.inkDrops){e.life+=1,e.radius+=.3;const i=(1-e.life/20)*.3;this.ctx.fillStyle=t,this.ctx.globalAlpha=i,this.ctx.beginPath(),this.ctx.arc(e.x,e.y,e.radius,0,Math.PI*2),this.ctx.fill(),this.ctx.globalAlpha=1}}this.rafId=requestAnimationFrame(this.rafLoop)});a(this,"clear",()=>{this.ctx&&this.canvas&&this.ctx.clearRect(0,0,this.canvas.width,this.canvas.height),this.inkDrops=[],this.points=[]});a(this,"exportPNG",()=>{if(!this.canvas)return;const t=document.createElement("a");t.download="signature.png",t.href=this.canvas.toDataURL(),t.click()})}static get observedAttributes(){return[...u.observedAttributes,"name","disabled","required","invalid","valid"]}render(){return`
    ...
    `}mounted(){this.track=this.$$(".lms"),this.fill=this.$$(".lms__fill"),this.thumb=this.$$(".lms__thumb"),this.tooltip=this.$$(".lms__tooltip"),this.marksContainer=this.$$(".lms__marks"),this._min=parseFloat(this.getAttribute("min")??"0")||0,this._max=parseFloat(this.getAttribute("max")??"100")||100,this._step=parseFloat(this.getAttribute("step")??"1")||1,this._value=f(parseFloat(this.getAttribute("value")??"50")||50,this._min,this._max);const t=this.getAttribute("marks");if(t)try{this._marks=JSON.parse(t)}catch{this._marks=[]}this.renderMarks(),requestAnimationFrame(()=>this.updateUI()),"ResizeObserver"in window&&new ResizeObserver(()=>this.updateUI()).observe(this),this.track?.addEventListener("pointerdown",this.onPointerDown),this.thumb?.addEventListener("focus",()=>this.dispatchEvent(new CustomEvent("lumina-focus",{bubbles:!0,composed:!0,detail:{value:this._value}}))),this.thumb?.addEventListener("blur",()=>this.dispatchEvent(new CustomEvent("lumina-blur",{bubbles:!0,composed:!0,detail:{value:this._value}}))),document.addEventListener("pointermove",this.onPointerMove),document.addEventListener("pointerup",this.onPointerUp),this.thumb?.addEventListener("keydown",this.onKeydown)}unmounted(){this.track?.removeEventListener("pointerdown",this.onPointerDown),document.removeEventListener("pointermove",this.onPointerMove),document.removeEventListener("pointerup",this.onPointerUp),this.thumb?.removeEventListener("keydown",this.onKeydown)}onConfigChange(t){}attributeChangedCallback(t,e,i){if(super.attributeChangedCallback(t,e,i),t==="value"&&i!==null)this._value=f(parseFloat(i)||0,this._min,this._max),this.updateUI();else if(t==="min")this._min=parseFloat(i??"0")||0,this.updateUI();else if(t==="max")this._max=parseFloat(i??"100")||100,this.updateUI();else if(t==="step")this._step=parseFloat(i??"1")||1;else if(t==="marks"&&i)try{this._marks=JSON.parse(i),this.renderMarks()}catch{this._marks=[]}}updateUI(){if(!this.fill||!this.thumb||!this.tooltip)return;const t=(this._value-this._min)/(this._max-this._min)*100;this.fill.style.width=`${t}%`,this.thumb.style.left=`${t}%`,this.tooltip.textContent=String(this._value),this.thumb.setAttribute("aria-valuenow",String(this._value)),this.marksContainer?.querySelectorAll(".lms__mark").forEach(e=>{const i=parseFloat(e.getAttribute("data-value")??"");e.toggleAttribute("data-active",i===this._value)})}renderMarks(){if(this.marksContainer){this.marksContainer.innerHTML="";for(const t of this._marks){const e=(t.value-this._min)/(this._max-this._min)*100,i=document.createElement("div");if(i.className="lms__mark",i.style.left=`${e}%`,i.setAttribute("data-value",String(t.value)),this.marksContainer.appendChild(i),t.label){const r=document.createElement("div");r.className="lms__mark-label",r.style.left=`${e}%`,r.textContent=t.label,this.marksContainer.appendChild(r)}}}}setValueFromPointer(t){if(!this.track)return;const e=this.track.getBoundingClientRect(),i=f((t-e.left)/e.width,0,1),r=this._min+i*(this._max-this._min),s=Math.round(r/this._step)*this._step,o=f(s,this._min,this._max);o!==this._value&&(this._value=o,this.setAttribute("value",String(this._value)),this.updateUI(),this.dispatchEvent(new CustomEvent("lumina-input",{bubbles:!0,composed:!0,detail:{value:this._value}})))}}a(ge,"tagName","lumina-slider"),customElements.get(ge.tagName)||customElements.define(ge.tagName,ge);class ve extends u{constructor(){super(...arguments);a(this,"_size",40);a(this,"_spinSpeed",1);a(this,"canvas",null);a(this,"ctx",null);a(this,"raf",0);a(this,"particles",[]);a(this,"time",0);a(this,"tick",()=>{if(!this.ctx){this.raf=requestAnimationFrame(this.tick);return}const t=this._size,e=this._size,i=t/2,r=e/2;this.ctx.clearRect(0,0,t,e),this.time+=.016*this._spinSpeed;const s=this.shadow.host.style.getPropertyValue("--lumina-accent-rgb").trim()||"124 92 255",o=.3+.4*Math.sin(this.time*2);for(const d of this.particles){d.angle+=d.speed*this._spinSpeed,i+Math.cos(d.angle)*d.radius,r+Math.sin(d.angle)*d.radius;const c=5;for(let m=0;m<c;m++){const b=d.angle-m*.05*this._spinSpeed,y=i+Math.cos(b)*d.radius,x=r+Math.sin(b)*d.radius,w=(1-m/c)*o;this.ctx.fillStyle=`rgba(${s} / ${w})`,this.ctx.beginPath(),this.ctx.arc(y,x,Math.max(0,d.size*(1-m/c)),0,Math.PI*2),this.ctx.fill()}}this.raf=requestAnimationFrame(this.tick)})}static get observedAttributes(){return[...u.observedAttributes,"size","speed"]}render(){return`
    ...
    `}mounted(){this._size=parseInt(this.getAttribute("size")??"40",10)||40,this._spinSpeed=parseFloat(this.getAttribute("speed")??"1")||1,this.style.setProperty("--lmsp-size",`${this._size}px`),this.canvas=this.$$(".lmsp__particles"),this.ctx=this.canvas?.getContext("2d")??null;for(let t=0;t<6;t++)this.particles.push({angle:t/6*Math.PI*2,radius:this._size*.35,speed:.03+Math.random()*.02,size:1.5+Math.random()*1});p()||(this.resize(),this.raf=requestAnimationFrame(this.tick))}unmounted(){cancelAnimationFrame(this.raf)}onConfigChange(t){}attributeChangedCallback(t,e,i){super.attributeChangedCallback(t,e,i),t==="size"?(this._size=parseInt(i??"40",10)||40,this.style.setProperty("--lmsp-size",`${this._size}px`),this.particles.forEach(r=>r.radius=this._size*.35)):t==="speed"&&(this._spinSpeed=parseFloat(i??"1")||1)}resize(){if(!this.canvas||!this.ctx)return;const t=window.devicePixelRatio||1;this.canvas.width=this._size*t,this.canvas.height=this._size*t,this.canvas.style.width=`${this._size}px`,this.canvas.style.height=`${this._size}px`,this.ctx.setTransform(t,0,0,t,0,0)}}a(ve,"tagName","lumina-spinner"),customElements.get(ve.tagName)||customElements.define(ve.tagName,ve);class fe extends u{constructor(){super(...arguments);a(this,"_menuItems",[]);a(this,"_disabled",!1);a(this,"_open",!1);a(this,"menu",null);a(this,"onDocClick",t=>{!this.contains(t.target)&&this._open&&this.closeMenu()})}static get observedAttributes(){return[...u.observedAttributes,"menu-items","disabled"]}get disabled(){return this._disabled}set disabled(t){this._disabled=t,t?this.setAttribute("disabled",""):this.removeAttribute("disabled")}get menuItems(){return this._menuItems}set menuItems(t){this._menuItems=t,this.renderMenu()}render(){return`
    ...
    `}mounted(){this._count=parseInt(this.getAttribute("count")??"3",10)||3,this._interactive=this.getAttribute("interactive")!=="false",this.buildStack()}unmounted(){}onConfigChange(t){}attributeChangedCallback(t,e,i){super.attributeChangedCallback(t,e,i),t==="count"?(this._count=parseInt(i??"3",10)||3,this.buildStack()):t==="interactive"&&(this._interactive=i!=="false")}buildStack(){const t=this.$$(".lmsc__cards");if(!t)return;t.innerHTML="",this.cards=[];const e=Array.from(this.children).filter(r=>!r.hasAttribute("slot")),i=e.length>0?e.slice(0,this._count):[];Math.max(this._count,i.length);for(let r=0;r<this._count;r++){const s=document.createElement("div");s.className="lmsc__card",s.setAttribute("part","card"),s.setAttribute("data-index",String(r));const o=(Math.random()-.5)*8;if(i[r])s.innerHTML=i[r].innerHTML;else{const c=document.createElement("div");c.className="lmsc__card-title",c.textContent=`Card ${r+1}`;const m=document.createElement("div");m.className="lmsc__card-sub",m.textContent=`Stack item ${r+1} de ${this._count}`,s.appendChild(c),s.appendChild(m)}const d=(this._count-1-r)*8;s.style.transform=`translateY(${d}px) scale(${1-(this._count-1-r)*.04}) rotate(${o}deg)`,s.style.zIndex=String(this._count-r),r===0&&s.setAttribute("data-active",""),this.cards.push({el:s,rotation:o}),t.appendChild(s),this._interactive&&s.addEventListener("pointerdown",c=>this.onPointerDown(c,r))}this.currentIndex=0}onPointerDown(t,e){if(e!==0||p())return;this.dragging=!0,this.dragStartX=t.clientX,this.dragCurrentX=t.clientX;const i=this.cards[0]?.el;i&&i.setAttribute("data-dragging",""),document.addEventListener("pointermove",this.onPointerMove),document.addEventListener("pointerup",this.onPointerUp)}swipeCard(t){const e=this.cards[0]?.el;if(!e)return;const i=t==="right"?400:-400;e.style.transform=`translateX(${i}px) rotate(${this.cards[0].rotation+20}deg)`,e.style.opacity="0",setTimeout(()=>{const r=this.cards.shift();r.el.style.transition="none",r.el.style.transform=`translateY(${(this._count-1)*8}px) scale(${1-(this._count-1)*.04}) rotate(${r.rotation}deg)`,r.el.style.opacity="0",this.cards.push(r),this.$$(".lmsc__cards")?.appendChild(r.el),requestAnimationFrame(()=>{this.cards.forEach((o,d)=>{o.el.style.transition="";const c=d*8;o.el.style.transform=`translateY(${c}px) scale(${1-d*.04}) rotate(${o.rotation}deg)`,o.el.style.opacity="1",o.el.style.zIndex=String(this._count-d),o.el.removeAttribute("data-dragging"),d===0?o.el.setAttribute("data-active",""):o.el.removeAttribute("data-active")})}),this.dispatchEvent(new CustomEvent("lumina-card-select",{bubbles:!0,composed:!0,detail:{index:0,direction:t}})),this.dispatchEvent(new CustomEvent("lumina-stack-change",{bubbles:!0,composed:!0,detail:{remaining:this.cards.length}}))},300)}resetCard(){const t=this.cards[0]?.el;t&&(t.style.transform=`translateY(0) scale(1) rotate(${this.cards[0].rotation}deg)`,t.style.opacity="1",t.removeAttribute("data-dragging"))}}a(_e,"tagName","lumina-stack-card"),customElements.get(_e.tagName)||customElements.define(_e.tagName,_e);const di={online:"#22c55e",offline:"#6b7280",busy:"#ef4444",away:"#f59e0b",neural:"var(--lumina-accent)"};class xe extends u{constructor(){super(...arguments);a(this,"_status","online");a(this,"_tooltip","")}static get observedAttributes(){return[...u.observedAttributes,"status","tooltip"]}get status(){return this._status}set status(t){this._status=t,this.setAttribute("status",t),this.applyStatus()}render(){return`
    ...
    `}mounted(){this._status=this.getAttribute("status")??"online",this._tooltip=this.getAttribute("tooltip")??"",this.applyStatus()}unmounted(){}onConfigChange(t){}attributeChangedCallback(t,e,i){super.attributeChangedCallback(t,e,i),t==="status"?(this._status=i??"online",this.applyStatus(),this.dispatchEvent(new CustomEvent("lumina-status-change",{bubbles:!0,composed:!0,detail:{status:this._status}}))):t==="tooltip"&&(this._tooltip=i??"",this.applyTooltip())}applyStatus(){const t=this.$$(".lmsi");t&&t.setAttribute("data-status",this._status);const e=di[this._status]??di.online;this.style.setProperty("--lmsi-color",e),this.applyTooltip()}applyTooltip(){const t=this.$$(".lmsi__tooltip");t&&(t.textContent=this._tooltip||this._status.charAt(0).toUpperCase()+this._status.slice(1))}}a(xe,"tagName","lumina-status-indicator"),customElements.get(xe.tagName)||customElements.define(xe.tagName,xe);class ye extends u{static get observedAttributes(){return[...u.observedAttributes,"current","total"]}get current(){return parseFloat(this.getAttribute("current")??"0")||0}set current(n){this.setAttribute("current",String(n))}get total(){return parseFloat(this.getAttribute("total")??"0")||0}set total(n){this.setAttribute("total",String(n))}render(){return`
      <nav class="lmc" part="bar">
        <div class="lmc__glow" part="glow" aria-hidden="true"></div>
        <div class="lmc__inner"><slot></slot></div>
      </nav>
...
`}mounted(){}unmounted(){}onConfigChange(n){}emit(n,t){this.dispatchEvent(new CustomEvent(n,{bubbles:!0,composed:!0,detail:t}))}open(){this.setAttribute("open",""),this.setAttribute("data-open",""),this.emit("lumina-open")}close(){this.removeAttribute("open"),this.removeAttribute("data-open"),this.emit("lumina-close")}}a(ye,"tagName","lumina-step-indicator"),customElements.get(ye.tagName)||customElements.define(ye.tagName,ye);class we extends u{constructor(){super(...arguments);a(this,"_checked",!1);a(this,"canvas",null);a(this,"ctx",null);a(this,"particles",[]);a(this,"raf",0);a(this,"button",null);a(this,"onFocus",()=>{this.dispatchEvent(new CustomEvent("lumina-focus",{bubbles:!0,composed:!0,detail:{checked:this._checked}}))});a(this,"onBlur",()=>{this.dispatchEvent(new CustomEvent("lumina-blur",{bubbles:!0,composed:!0,detail:{checked:this._checked}}))});a(this,"onClick",()=>{this._checked=!this._checked,this._checked?this.setAttribute("checked",""):this.removeAttribute("checked"),this.setAttribute("aria-checked",String(this._checked)),this._checked&&!p()&&this.burst(),this.dispatchEvent(new CustomEvent("lumina-change",{bubbles:!0,composed:!0,detail:{checked:this._checked}}))});a(this,"tick",t=>{if(this.ctx){this.ctx.clearRect(0,0,24,24),this.particles=this.particles.filter(e=>e.life<e.maxLife);for(const e of this.particles){e.x+=e.vx,e.y+=e.vy,e.vx*=.92,e.vy*=.92,e.life+=1;const i=1-e.life/e.maxLife;this.ctx.fillStyle=`rgba(${t} / ${i})`,this.ctx.beginPath(),this.ctx.arc(e.x,e.y,Math.max(0,e.size*i),0,Math.PI*2),this.ctx.fill()}this.particles.length>0?this.raf=requestAnimationFrame(()=>this.tick(t)):(this.raf=0,this.ctx.clearRect(0,0,24,24))}})}static get observedAttributes(){return[...u.observedAttributes,"checked","name","disabled","required","invalid","valid"]}get value(){return this._checked}get checked(){return this._checked}set checked(t){this._checked=t,t?this.setAttribute("checked",""):this.removeAttribute("checked")}render(){return`
    ...
    `}mounted(){this._checked=this.hasAttribute("checked"),this.button=this.$$(".lmsw"),this.canvas=this.$$(".lmsw__particles"),this.ctx=this.canvas?.getContext("2d")??null,this.setAttribute("role","switch"),this.setAttribute("aria-checked",String(this._checked)),this.button?.addEventListener("click",this.onClick),this.button?.addEventListener("focus",this.onFocus),this.button?.addEventListener("blur",this.onBlur)}unmounted(){cancelAnimationFrame(this.raf),this.button?.removeEventListener("focus",this.onFocus),this.button?.removeEventListener("blur",this.onBlur)}onConfigChange(t){}attributeChangedCallback(t,e,i){super.attributeChangedCallback(t,e,i),t==="checked"?(this._checked=i!==null,this.setAttribute("aria-checked",String(this._checked))):t==="disabled"&&this.button&&(this.button.disabled=i!==null)}burst(){if(!this.ctx||!this.canvas)return;const t=window.devicePixelRatio||1,e=24,i=24;this.canvas.width=e*t,this.canvas.height=i*t,this.canvas.style.width=`${e}px`,this.canvas.style.height=`${i}px`,this.ctx.setTransform(t,0,0,t,0,0);const r=this.shadow.host.style.getPropertyValue("--lumina-accent-rgb").trim()||"124 92 255",s=k(this.intensity),o=Math.round(14*s);for(let d=0;d<o;d++){const c=v(0,Math.PI*2),m=v(1.5,3.5);this.particles.push({x:e/2,y:i/2,vx:Math.cos(c)*m,vy:Math.sin(c)*m,life:0,maxLife:30+Math.random()*20,size:v(.8,2)})}this.raf||this.tick(r)}}a(we,"tagName","lumina-switch"),customElements.get(we.tagName)||customElements.define(we.tagName,we);class ke extends u{constructor(){super(...arguments);a(this,"sortCol",-1);a(this,"sortDir","asc");a(this,"onClick",t=>{const e=t.target.closest("th[data-sort]");if(!e)return;const i=parseInt(e.getAttribute("data-sort")??"0",10);this.sortCol===i?this.sortDir=this.sortDir==="asc"?"desc":"asc":(this.sortCol=i,this.sortDir="asc"),this.querySelectorAll("th[data-sort]").forEach(o=>{o.removeAttribute("data-sorted")}),e.setAttribute("data-sorted",this.sortDir);const r=this.querySelector("tbody");if(!r)return;const s=Array.from(r.querySelectorAll("tr"));s.sort((o,d)=>{const c=o.children[i],m=d.children[i],b=c?.textContent??"",y=m?.textContent??"",x=parseFloat(b),w=parseFloat(y),T=!isNaN(x)&&!isNaN(w)?x-w:b.localeCompare(y);return this.sortDir==="asc"?T:-T}),s.forEach((o,d)=>{o.style.animation="none",r.appendChild(o),requestAnimationFrame(()=>{o.style.animation=`lmtb-row-morph 0.3s var(--lumina-ease-spring) ${d*.02}s`})})})}static get observedAttributes(){return[...u.observedAttributes,"sortable"]}render(){return'<div class="lmtb" part="root"><table class="lmtb__table" part="table"><thead class="lmtb__head" part="head"><slot name="head"></slot></thead><tbody class="lmtb__body"><slot></slot></tbody></table></div>'}styles(){return`
      :host { display: block; font-family: var(--lumina-font-sans); color: var(--lumina-text); }
    ...
    `}mounted(){this.addEventListener("click",this.onClick)}unmounted(){this.removeEventListener("click",this.onClick)}onConfigChange(t){}}a(ke,"tagName","lumina-table"),customElements.get(ke.tagName)||customElements.define(ke.tagName,ke);const Ji=["horizontal","vertical"];class Ee extends HTMLElement{constructor(){super();const n=this.attachShadow({mode:"open"}),t=new CSSStyleSheet;t.replaceSync(`
      :host { display: none; }
      :host([active]) { display: block; }
    `),n.adoptedStyleSheets=[t]}connectedCallback(){this.id||(this.id=`tab-${Math.random().toString(36).slice(2,9)}`)}}a(Ee,"tagName","lumina-tab");class Ce extends u{constructor(){super(...arguments);a(this,"_activeTab","");a(this,"_orientation","horizontal");a(this,"_lazy",!1);a(this,"indicator",null);a(this,"panelsContainer",null);a(this,"tabsRow",null);a(this,"renderedPanels",new Set);a(this,"previousTabRect",null);a(this,"onTabKeydown",t=>{const e=t.target;if(!e.classList.contains("lmt__tab"))return;const i=Array.from(this.tabsRow?.querySelectorAll(".lmt__tab")??[]),r=i.indexOf(e);if(r===-1)return;let s=r;if(this._orientation==="horizontal")if(t.key==="ArrowRight")s=(r+1)%i.length;else if(t.key==="ArrowLeft")s=(r-1+i.length)%i.length;else if(t.key==="Home")s=0;else if(t.key==="End")s=i.length-1;else return;else if(t.key==="ArrowDown")s=(r+1)%i.length;else if(t.key==="ArrowUp")s=(r-1+i.length)%i.length;else if(t.key==="Home")s=0;else if(t.key==="End")s=i.length-1;else return;t.preventDefault();const o=i[s],d=o.getAttribute("data-tab-id");d&&this.activateTab(d),o.focus()})}static get observedAttributes(){return[...u.observedAttributes,"active-tab","orientation","lazy"]}get activeTab(){return this._activeTab}set activeTab(t){this._activeTab=t,this.setAttribute("active-tab",t),this.activateTab(t)}get orientation(){return this._orientation}set orientation(t){this._orientation=t,this.setAttribute("orientation",t),this.applyOrientation()}get lazy(){return this._lazy}set lazy(t){this._lazy=t,t?this.setAttribute("lazy",""):this.removeAttribute("lazy")}render(){return`
    ...
    `}mounted(){this.applyStagger(),"IntersectionObserver"in window&&(new IntersectionObserver(e=>{e.forEach(i=>{if(i.isIntersecting){const r=this.$$(".lmtl__line");if(r){const s=this.getBoundingClientRect(),o=window.innerHeight,d=Math.max(0,Math.min(1,(o-s.top)/(s.height+o*.3)));r.querySelector("::after"),r.style.setProperty("--fill",`${d*100}%`),this.style.setProperty("--lmtl-fill",`${d*100}%`)}}})},{threshold:0}).observe(this),window.addEventListener("scroll",this.onScroll,{passive:!0}))}unmounted(){window.removeEventListener("scroll",this.onScroll)}onConfigChange(t){}applyStagger(){this.querySelectorAll("li, [data-timeline-item]").forEach((t,e)=>{t.style.animationDelay=`${e*.1}s`})}}a(Le,"tagName","lumina-timeline"),customElements.get(Le.tagName)||customElements.define(Le.tagName,Le);const ci=["top-right","top-left","bottom-right","bottom-left","top-center","bottom-center"],Gi={success:"✓",error:"×",warning:"!",glass:"●",neural:"◆"},I={"top-right":[],"top-left":[],"bottom-right":[],"bottom-left":[],"top-center":[],"bottom-center":[]};function qe(l){const n=I[l],t=l.startsWith("top"),e=8;let i=12;if(n.forEach((r,s)=>{r.style.setProperty("--lmt-offset",`${i}px`),r.style.setProperty("--lmt-index",String(n.length-s)),i+=r.offsetHeight+e}),t){let r=12;n.forEach(s=>{s.style.setProperty("--lmt-offset",`${r}px`),r+=s.offsetHeight+e})}}class Se extends u{constructor(){super(...arguments);a(this,"_duration",4e3);a(this,"_position","top-right");a(this,"dismissTimer",null);a(this,"progressEl",null);a(this,"stackJoined",!1)}static get observedAttributes(){return[...u.observedAttributes,"duration","position"]}get duration(){return this._duration}set duration(t){this._duration=t,this.setAttribute("duration",String(t)),this.scheduleDismiss()}get position(){return this._position}set position(t){this.stackJoined&&(I[this._position]=I[this._position].filter(e=>e!==this),qe(this._position)),this._position=t,this.setAttribute("position",t),this.applyPosition(),this.joinStack()}render(){return`
    ...
    `}mounted(){this.progressEl=this.$$(".lmt__progress");const t=this.getAttribute("duration");t&&(this._duration=parseInt(t,10)||4e3);const e=this.getAttribute("position");e&&ci.includes(e)&&(this._position=e),this.applyPosition(),this.applyVariantIcon(),this.$$(".lmt__close")?.addEventListener("click",()=>this.dismiss()),this.shadow.querySelectorAll('slot[name="actions"]').forEach(i=>{i.addEventListener("click",r=>{const s=r.target;s.matches('[slot="actions"]')&&!s.hasAttribute("data-persist")&&setTimeout(()=>this.dismiss(),100)})}),this.style.setProperty("--lmt-duration",`${this._duration}ms`),requestAnimationFrame(()=>{this.classList.remove("is-hidden"),this.joinStack(),this.startProgress(),this.scheduleDismiss()})}unmounted(){this.dismissTimer&&clearTimeout(this.dismissTimer),this.leaveStack()}onConfigChange(t){}attributeChangedCallback(t,e,i){super.attributeChangedCallback(t,e,i),t==="duration"&&i?(this._duration=parseInt(i,10)||4e3,this.style.setProperty("--lmt-duration",`${this._duration}ms`)):t==="position"&&i&&ci.includes(i)&&(this._position=i)}applyPosition(){}applyVariantIcon(){const t=this.$$(".lmt__icon");t&&(t.textContent=Gi[this.variant]??"●")}joinStack(){this.stackJoined||(I[this._position].push(this),this.stackJoined=!0,qe(this._position))}leaveStack(){this.stackJoined&&(I[this._position]=I[this._position].filter(t=>t!==this),this.stackJoined=!1,qe(this._position))}startProgress(){if(p()||this._duration<=0)return;const t=this.$$(".lmt");t&&t.classList.add("is-counting")}scheduleDismiss(){this.dismissTimer&&clearTimeout(this.dismissTimer),this._duration>0&&(this.dismissTimer=setTimeout(()=>this.dismiss(),this._duration))}pause(){this.dismissTimer&&(clearTimeout(this.dismissTimer),this.dismissTimer=null);const t=this.$$(".lmt");if(t){t.style.animationPlayState="paused";const e=this.$$(".lmt__progress");e&&(e.style.animationPlayState="paused")}}resume(){const t=this.$$(".lmt");if(t){t.style.animationPlayState="running";const e=this.$$(".lmt__progress");e&&(e.style.animationPlayState="running")}}dismiss(){this.dismissTimer&&(clearTimeout(this.dismissTimer),this.dismissTimer=null),this.classList.add("is-hidden"),this.leaveStack(),setTimeout(()=>{this.dispatchEvent(new CustomEvent("lumina-dismiss",{bubbles:!0,composed:!0})),this.remove()},p()?0:400)}}a(Se,"tagName","lumina-toast"),customElements.get(Se.tagName)||customElements.define(Se.tagName,Se);class ze extends u{constructor(){super(...arguments);a(this,"_pressed",!1);a(this,"_iconOn","");a(this,"_iconOff","");a(this,"burstCanvas",null);a(this,"burstCtx",null);a(this,"burstParticles",[]);a(this,"burstRaf",0);a(this,"onClick",()=>{this._pressed=!this._pressed,this._pressed?this.setAttribute("pressed",""):this.removeAttribute("pressed"),this.setAttribute("aria-pressed",String(this._pressed)),this.updateIcon(),this.spawnBurst(),this.dispatchEvent(new CustomEvent("lumina-change",{bubbles:!0,composed:!0,detail:{pressed:this._pressed}}))});a(this,"onKeydown",t=>{(t.key==="Enter"||t.key===" ")&&(t.preventDefault(),this.onClick())});a(this,"tick",t=>{if(this.burstCtx){this.burstCtx.clearRect(0,0,this.clientWidth,this.clientHeight),this.burstParticles=this.burstParticles.filter(e=>e.life<e.maxLife);for(const e of this.burstParticles){e.x+=e.vx,e.y+=e.vy,e.vx*=.94,e.vy*=.94,e.life+=1;const i=1-e.life/e.maxLife;this.burstCtx.fillStyle=`rgba(${t} / ${i})`,this.burstCtx.beginPath(),this.burstCtx.arc(e.x,e.y,Math.max(0,e.size*i),0,Math.PI*2),this.burstCtx.fill()}this.burstParticles.length>0?this.burstRaf=requestAnimationFrame(()=>this.tick(t)):(this.burstRaf=0,this.burstCtx.clearRect(0,0,this.clientWidth,this.clientHeight))}})}static get observedAttributes(){return[...u.observedAttributes,"pressed","icon-on","icon-off"]}get pressed(){return this._pressed}set pressed(t){this._pressed=t,t?this.setAttribute("pressed",""):this.removeAttribute("pressed")}get iconOn(){return this._iconOn}set iconOn(t){this._iconOn=t,this.setAttribute("icon-on",t),this.updateIcon()}get iconOff(){return this._iconOff}set iconOff(t){this._iconOff=t,this.setAttribute("icon-off",t),this.updateIcon()}render(){return`
    ...
    `}mounted(){this._pressed=this.hasAttribute("pressed"),this._iconOn=this.getAttribute("icon-on")??"",this._iconOff=this.getAttribute("icon-off")??"",this.burstCanvas=this.$$(".lmtb__particles"),this.burstCtx=this.burstCanvas?.getContext("2d")??null,this.updateIcon(),this.setAttribute("role","switch"),this.setAttribute("tabindex","0"),this.setAttribute("aria-pressed",String(this._pressed)),this.$$(".lmtb")?.addEventListener("click",this.onClick),this.$$(".lmtb")?.addEventListener("keydown",this.onKeydown)}unmounted(){cancelAnimationFrame(this.burstRaf)}onConfigChange(t){}attributeChangedCallback(t,e,i){super.attributeChangedCallback(t,e,i),t==="pressed"?(this._pressed=i!==null,this.setAttribute("aria-pressed",String(this._pressed))):t==="icon-on"?(this._iconOn=i??"",this.updateIcon()):t==="icon-off"&&(this._iconOff=i??"",this.updateIcon())}updateIcon(){const t=this.$$(".lmtb__icon");t&&(t.textContent=this._pressed?this._iconOn:this._iconOff)}spawnBurst(){if(p()||!this.burstCtx||!this.burstCanvas)return;const t=window.devicePixelRatio||1,e=this.clientWidth,i=this.clientHeight;this.burstCanvas.width=e*t,this.burstCanvas.height=i*t,this.burstCanvas.style.width=`${e}px`,this.burstCanvas.style.height=`${i}px`,this.burstCtx.setTransform(t,0,0,t,0,0);const r=this.shadow.host.style.getPropertyValue("--lumina-accent-rgb").trim()||"124 92 255",s=k(this.intensity),o=Math.round(14*s),d=e/2,c=i/2;for(let m=0;m<o;m++){const b=m/o*Math.PI*2,y=1.5+Math.random()*3*s;this.burstParticles.push({x:d,y:c,vx:Math.cos(b)*y,vy:Math.sin(b)*y,life:0,maxLife:30+Math.random()*20,size:v(1,2.5)})}this.burstRaf||this.tick(r)}}a(ze,"tagName","lumina-toggle-button"),customElements.get(ze.tagName)||customElements.define(ze.tagName,ze);class Me extends u{constructor(){super(...arguments);a(this,"knob",null);a(this,"track",null);a(this,"canvas",null);a(this,"ctx",null);a(this,"particles",[]);a(this,"raf",0);a(this,"_checked",!1);a(this,"onClick",()=>{this.getAttribute("disabled")===null&&(this.checked=!this._checked,this.dispatchEvent(new CustomEvent("lumina-toggle",{detail:{checked:this._checked},bubbles:!0,composed:!0})))});a(this,"tick",t=>{if(this.ctx){this.ctx.clearRect(0,0,24,24),this.particles=this.particles.filter(e=>e.life<e.maxLife);for(const e of this.particles){e.x+=e.vx,e.y+=e.vy,e.vx*=.92,e.vy*=.92,e.life+=1;const i=1-e.life/e.maxLife;this.ctx.fillStyle=`rgba(${t} / ${i})`,this.ctx.beginPath(),this.ctx.arc(e.x,e.y,Math.max(0,e.size*i),0,Math.PI*2),this.ctx.fill()}this.particles.length>0?this.raf=requestAnimationFrame(()=>this.tick(t)):this.raf=0}})}static get observedAttributes(){return[...u.observedAttributes,"checked","disabled","label"]}get checked(){return this._checked}set checked(t){this._checked=t,this.setAttribute("aria-checked",String(t)),t?this.setAttribute("checked",""):this.removeAttribute("checked"),t&&!p()&&this.burst()}render(){return`
      <button
        class="lumina-toggle"
        part="root"
        role="switch"
    ...
    `}mounted(){this.knob=this.$$(".lumina-toggle__knob"),this.track=this.$$(".lumina-toggle__track"),this.canvas=this.$$(".lumina-toggle__burst"),this.ctx=this.canvas?.getContext("2d")??null,this._checked=this.hasAttribute("checked"),this.setAttribute("role","switch"),this.setAttribute("aria-checked",String(this._checked)),this.$$(".lumina-toggle")?.addEventListener("click",this.onClick)}unmounted(){this.$$(".lumina-toggle")?.removeEventListener("click",this.onClick),cancelAnimationFrame(this.raf)}onConfigChange(t){}burst(){if(!this.ctx||!this.canvas||!this.knob)return;const t=window.devicePixelRatio||1,e=24,i=24;this.canvas.width=e*t,this.canvas.height=i*t,this.canvas.style.width=`${e}px`,this.canvas.style.height=`${i}px`,this.ctx.setTransform(t,0,0,t,0,0);const r=this.shadow.host.style.getPropertyValue("--lumina-accent-rgb").trim()||"124 92 255",s=k(this.intensity),o=Math.round(14*s);for(let d=0;d<o;d++){const c=v(0,Math.PI*2),m=v(1.5,3.5);this.particles.push({x:e/2,y:i/2,vx:Math.cos(c)*m,vy:Math.sin(c)*m,life:0,maxLife:30+Math.random()*20,size:v(.8,2)})}this.raf||this.tick(r)}}a(Me,"tagName","lumina-toggle"),customElements.get(Me.tagName)||customElements.define(Me.tagName,Me);class Ne extends u{constructor(){super(...arguments);a(this,"bubble",null);a(this,"arrow",null);a(this,"hideTimer",null);a(this,"showTimer",null);a(this,"_visible",!1);a(this,"onEnter",()=>{this.hideTimer&&(clearTimeout(this.hideTimer),this.hideTimer=null);const t=parseInt(this.getAttribute("delay")??"200",10);this.showTimer=setTimeout(()=>this.show(),t)});a(this,"onLeave",()=>{this.showTimer&&(clearTimeout(this.showTimer),this.showTimer=null),this.hideTimer=setTimeout(()=>this.hide(),80)})}static get observedAttributes(){return[...u.observedAttributes,"content","side","delay"]}render(){return`
    ...
    `}mounted(){this.bubble=this.$$(".lumina-tooltip__bubble"),this.arrow=this.$$(".lumina-tooltip__arrow");const t=this.getAttribute("side")??"top";this.bubble?.setAttribute("data-side",t),this.addEventListener("pointerenter",this.onEnter),this.addEventListener("pointerleave",this.onLeave),this.addEventListener("focusin",this.onEnter),this.addEventListener("focusout",this.onLeave)}unmounted(){this.removeEventListener("pointerenter",this.onEnter),this.removeEventListener("pointerleave",this.onLeave),this.removeEventListener("focusin",this.onEnter),this.removeEventListener("focusout",this.onLeave),this.showTimer&&clearTimeout(this.showTimer),this.hideTimer&&clearTimeout(this.hideTimer)}onConfigChange(t){}show(){!this.bubble||this._visible||(this._visible=!0,this.bubble.setAttribute("data-visible",""),this.bubble.setAttribute("aria-hidden","false"),p()||this.reposition())}hide(){!this.bubble||!this._visible||(this._visible=!1,this.bubble.removeAttribute("data-visible"),this.bubble.setAttribute("aria-hidden","true"))}reposition(){if(!this.bubble)return;const t=this.bubble.getAttribute("data-side")??"top",e=this.bubble.getBoundingClientRect(),i=8;let r=t;t==="top"&&e.top<i&&(r="bottom"),t==="bottom"&&e.bottom+i>window.innerHeight&&(r="top"),t==="left"&&e.left<i&&(r="right"),t==="right"&&e.right+i>window.innerWidth&&(r="left"),r!==t&&this.bubble.setAttribute("data-side",r)}}a(Ne,"tagName","lumina-tooltip"),customElements.get(Ne.tagName)||customElements.define(Ne.tagName,Ne);class Ie extends u{constructor(){super(...arguments);a(this,"onClick",t=>{const e=t.target.closest("li, [data-tree-node]");if(!e)return;const i=e.querySelector("ul, .lmtv__children");if(i){const r=i.hasAttribute("data-expanded");r?(i.removeAttribute("data-expanded"),e.removeAttribute("data-expanded")):(i.setAttribute("data-expanded",""),e.setAttribute("data-expanded",""),e.setAttribute("data-expandable","")),this.dispatchEvent(new CustomEvent("lumina-expand",{bubbles:!0,composed:!0,detail:{node:e.textContent?.trim(),expanded:!r}}))}this.querySelectorAll("[data-selected]").forEach(r=>r.removeAttribute("data-selected")),e.setAttribute("data-selected",""),this.dispatchEvent(new CustomEvent("lumina-select",{bubbles:!0,composed:!0,detail:{value:e.textContent?.trim()}}))})}render(){return'<ul class="lmtv" part="tree" role="tree"><slot></slot></ul>'}styles(){return`
      :host { display: block; font-family: var(--lumina-font-sans); color: var(--lumina-text); }
    ...
    `}mounted(){this.addEventListener("click",this.onClick)}unmounted(){this.removeEventListener("click",this.onClick)}onConfigChange(t){}}a(Ie,"tagName","lumina-tree-view"),customElements.get(Ie.tagName)||customElements.define(Ie.tagName,Ie);class Te extends u{constructor(){super(...arguments);a(this,"input",null);a(this,"micBtn",null);a(this,"canvas",null);a(this,"ctx",null);a(this,"recording",!1);a(this,"raf",0);a(this,"waveform",new Array(40).fill(0));a(this,"recognition",null);a(this,"onInput",t=>{this.dispatchEvent(new CustomEvent("lumina-change",{bubbles:!0,composed:!0,detail:{value:t.target.value}}))});a(this,"onFocus",()=>{this.dispatchEvent(new CustomEvent("lumina-focus",{bubbles:!0,composed:!0,detail:{value:this.value}}))});a(this,"onBlur",()=>{this.dispatchEvent(new CustomEvent("lumina-blur",{bubbles:!0,composed:!0,detail:{value:this.value}}))});a(this,"toggleRecording",()=>{this.recording?this.stopRecording():this.startRecording()});a(this,"drawWaveform",()=>{if(!this.ctx||!this.canvas){this.raf=requestAnimationFrame(this.drawWaveform);return}const t=window.devicePixelRatio||1,e=this.canvas.clientWidth,i=this.canvas.clientHeight;this.canvas.width!==e*t&&(this.canvas.width=e*t,this.canvas.height=i*t,this.ctx.setTransform(t,0,0,t,0,0)),this.ctx.clearRect(0,0,e,i),this.waveform.shift(),this.waveform.push(this.recording?Math.random()*.8+.2:0);const r=e/this.waveform.length,s=this.shadow.host.style.getPropertyValue("--lumina-accent").trim()||"#7c5cff";this.ctx.fillStyle=s;for(let o=0;o<this.waveform.length;o++){const c=this.waveform[o]*i*.8,m=o*r+r*.2,b=(i-c)/2;this.ctx.fillRect(m,b,r*.6,c)}this.raf=requestAnimationFrame(this.drawWaveform)})}static get observedAttributes(){return[...u.observedAttributes,"value","placeholder","name","disabled","required","invalid","valid"]}render(){return`
    ...
    `}mounted(){this.canvas=this.$$(".lmvc__canvas"),this.ctx=this.canvas?.getContext("2d")??null,p()||(this.spawnParticles(),this.raf=requestAnimationFrame(this.tick)),this.addEventListener("pointermove",this.onMove)}unmounted(){cancelAnimationFrame(this.raf),this.removeEventListener("pointermove",this.onMove)}onConfigChange(t){}spawnParticles(){if(!this.ctx||!this.canvas)return;const t=window.devicePixelRatio||1,e=this.clientWidth||300,i=this.clientHeight||200;this.canvas.width=e*t,this.canvas.height=i*t,this.canvas.style.width=`${e}px`,this.canvas.style.height=`${i}px`,this.ctx.setTransform(t,0,0,t,0,0);for(let r=0;r<30;r++)this.particles.push({x:e/2,y:i/2,angle:Math.random()*Math.PI*2,radius:20+Math.random()*Math.max(e,i)*.6,life:Math.random()*100,maxLife:100+Math.random()*100,size:.5+Math.random()*1.5})}}a(Fe,"tagName","lumina-void-card"),customElements.get(Fe.tagName)||customElements.define(Fe.tagName,Fe),g.DEFAULT_CONFIG=hi,g.DEPTH_PX=je,g.DEPTH_VALUES=Ve,g.INTENSITY_MULTIPLIERS=Ke,g.INTENSITY_VALUES=Re,g.LuminaElement=u,g.ParticleField=A,g.THEME_VALUES=De,g.TOKENS=h,g.TRIGGER_VALUES=Ye,g.VARIANT_VALUES=Pe,g.buildBaseStylesheet=Oe,g.clamp=f,g.coerceAttr=_,g.createHiDPICanvas=Ge,g.depthToPx=Je,g.intensityToMultiplier=k,g.lerp=bi,g.parseColor=We,g.prefersReducedMotion=p,g.qs=gi,g.randRange=v,g.resolveTheme=He,g.rgbToString=pi,g.springEase=vi,g.throttle=C,g.toRgbTriplet=Ue,Object.defineProperty(g,Symbol.toStringTag,{value:"Module"})});
