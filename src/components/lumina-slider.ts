/**
 * LuminaSlider — Slider com glow e tooltip de valor.
 *
...
export class Slider extends LuminaElement {
  ...
  static get observedAttributes(): string[] {
    return [...LuminaElement.observedAttributes, "value", "min", "max"];
  }
  ...
  get max(): number {
    return parseFloat(this.getAttribute('max') ?? '100') || 0;
  }
  set max(v: number) {
