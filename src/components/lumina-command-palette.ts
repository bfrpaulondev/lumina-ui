/**
 * LuminaCommandPalette — Cmd+K palette com fuzzy search.
 *
...
declare global {
  interface HTMLElementTagNameMap {
    'lumina-command-palette': CommandPalette;
  }
}

if (!customElements.get(CommandPalette.tagName)) {
