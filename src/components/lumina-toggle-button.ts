/**
 * LuminaToggleButton — Botão de estado pressed/released.
 *
...
export class ToggleButton extends LuminaElement {
  ...
  static get observedAttributes(): string[] {
    return [...LuminaElement.observedAttributes, "pressed"];
  }
...
declare global {
  interface HTMLElementTagNameMap {
    'lumina-toggle-button': ToggleButton;
  }
}

if (!customElements.get(ToggleButton.tagName)) {
