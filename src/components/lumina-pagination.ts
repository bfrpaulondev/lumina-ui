/**
 * LuminaPagination — Pagination com ellipsis inteligente.
 *
...
export class Pagination extends LuminaElement {
  ...
  static get observedAttributes(): string[] {
    return [...LuminaElement.observedAttributes, "page", "total"];
  }
...
declare global {
  interface HTMLElementTagNameMap {
    'lumina-pagination': Pagination;
  }
}

if (!customElements.get(Pagination.tagName)) {
