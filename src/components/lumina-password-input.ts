/**
 * LuminaPasswordInput — Senha com medidor de força neural.
 *
...
export class PasswordInput extends LuminaElement {
  ...
  static get observedAttributes(): string[] {
    return [...LuminaElement.observedAttributes, "value"];
  }
...
declare global {
  interface HTMLElementTagNameMap {
    'lumina-password-input': PasswordInput;
  }
}

if (!customElements.get(PasswordInput.tagName)) {
