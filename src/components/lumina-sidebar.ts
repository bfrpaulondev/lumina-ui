/**
 * LuminaSidebar — Sidebar colapsável com glow.
 *
...
export class Sidebar extends LuminaElement {
  ...
  static get observedAttributes(): string[] {
    return [...LuminaElement.observedAttributes, "collapsed"];
  }
...
declare global {
  interface HTMLElementTagNameMap {
    'lumina-sidebar': Sidebar;
  }
}

if (!customElements.get(Sidebar.tagName)) {
