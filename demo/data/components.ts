 ...
 *
 * 104 components across 8 categories.
 */
...
export class MaskedInput extends LuminaElement {
  ...
  // Accepts variants: 'glass' | 'neural' | 'void'
  // CSS parts:       field, control, input, success, error
  ...
  protected render(): string {
    /* Full source: src/components/lumina-masked-input.ts */
    return \`
      <div class="lmc" part="root">
        <slot></slot>
      </div>
...
<script type="module">
  const el = document.querySelector('lumina-masked-input');
  el.addEventListener('lumina-change', (e) => {
    console.log('lumina-change', e.detail);
  });
</script>`,
...
export function MaskedInputExample() {
  return (
    <lumina-masked-input variant="glass" intensity="intense" accent-color="#7c5cff" speed={0.5} mask="###.###.###-##" placeholder="000.000.000-00" name="cpf"
      onLuminaChange={(e) => console.log(e.detail)}>
      <span slot="label">CPF</span>
        <span slot="left-icon">#</span>
        <span slot="error">CPF inválido</span>
...
export class FormField extends LuminaElement {
  ...
  // Accepts variants: 'glass' | 'neural' | 'void'
  // CSS parts:       field, label, hint, control, error, check
  // Events:          (inherits standard lumina-* events)
  // Props:
   * label: string
   * hint: string
  ...
  protected render(): string {
    /* Full source: src/components/lumina-form-field.ts */
    return \`
      <div class="lmc" part="root">
        <slot></slot>
      </div>
...
export function FormFieldExample() {
  return (
    <lumina-form-field variant="glass" intensity="intense" accent-color="#7c5cff" speed={0.5} label="Email" hint="Use seu email corporativo" required>
...
export class FormList extends LuminaElement {
  ...
  // Accepts variants: 'glass' | 'neural' | 'void'
  // CSS parts:       list, items, footer, add
  ...
  protected render(): string {
    /* Full source: src/components/lumina-form-list.ts */
    return \`
      <div class="lmc" part="root">
        <slot></slot>
      </div>
...
<script type="module">
  const el = document.querySelector('lumina-form-list');
  el.addEventListener('lumina-add', (e) => {
    console.log('lumina-add', e.detail);
  });
</script>`,
    react: `import 'lumina-ui';

export function FormListExample() {
  return (
    <lumina-form-list variant="glass" intensity="intense" accent-color="#ff6ec7" speed={0.5} add-label="Adicionar" max={0} add-label="Adicionar telefone" movable max={5}
      onLuminaAdd={(e) => console.log(e.detail)}>
...
export class Form extends LuminaElement {
  ...
  protected render(): string {
    /* Full source: src/components/lumina-form.ts */
    return \`
      <div class="lmc" part="root">
        <slot></slot>
      </div>
...
<script type="module">
  const el = document.querySelector('lumina-form');
  el.addEventListener('lumina-submit', (e) => {
    console.log('lumina-submit', e.detail);
  });
</script>`,
    react: `import 'lumina-ui';
...
export function FormExample() {
  return (
    <lumina-form variant="glass" intensity="intense" accent-color="#7c5cff" speed={0.5}
      onLuminaSubmit={(e) => console.log(e.detail)}>
      <lumina-form-field label="Nome" required>
